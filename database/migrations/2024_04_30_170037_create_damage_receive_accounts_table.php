...
class CreateDamageReceiveAccountsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('damage_receive_accounts', function (Blueprint $table) {
           $table->id();
    ...
    {
        Schema::dropIfExists('damage_receive_accounts');
    }
}
