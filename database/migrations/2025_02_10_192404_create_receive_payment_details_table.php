...
class CreateReceivePaymentDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('receive_payment_details', function (Blueprint $table) {
            $table->id();
            ...
            $table->tinyInteger('_is_effect')->default(0);
    ...
    {
        Schema::dropIfExists('receive_payment_details');
    }
}
