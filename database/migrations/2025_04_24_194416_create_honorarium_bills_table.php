...
class CreateHonorariumBillsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('honorarium_bills', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('_amount', 15, 2)->default(0);
    ...
    {
        Schema::dropIfExists('honorarium_bills');
    }
}
