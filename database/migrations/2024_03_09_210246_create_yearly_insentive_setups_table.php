...
class CreateYearlyInsentiveSetupsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('yearly_insentive_setups', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('yearly_insentive_setups');
    }
}
