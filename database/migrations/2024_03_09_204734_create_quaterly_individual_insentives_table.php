...
class CreateQuaterlyIndividualInsentivesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('quaterly_individual_insentives', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('quaterly_individual_insentives');
    }
}
