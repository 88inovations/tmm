...
class CreateDamageItemHistoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('damage_item_histories', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('damage_item_histories');
    }
}
