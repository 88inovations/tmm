...
class CreateImportCostAccountsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('import_cost_accounts', function (Blueprint $table) {
           
            $table->id();
            $table->unsignedBigInteger('_no');
            $table->foreign('_no')->references('id')->on('asset_import_costs');
    ...
    {
        Schema::dropIfExists('import_cost_accounts');
    }
}
