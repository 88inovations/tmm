...
class CreateDamageSendAccountsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('damage_send_accounts', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('_no');
            $table->foreign('_no')->references('id')->on('damage_send_masters');
    ...
    {
        Schema::dropIfExists('damage_send_accounts');
    }
}
