...
class CreateHonorariumBillDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('honorarium_bill_details', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('honorarium_bill_details');
    }
}
