...
class CreateStmCollectionMastersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('stm_collection_masters', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('stm_collection_masters');
    }
}
