...
class CreateDamageReceiveMastersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('damage_receive_masters', function (Blueprint $table) {
            $table->id();
            ...
            $table->tinyInteger('_receive_type')->default(0);
    ...
    {
        Schema::dropIfExists('damage_receive_masters');
    }
}
