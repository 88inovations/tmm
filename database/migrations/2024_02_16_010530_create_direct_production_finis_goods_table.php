...
class CreateDirectProductionFinisGoodsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('direct_production_finis_goods', function (Blueprint $table) {
            $table->id();
            $table->integer('_no');
    ...
    {
        Schema::dropIfExists('direct_production_finis_goods');
    }
}
