...
class SecurityDeposit extends Model implements Auditable{
    ...
    protected $guarded = [];
     ...
     public function _ledger(){
        return $this->hasOne(AccountLedger::class,'id','_ledger_id')->select('id','_name','_account_group_id','_account_head_id','_phone','_address','_code')->with(['account_type','account_group']);
    }
