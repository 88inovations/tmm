...
class StmBillCollection extends Model
{
    use HasFactory;

    protected $table="stm_collection_master_details";
    protected $fillable =['id', 'organization_id', '_branch_id', '_cost_center_id', '_no', '_student_id', '_bill_master_id', '_bill_detail_id', '_stm_division_id', '_class_id', '_bill_type', '_collection_ledger_id', '_fee_amount', '_discount_amount', '_net_fee_amount', '_remarks', '_status', '_is_close', '_created_by', '_updated_by', 'created_at', 'updated_at','_session_id'];
