...
class HonorariumPaymentDetail extends Model
{
    use HasFactory;
   ...
   public function _organization(){
    ...
    public function _cash_ledger(){
        return $this->hasOne(\App\Models\AccountLedger::class,'id','_ledger_id');
    }


    public function _honorarium_bill(){
        return $this->hasOne(HonorariumBillDetail::class,'id','_bill_detail_id');
    }
}
