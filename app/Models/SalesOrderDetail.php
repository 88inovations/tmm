...
class SalesOrderDetail extends Model implements Auditable{
    use HasFactory;
    use AuditableTrait;
    protected $guarded = [];
    
    public function _items(){
    	return $this->hasOne(Inventory::class,'id','_item_id')->select('id','_item as _name','_unit_id','_unique_barcode','_pur_rate','_sale_rate','_code','_pack_size_id','_code','_balance')->with(['_units','unit_conversion','_pack_size']);
    }
