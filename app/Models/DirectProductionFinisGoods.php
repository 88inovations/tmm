...
class DirectProductionFinisGoods extends Model implements Auditable{
    use HasFactory;
    use AuditableTrait;
    protected $guarded = [];

    protected $table="direct_production_finis_goods";
    use HasFactory;
    ...
    public function _lot_product(){
      return $this->hasOne(ProductPriceList::class,'_purchase_detail_id','id')->where('_input_type','direct_productions')
