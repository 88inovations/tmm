...
class MaterialIssueReturnDetail extends Model implements Auditable{
    use HasFactory;
    use AuditableTrait;
    protected $guarded = [];
    ...
    public function _return_barcodes(){
     return $this->hasMany(MaterialIssueReturnBarcode::class,'_no_detail_id','id');
    }

    public function _return_master(){
     return $this->hasOne(MaterialIssueReturn::class,'id','_no')->with(['_ledger']);
    }
}
