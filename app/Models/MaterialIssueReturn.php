...
class MaterialIssueReturn extends Model implements Auditable{
    use HasFactory;
    use AuditableTrait;
    protected $guarded = [];
    ...
    public function _master_details(){
        return $this->hasMany(MaterialIssueReturnDetail::class,'_no','id')->with(['_detail_branch','_detail_cost_center','_store','_items','_warrant','_units','_trans_unit','unit_conversion'])->where('_status',1);
    }
