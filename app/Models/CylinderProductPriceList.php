...
class CylinderProductPriceList extends Model
{
    use HasFactory;
    protected $table="cylinder_product_price_lists";
    protected $fillable=['id', '_item_id', '_category_id', '_brand_id', '_pack_size_id', '_base_unit', '_transection_unit', '_unit_conversion', '_item', '_input_type', '_barcode', '_model', '_manufacture_date', '_expire_date', '_qty', '_sales_rate', '_pur_rate', '_sales_discount', '_sales_vat', '_value', '_unit_id', '_p_discount_input', '_p_discount_amount', '_p_vat', '_p_vat_amount', '_purchase_detail_id', 'organization_id', '_branch_id', '_store_id', '_cost_center_id', '_warranty', '_master_id', '_store_salves_id', '_status', 'is_lebel_print', '_receive_type', '_unique_barcode', '_created_by', '_updated_by', 'created_at', 'updated_at', '_order_number', '_table_name', '_budget_id', '_item_category', '_transfer_to_asset', '_short_note', '_customer_id', '_supplier_id', '_sales_invoice_date', '_purchase_date'];
 ...
 public function _organization(){
    ...
    public function _customer(){
        return $this->hasOne(AccountLedger::class,'id','_customer_id')->select('id','_name','_account_group_id','_account_head_id','_code','_alious','_phone','_address');
    }


    public function _supplier(){
        return $this->hasOne(AccountLedger::class,'id','_supplier_id')->select('id','_name','_account_group_id','_account_head_id','_code','_alious','_phone','_address');
    }
