...
class DepartmentController extends Controller
{
    function __construct()
    {
        ...
        $this->page_name = __('label.departments');
        $this->new_page_name = __('label.new_departments');
        $this->edit_page_name = __('label.edit_departments');
    }
    ...
    {
        $data = Department::where('is_delete',0)->get();
        $page_name = $this->page_name;
        return view('master.departments.index',compact('data','page_name'));
    }
    ...
    public function create()
    {
        ...
        return view('master.departments.create',compact('page_name','new_page_name'));
    }
    ...
    public function edit($id)
    {
        try {
            ...
            $data = Department::where('is_delete',0)->find($id);
            $page_name = $this->page_name;
            $edit_page_name = $this->edit_page_name;
            return view('master.departments.edit',compact('page_name','edit_page_name','data'));
        } catch (Throwable $e) {
            report($e);
