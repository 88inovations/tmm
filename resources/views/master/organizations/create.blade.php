...
@section('content')
        ...
        <form class="mb-9" method="post" action="{{ route('organizations.store') }}" enctype='multipart/form-data'>
        @csrf
          ...
          <div class="row g-5">
            <div class="col-12 col-xl-8">
              ...
              <input class="form-control mb-2 @error('_name') is-invalid @enderror" name="_name" type="text" placeholder="{{__('label._name')}}" value="{!! old('_name') !!}" />
