...
@section('content')
 ...
 <nav class="mb-2" aria-label="breadcrumb">
          <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="{{route('store-house.index')}}">{{__('label.store-house')}}</a></li>
          </ol>
        </nav>
        <div class="mb-9">
        ...
        <div id="orderTable" data-list='{"valueNames":["id","_name","_code","status","order","created_at","updated_at"],"page":10,"pagination":true}'>
                  <div class="mb-4">
              <div class="row g-3">
                <div class="col-auto">
             ...
             <td class=" align-middle white-space-nowrap ps-8">
                      <div class="d-flex align-items-center text-90">
                         @can('store-house-edit')
                            <a class="mr-10"  href="{{ route('store-house.edit',$value->id) }}?_lang_ref={!! $lan_data->lang_code ?? 'en_US' !!}" title="{!! $lan_data->lang_name ?? 'English' !!}">
                        ...
                        @endcan
                         ...
                         @can('store-house-delete')         
                                    {!! Form::open(['method' => 'DELETE','route' => ['store-house.destroy', $value->id],'style'=>'display:inline']) !!}
