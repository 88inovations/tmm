...
@include('messages.language_message')
 <nav class="mb-2" aria-label="breadcrumb">
          <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="{{route('departments.index')}}">{{$page_name ?? ''}}</a></li>
            @endcan
        ...
        <div class="mb-9">
           ...
           <form class="mb-9" method="post" action="{{ route('departments.update', $data->id) }}" enctype='multipart/form-data'>
        @csrf
        @method('PUT')
