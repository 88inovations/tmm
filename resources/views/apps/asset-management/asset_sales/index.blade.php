...
<div class="container-fluid">
 <nav class="mb-2" aria-label="breadcrumb">
          <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="{{route('asset_sales_list')}}">{{__('label.asset_sales')}}</a></li>
            @endcan
             @can('asset_sales_create')
            <li class="breadcrumb-item">
              <a class="btn btn-primary btn-sm"
                  href="{{route('asset_sales_create')}}"
        ...
        <div>
             ...
             <td class=" align-middle white-space-nowrap ps-8">
                      <div class="d-flex align-items-center text-90">
                         @can('asset_sales_edit')
                            <a class="mr-4"  href="{{ url('asset-management/asset_sales_edit') }}/{{$value->id}}" title="Edit">
                        ...
                        @endcan
                         @can('asset_sales_edit')
                            <a class="mr-4"  href="{{ url('asset-management/asset_sales_print') }}/{{$value->id}}" title="Edit">
                        ...
                        @endcan
                         ...
                         @can('asset_sales_delete')         
                                    
                                         <a onclick="return confirm('Are you sure?')" href="{{url('asset-management/asset_sales_delete')}}/{{$value->id}}" class="btn btn-sm btn-default"><i class="fa fa-trash "></i></a>
