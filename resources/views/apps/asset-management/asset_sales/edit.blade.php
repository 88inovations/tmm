...
<div class="row g-0 border-top border-bottom border-300" style="padding:10px; ;">
                        ...
                        <label class="mt-2 text-right text-1000 col-md-4">{{__('label.id')}}</label>
                        <div class="col-md-6">
                              <input type="text"   name="id" class="form-control id" value="{{old('id',$data->id ?? '')}}" placeholder="{{__('label.id')}}" readonly >
                              
                        </div>
                             <label class="mt-2 text-right text-1000 col-md-4">{{__('label._voucher_code')}}</label>
                            <div class="col-md-6 mt-2">
                              ...
                              <input type="text"   name="voucher_code" class="form-control voucher_code" value="{{old('voucher_id',$data->voucher_code ?? '')}}" placeholder="{{__('label.voucher_id')}}" readonly >
                            </div>
                   ...
                   <label class=" mt-2 text-right col-md-4">{{__('label.asset_ledger_id')}}<span class="_required">*</span></label>
                   ...
                   <label class="col-sm-4 text-right mt-2 text-1000">{{__('label.asset_dep_ledger_id')}}<span class="_required">*</span></label>
                   ...
                   <label class="col-sm-4 text-right mt-2 text-1000">{{__('label.asset_dep_exp_ledger_id')}}<span class="_required">*</span></label>
                    ...
                    <label class="mt-2 text-right text-1000 col-md-4">{{__('label.name')}}<span class="_required">*</span></label>
                             <div class="col-md-6 mt-2">
                            ...
                            <div class="asset_name_box"> </div>
                             ...
                             <label class="mt-2 text-right text-1000 col-md-4">{{__('label.asset_tag')}}</label>
                             <div class="col-md-6 mt-2">
                             ...
                             <label class="mt-2 text-right text-1000 col-md-4">{{__('label.asset_code')}}</label>
                             <div class="col-md-6 mt-2">
                             ...
                             <label class="mt-2 text-right text-1000 col-md-4">{{__('label.model_no')}}</label>
                             <div class="col-md-6 mt-2">
                             ...
                             <label class="mt-2 text-right text-1000 col-md-4">{{__('label.purchase_price')}}</label>
                              <div class="col-md-6 mt-2">
                             ...
                             <label class="mt-2 text-right text-1000 col-md-4">{{__('label.extra_cost')}}</label>
                              <div class="col-md-6 mt-2">
                             ...
                             <label class="mt-2 text-right text-1000 col-md-4">{{__('label.evaluated_price')}}</label>
                             <div class="col-md-6 mt-2">
                             ...
                             <label class="mt-2 text-right text-1000 col-md-4">{{__('label.accumulated_dep_val')}}</label>
                             <div class="col-md-6 mt-2">
                             ...
                             <label class="mt-2 text-right col-md-4">{{__('label.book_value')}}</label>
                             <div class="col-md-6 mt-2">
                   ...
                   <label class="col-sm-4 mt-2 text-right">{{__('label.customer_ledger_id')}}<span class="_required">*</span></label>
                   ...
                   <label class=" mt-2 text-right col-md-4">Cash/Bank Account</label>
                   ...
                   <label class=" mt-2 text-right col-md-4">{{__('label.gain_or_loss_ledger_id')}}<span class="_required">*</span></label>
                    ...
                    <div class="col-sm-6 mt-2">
                            ...
                            <div class="gain_loss_box"> </div>
                             ...
                             <label class="mt-2 text-right col-md-4">{{__('label.sale_price')}}</label>
                             <div class="col-md-6 mt-2">
                             ...
                             <label class="mt-2 text-right col-md-4">{{__('label.gain_loss')}}</label>
                             <div class="col-md-6 mt-2">
