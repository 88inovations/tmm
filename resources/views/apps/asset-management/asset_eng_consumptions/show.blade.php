...
<div class="container-fluid">
        <nav class="mb-2" aria-label="breadcrumb">
          <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="{{route('asset_eng_consumptions.index')}}">{{__('label.asset_eng_consumptions')}}</a></li>
            @endcan
   ...
   <div class="text-center">
      <address>
        <img src="{{asset('/')}}{{$settings->logo ?? '' }}" style="width:60px;height: 60px;"><br>
           ...
           <b>{{__('label.asset_eng_consumptions')}}</b><br>
...
<tr style="border:none;">
  <td colspan="13" style="border:none;"><b>{{__('label._note')}}:</b> {!! $data->_note ?? '' !!}</td>
</tr>
<tfoot>
  <tr style="border:none;">
