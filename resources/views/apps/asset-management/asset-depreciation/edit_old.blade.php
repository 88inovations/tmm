...
@php
$datas = $main_data->asset_dep_detail ?? [];
@endphp
...
$total_evaluated_price  +=$data->_asset_item->evaluated_price ?? 0;
...
$total_dep_value  +=$data->_asset_dep_amount ?? 0;
...
@endphp
                    ...
                    <tr class="@if($book_value==0) zero_book_value @endif">
                      <td>
                        ...
                        <input class="form-control row_id" type="hidden" name="row_id[]" value="{{$data->id}}" >
                      ...
                      <td>
                      <input class="form-control asset_ledger_id" type="hidden" name="asset_ledger_id[]" value="{{$data->asset_ledger_id ?? ''}}">
                      <input class="form-control asset_ledger_name" type="text" name="asset_ledger_name[]" value="{{$data->_asset_ledger->_name ?? ''}}"  title="{{$data->_asset_ledger->_name ?? ''}}" readonly>
                    </td>
                      <td>
                        <input class="form-control asset_dep_ledger_id" type="hidden" name="asset_dep_ledger_id[]" value="{{$data->asset_dep_ledger_id ?? ''}}">
                      <input class="form-control asset_dep_ledger_name" type="text" name="asset_dep_ledger_name[]" value="{{$data->_asset_dep_ledger->_name ?? ''}}"  title="{{$data->_asset_dep_ledger->_name ?? ''}}" readonly>
                      
                    </td>
                      <td>
                        <input class="form-control asset_dep_exp_ledger_id" type="hidden" name="asset_dep_exp_ledger_id[]" value="{{$data->asset_dep_exp_ledger_id ?? ''}}">
                      <input class="form-control asset_dep_exp_ledger_name" type="text" name="asset_dep_exp_ledger_name[]" value="{{$data->_asset_dep_exp_ledger->_name ?? ''}}"  title="{{$data->_asset_dep_exp_ledger->_name ?? ''}}" readonly>
                      
                    </td>
                      <td>
                          <input class="form-control _asset_id" type="hidden" name="_asset_id[]" value="{{$data->_asset_id ?? ''}}">
                      <input class="form-control _asset_name" type="text" name="_asset_name[]" value="{{$data->_asset_item->name ?? ''}}"  title="{{$data->_asset_item->name ?? ''}}" readonly>

                      
                    </td>
                      <td>
                        <input class="form-control asset_code" type="text" name="asset_code[]" value="{{$data->_asset_item->asset_code ?? ''}}"  title="{{$data->_asset_item->asset_code ?? ''}}" readonly>

                     </td>
                      <td>
                         <input class="form-control purchase_date" type="date" name="purchase_date[]" value="{{$data->_asset_item->purchase_date ?? ''}}" readonly>
                     </td>
                      <td>
                         <input class="form-control dep_date" type="date" name="dep_date[]" value="{{$data->_asset_item->dep_date ?? ''}}" readonly>
                     </td>
                      <td>
                         <input class="form-control evaluated_price" type="number" min="0" step="any" name="evaluated_price[]" value="{{$data->_asset_item->evaluated_price}}" readonly>
                     </td>
                      <td>
                         <input class="form-control dep_type" type="number" min="0" step="any" name="dep_type[]" value="{{$data->_asset_item->dep_type ?? 0}}" readonly>
                     </td>
                      <td>
                         <input class="form-control dep_date_number" type="number" min="0" step="any"  name="dep_date_number[]" value="{{$dep_date_number ?? 0}}" readonly>
                     </td>

                      <td>
                         <input class="form-control dep_rate" type="number" min="0" step="any" name="dep_rate[]" value="{{_php_round($data->_asset_dep_rate ?? 0)}}">
                     </td>
                      <td>
                         <input class="form-control dep_value" type="number" min="0" step="any" name="dep_value[]" value="{{_php_round($data->_asset_dep_amount ?? 0)}}">
                     </td>
                      <td>
                         <input class="form-control accumulated_dep_val" type="number" min="0" step="any" name="accumulated_dep_val[]" value="{{_php_round($data->accumulated_dep_val ?? 0)}}" readonly>
                      ...
                      <td>
                         <input class="form-control book_value" type="number" min="0" step="any" name="book_value[]" value="{{_php_round($data->book_value ?? 0)}}" readonly>
                     </td>
