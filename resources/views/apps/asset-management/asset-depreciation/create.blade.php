...
<div class="container-fluid">
 ...
 @if($message_duplicate !='')
            <h4 style="text-align: center;color: red;">{!! $message_duplicate ?? '' !!}</h4>
  @endif
             @if(sizeof($datas ) > 0 && $message_duplicate =='')
          <div class="col-12 ">
              ...
              <div class="row">
                ...
                <table class="table table-borderd">
                  <thead>
                    <tr>
                      <th>SL
<input class="form-control id" type="hidden" name="id" value="{{$data->id ?? ''}}" >
                      </th>
