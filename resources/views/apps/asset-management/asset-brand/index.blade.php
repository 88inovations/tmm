...
@include('messages.language_message')
 <nav class="mb-2" aria-label="breadcrumb">
          <ol class="breadcrumb mb-0">
            ...
            @can('asset-brand-list')
            <li class="breadcrumb-item"><a href="{{route('asset-brand.index')}}">{{__('label.asset-brand')}}</a></li>
            @endcan
          </ol>
        </nav>
        <div class="mb-9">
        ...
        <div id="orderTable" data-list='{"valueNames":["name","code","description","status","order","created_at","updated_at"],"page":10,"pagination":true}'>
              ...
              <div class="row g-3">
                ...
                <div class="col-auto">
                  @can('asset-brand-create')
                  <a class="btn btn-primary "
                  href="{{route('asset-brand.create')}}"
             ...
             <td class=" align-middle white-space-nowrap ps-8">
                      <div class="d-flex align-items-center text-90">
                         @can('asset-brand-edit')
                            <a class="mr-10"  href="{{ route('asset-brand.edit',$value->id) }}?_lang_ref={!! $lan_data->lang_code ?? 'en_US' !!}" title="{!! $lan_data->lang_name ?? 'English' !!}">
                        ...
                        @endcan
                         ...
                         @can('asset-brand-delete')         
                                    {!! Form::open(['method' => 'DELETE','route' => ['asset-brand.destroy', $value->id],'style'=>'display:inline']) !!}
