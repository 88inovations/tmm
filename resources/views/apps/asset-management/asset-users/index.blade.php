...
@include('messages.language_message')
 <nav class="mb-2" aria-label="breadcrumb">
          <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="{{route('asset-users.index')}}">{{__('label.asset-users')}}</a></li>
            @endcan
          </ol>
        </nav>
        <div class="mb-9">
        ...
        <div id="orderTable" data-list='{"valueNames":["name","phone","address","description","status","order","created_at","updated_at"],"page":10,"pagination":true}'>
                  <div class="mb-4">
              <div class="row g-3">
                <div class="col-auto">
                ...
                <div class="col-auto">
                  @can('asset-users-create')
                  <a class="btn btn-primary "
                  href="{{route('asset-users.create')}}"
             ...
             <td class=" align-middle white-space-nowrap ps-8">
                      <div class="d-flex align-items-center text-90">
                         @can('asset-users-edit')
                            <a class="mr-10"  href="{{ route('asset-users.edit',$value->id) }}?_lang_ref={!! $lan_data->lang_code ?? 'en_US' !!}" title="{!! $lan_data->lang_name ?? 'English' !!}">
                        ...
                        @endcan
                         ...
                         @can('asset-users-delete')         
                                    {!! Form::open(['method' => 'DELETE','route' => ['asset-users.destroy', $value->id],'style'=>'display:inline']) !!}
