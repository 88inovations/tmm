...
<div class="container">
 <nav class="mb-2" aria-label="breadcrumb">
          <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="{{route('inspection-check-category.index')}}">{{$page_name ?? ''}}</a></li>
            @endcan
        ...
        <div class="mb-9">
           ...
           <form class="mb-9" method="post" action="{{ route('inspection-check-category.update', $data->id) }}" enctype='multipart/form-data'>
        @csrf
        @method('PUT')
