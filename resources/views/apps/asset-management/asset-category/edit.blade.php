              ...
              <div class="col-sm-12 mb-1">
                <input required class="form-control  @error('dep_rate') is-invalid @enderror" name="dep_rate" type="number" min="0" step="any" placeholder="{{__('label.dep_rate')}}" value="{{old('dep_rate',$data->dep_rate ?? 0)}}" />
                   ...
                   <h5 class="mb-1 text-1000">{{__('label.asset_dep_ledger_id')}}</h5>
                    ...
                    <div class=" mb-1">
                                        <input type="text" id="_search_asset_dep_ledger_id" name="_search_asset_dep_ledger_id" class="form-control _search_asset_dep_ledger_id" value="{{old('_search_asset_dep_ledger_id',$data->acc_dep_category_ledger->_name ?? '')}}" placeholder="{{__('label.asset_dep_ledger_id')}}"  attr_url="{{url('main-ledger-search')}}"  >
                   ...
                   <h5 class="mb-1 text-1000">{{__('label.asset_dep_exp_ledger_id')}}</h5>
                    ...
                    <div class=" mb-1">
                                        <input type="text" id="_search_asset_dep_exp_ledger_id" name="_search_asset_dep_exp_ledger_id" class="form-control _search_asset_dep_exp_ledger_id" value="{{old('_search_asset_dep_exp_ledger_id',$data->dep_exp_category_ledger->_name ?? '')}}" placeholder="{{__('label.asset_dep_exp_ledger_id')}}"  attr_url="{{url('main-ledger-search')}}"  >
