...
<div class="container-fluid">
 <nav class="mb-2" aria-label="breadcrumb">
        ...
        <div >
              ...
              <div class="row g-3">
                <div class="col-auto">
                  <div class="search-box">
                    <button class="btn btn-warning" type="button" data-bs-toggle="modal" data-bs-target="#AssetAssignSearch"> 
                      <span class="fas fa-search "></span> {{__('label.search_option')}}
                    </button>
            ...
            <td class=" align-middle white-space-nowrap ps-8 ">{!! $value->current_user->_user->name ?? '' !!}</td>
            ...
            <td class=" align-middle white-space-nowrap ps-8 ">{!! $value->category->name ?? '' !!}</td>
            <td class=" align-middle white-space-nowrap ps-8 ">{!! $value->brand->name ?? '' !!}</td>
