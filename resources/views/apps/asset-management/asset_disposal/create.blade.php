...
<div class="row g-0 border-top border-bottom border-300" style="padding:10px; ;">
               <div class="row mb-1">
                             <label class="mb-1 text-1000 col-md-4">{{__('label._date')}}</label>
                              <div class="col-md-8">
                              <input type="date"   name="_date" class="form-control _date" value="{{old('_date')}}" placeholder="{{__('label._date')}}" >
                          </div>
                        </div>
                         <div class="row  mb-1 display_none">
                   ...
                   <label class=" mb-1 text-1000">{{__('label.asset_ledger_id')}}<span class="_required">*</span></label>
                    ...
                    <div class="col-sm-8 mb-1">
                            ...
                            <input type="text" id="_search_main_ledger_id" name="_search_main_ledger_id" class="form-control _search_main_ledger_id" value="{{old('_search_main_ledger_id')}}" placeholder="{{__('label.asset_ledger_id')}}" required  attr_url="{{url('main-ledger-search')}}" readonly>
                   ...
                   <label class=" mb-1 text-1000">{{__('label.asset_dep_exp_ledger_id')}}<span class="_required">*</span></label>
                    ...
                    <div class="col-sm-8 mb-1">
                          ...
                          <div class="row mb-1">
                             ...
                             <div class="col-md-8">
                              <input type="text" name="name" class="form-control asset_name_search" value="{!! old('name') !!}" placeholder="{{__('label.name')}}" attr_url="{{route('asset_search')}}">
