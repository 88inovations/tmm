...
<div class="container-fluid">
        ...
        <form class="mb-9" method="GET" action="{{ route('maintenance_and_repair_costs_report') }}" enctype='multipart/form-data'>
        @csrf
      ...
      <div class="row">
        ...
        <table class="table table-bordered table-sm fs--1 mb-0">
          <thead>
            ...
            <th class=" align-middle ps-8" style="width:10%">{{__('label.technician_name')}}</th>
            <th class=" align-middle ps-8" style="width:10%">{{__('label._note')}}</th>
...
@endphp
        ...
        <td class="= align-middle  ps-8 white-space-nowrap">{!! $value->technician_name ?? '' !!}</td>
        <td class="= align-middle  ps-8 white-space-nowrap">{!! $value->_note ?? '' !!}</td>
        <td class="= align-middle  ps-8 white-space-nowrap">{!! _report_amount($value->cost ?? 0) !!}</td>
        </tr>
        @empty
        <tr>
        <td colspan="12" style="text-align:center;"><b>{!! __('label.no_data_found') !!}</b></td>
        </tr>
        @endforelse
        </tbody>
        <tfoot>
           <tr class="">
        <th colspan="11" class="= align-middle  ps-8 white-space-nowrap">Grand Total</th>
