   ...
   <div class="text-center">
      <address>
        <img src="{{asset('/')}}{{$settings->logo ?? '' }}" style="width:60px;height: 60px;"><br>
           ...
           Date: {{date('d-m-Y')}}<br>
           <b>{!! $condition->name ?? '' !!}  {{__('label.condition_wise_asset_list')}}</b>
        </address>
  </div>
                        ...
                        <table class="table table-bordered table-sm fs--1 mb-0">
                          <thead>
                            ...
                            <th class=" align-middle ps-8" style="width:10%">{{__('label.id')}}</th>
            ...
            <td class="= align-middle  ps-8 white-space-nowrap">{!! $value->id ?? '' !!}</td>
