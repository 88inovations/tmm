      ...
      <address>
       ...
       <table class="table table-bordered table-sm fs--1 mb-0">
        ...
        <tr>
          ...
          <td style="width:25%;text-align: left;font-weight: bold;">{!! $data->category->name ?? '' !!}</td>
        ...
        <tr>
          ...
          <td style="width:25%;text-align: left;font-weight: bold;">{!! $data->brand->name ?? '' !!}</td>
        ...
        <tr>
          ...
          <td style="width:25%;text-align: left;font-weight: bold;">{!! $data->organization->_name ?? '' !!}</td>
          
          <td style="width:25%;text-align: right;">{{__('label._branch_id')}}</td>
          <td style="width:25%;text-align: left;font-weight: bold;">{!! $data->branch->_name ?? '' !!}</td>
        </tr>
        <tr>
          <td style="width:25%;text-align: right;">{{__('label.project_id')}}</td>
          <td style="width:25%;text-align: left;font-weight: bold;">{!! $data->cost_center->_name ?? '' !!}</td>
          
          <td style="width:25%;text-align: right;">{{__('label.asset_location_id')}}</td>
          <td style="width:25%;text-align: left;font-weight: bold;">{!! $data->building->name ?? '' !!}</td>
        </tr>
        <tr>
          <td style="width:25%;text-align: right;">{{__('label.asset_room_id')}}</td>
          <td style="width:25%;text-align: left;font-weight: bold;">{!! $data->room->name ?? '' !!}</td>
        ...
        <tr>
          ...
          <td style="width:25%;text-align: left;font-weight: bold;">{!! $data->warranty_start_date ?? '' !!}</td>
          
          <td style="width:25%;text-align: right;">{{__('label.warranty_end_date')}}</td>
          <td style="width:25%;text-align: left;font-weight: bold;">{!! $data->warranty_end_date ?? '' !!}</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td style="width:25%;text-align: left;font-weight: bold;">{!! $data->purchase_date ?? '' !!}</td>
          
          <td style="width:25%;text-align: right;">{{__('label._date')}}</td>
          <td style="width:25%;text-align: left;font-weight: bold;">{!! $data->_date ?? '' !!}</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td style="width:25%;text-align: left;font-weight: bold;">{!! $data->dep_date ?? '' !!}</td>
          
          <td style="width:25%;text-align: right;">{{__('label.purchase_price')}}</td>
          <td style="width:25%;text-align: left;font-weight: bold;">{!! $data->purchase_price ?? '' !!}</td>
        </tr>
        <tr>
          <td style="width:25%;text-align: right;">{{__('label.extra_cost')}}</td>
          <td style="width:25%;text-align: left;font-weight: bold;">{!! $data->extra_cost ?? '' !!}</td>
          
          <td style="width:25%;text-align: right;">{{__('label.entry_price')}}</td>
          <td style="width:25%;text-align: left;font-weight: bold;">{!! $data->entry_price ?? '' !!}</td>
        </tr>
        <tr>
          <td style="width:25%;text-align: right;">{{__('label.evaluated_price')}}</td>
          <td style="width:25%;text-align: left;font-weight: bold;">{!! $data->evaluated_price ?? '' !!}</td>
        ...
        <tr>
          ...
          <td style="width:25%;text-align: left;font-weight: bold;">{!! $data->dep_rate ?? '' !!}</td>
          
          <td style="width:25%;text-align: right;">{{__('label.dep_value')}}</td>
          <td style="width:25%;text-align: left;font-weight: bold;">{!! $data->dep_value ?? '' !!}</td>
        </tr>
        <tr>
          <td style="width:25%;text-align: right;">{{__('label.accumulated_dep_val')}}</td>
          <td style="width:25%;text-align: left;font-weight: bold;">{!! $data->accumulated_dep_val ?? '' !!}</td>
          
          <td style="width:25%;text-align: right;">{{__('label.book_value')}}</td>
          <td style="width:25%;text-align: left;font-weight: bold;">{!! $data->book_value ?? '' !!}</td>
        </tr>
        <tr>
          <td style="width:25%;text-align: right;"></td>
          <td style="width:25%;text-align: left;font-weight: bold;"></td>
          
          <td style="width:25%;text-align: right;">{{__('label.salvage_value')}}</td>
          <td style="width:25%;text-align: left;font-weight: bold;">{!! $data->salvage_value ?? '' !!}</td>
        </tr>
        <tr>
          <td style="width:25%;text-align: right;">{{__('label._selling_value')}}</td>
          <td style="width:25%;text-align: left;font-weight: bold;">{!! $data->_selling_value ?? '' !!}</td>
          
          <td style="width:25%;text-align: right;">{{__('label._pl_amount')}}</td>
          <td style="width:25%;text-align: left;font-weight: bold;">{!! $data->_pl_amount ?? '' !!}</td>
        </tr>
        <tr>
          <td style="width:25%;text-align: right;">{{__('label._sale_date')}}</td>
          <td style="width:25%;text-align: left;font-weight: bold;">{!! $data->_sale_date ?? '' !!}</td>
        ...
        <tr>
          ...
          <td style="width:25%;text-align: left;font-weight: bold;">{!! $data->current_user->_user->name ?? '' !!}</td>
        </tr>
