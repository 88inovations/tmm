...
<div class="container">
 <nav class="mb-2" aria-label="breadcrumb">
          <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="{{route('asset-actual-location.index')}}">{{__('label.asset-actual-location')}}</a></li>
            @endcan
          </ol>
        </nav>
        <div class="mb-9">
        ...
        <div id="orderTable" data-list='{"valueNames":["name","code","description","status","order","created_at","updated_at"],"page":10,"pagination":true}'>
              ...
              <div class="row g-3">
                ...
                <div class="col-auto">
                  @can('asset-actual-location-create')
                  <a class="btn btn-primary "
                  href="{{route('asset-actual-location.create')}}"
             ...
             <td class=" align-middle white-space-nowrap ps-8">
                      <div class="d-flex align-items-center text-90">
                         @can('asset-actual-location-edit')
                            <a class="mr-4"  href="{{ route('asset-actual-location.edit',$value->id) }}" title="{!! $lan_data->lang_name ?? 'English' !!}">
                        ...
                        @endcan
                         ...
                         @can('asset-actual-location-delete')         
                                    {!! Form::open(['method' => 'DELETE','route' => ['asset-actual-location.destroy', $value->id],'style'=>'display:inline']) !!}
