        ...
        <div class="row mb-2">
          <div class="col-sm-12" style="display: flex;">
           ...
           <ol class="breadcrumb float-sm-right ml-2">
               @can('honorarium_payments_create')
              <li class="breadcrumb-item active">
                <a  
               class="btn btn-sm btn-info active " 
               href="{{ route('honorarium_payments.create') }}">
               ...
               <div class="form-group ">
                   ...
                   <select class="form-control _honorarium_ledger_id select2" name="_honorarium_ledger_id">
                    <option value="">Select Ledger</option>
                       ...
                       <option value="{{$ledger->id}}" @if($ledger->id==$_honorarium_ledger_id) selected @endif > {!! $ledger->_code ?? '' !!} || {!! $ledger->_name ?? '' !!} || {!! $ledger->_branch->_name ?? '' !!} </option>
                       @empty
                       @endforelse
                   </select>
               </div>
                ...
                <div class="">
                  <table class="table table-bordered _list_table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td >
                           <a href="{{ route('honorarium_payments.show',$data->id) }}"
                                 class="btn btn-sm btn-warning mr-2" >Print</a>
                             @can('honorarium_payments_edit')
                                  <a   
                                  href="{{ route('honorarium_payments.edit',$data->id) }}"
...
<script type="text/javascript">
    ...
    console.log(_id)
    var _table_name ="honorarium_payments";
      if($(this).is(':checked')){
