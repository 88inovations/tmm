   ...
   <table class="table table-bordered _list_table">
                     ...
                     <tbody>
                        ...
                        <tr>
                            ...
                            <td  style="white-space: nowrap;">{{ _view_date_formate($data->_admission_date ?? '') }}</td>
                            <td  style="white-space: nowrap;">{{ $data->_edu_session->_name ?? '' }}</td>
                            <td  style="white-space: nowrap;">{{ $data->_edu_division->_name ?? '' }}</td>
                            <td  style="white-space: nowrap;">{{ $data->_edu_class->_name ?? '' }}</td>
                            <td  style="white-space: nowrap;">{{ $data->_student_id ?? '' }}</td>
                            <td  style="white-space: nowrap;">{{ $data->_proximity_card_no ?? '' }}</td>
                            <td  style="white-space: nowrap;">{{ $data->_name_in_english ?? '' }}</td>
                            <td  style="white-space: nowrap;">{{ $data->_f_mobile_no ?? '' }}</td>
                            <td  style="white-space: nowrap;">{{ $data->_mother_mobile_no ?? '' }}</td>
                            <td  style="white-space: nowrap;">{{ $data->_local_guardian_mobile ?? '' }}</td>
                           <td  style="white-space: nowrap;">{{ selected_status($data->_status) }}</td>
