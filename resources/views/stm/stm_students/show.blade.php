...
<div class="_report_button_header">
    <a class="nav-link"  href="{{route('stm_students.index')}}" role="button"><i class="fa fa-arrow-left"></i></a>
 @can('stm_students_edit')
 <a  href="{{ route('stm_students.edit',$data->id) }}" 
...
<h5>Academic Information</h5>
    <table class="table table-bordered">
        <tbody>
            <tr>
                <th>{{ __('label._admission_date') }}</th>
                <td>{{ $_admission_date }}</td>

                <th>{{ __('label._roll_no') }}</th>
                <td>{{ $_roll_no }}</td>
            </tr>
            <tr>
                <th>{{ __('label._student_id') }}</th>
                <td>{{ $_student_id }}</td>

                <th>{{ __('label._proximity_card_no') }}</th>
                <td>{{ $_proximity_card_no }}</td>
            </tr>
            <tr>
                <th>{{ __('label._education_type') }}</th>
                <td colspan="3">{{ $data->_edu_division->_name ?? '' }}</td>
            </tr>
            <tr>
                <th>{{ __('label._admission_session_id') }}</th>
                <td>
                    {!! $data->_edu_session->_name ?? '' !!}
                </td>
                <th>{{ __('label._admission_class_id') }}</th>
                <td>
                    {!! $data->_edu_class->_name ?? '' !!}
                </td>
            </tr>
            ...
            <tr>
                <th>{{ __('label._resedential_type') }}</th>
                <td>
                    @if($data->_resedential_type==1) Non Residential @endif
                    @if($data->_resedential_type==2) Residential @endif
                </td>
            </tr>
             <tr>
                <th>{{ __('label._adminssion_fee_amount') }}</th>
                <td>{{ _report_amount($_adminssion_fee_amount)}}</td>

                <th>{{ __('label._monthly_fee') }}</th>
                <td>{!! _report_amount($_monthly_fee) !!}</td>
            </tr>
        </tbody>
    </table>
</div>
    ...
    <table class="table table-bordered">
        <tbody>
            ...
            <tr>
                <th>{{ __('label._gender') }}</th>
                <td>{{ $_gender ?? '' }}</td>

                <th>{{ __('label._date_of_birth') }}</th>
                <td>{{ _view_date_formate($_date_of_birth) }}</td>
            </tr>
            <tr>
                <th>{{ __('label._barth_id') }}</th>
                <td>{{ $_barth_id ?? '' }}</td>
            ...
            <tr>
                <th>{{ __('label._bloodgroup') }}</th>
                <td>{{ $data->_bloodgroup ?? '' }}</td>

                <th>{{ __('label._religion_Id') }}</th>
                <td>{{ $_religion ?? '' }}</td>

            </tr>
            <tr>
                <th>{{ __('label._s_identification_mark') }}</th>
                <td>{{ $data->_s_identification_mark ?? '' }}</td>

                <th>{{ __('label._nationality') }}</th>
                <td>{{ $_nationality ?? '' }}</td>
                ...
                <td>{{ $_weight ?? '' }}</td>
                                ...
                                <table class="table table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>{{ __('label._cur_country_id') }}</th>
                                            <td>{{ $data->_cur_country->countryname ?? '' }}</td>

                                            <th>{{ __('label._cur_division_id') }}</th>
                                            <td>{{ $data->_cur_division->name ?? '' }}</td>
                                            <th>{{ __('label._cur_district_id') }}</th>
                                            <td>{{ $data->_cur_district->name ?? '' }}</td>
                                        </tr>
                                        <tr>
                                            <th>{{ __('label._cur_thana_id') }}</th>
                                            <td>{{ $data->_cur_thana->name ?? '' }}</td>

                                            <th>{{ __('label._cur_union_id') }}</th>
                                            <td>{{ $data->_cur_union->postOffice ?? '' }}</td>
                                            <th>{{ __('label._cur_post_office') }}</th>
                                            <td>{{ $data->_cur_post_office ?? '' }}</td>
                                        </tr>
                                        <tr>
                                            <th>{{ __('label._present_address') }}</th>
                                            <td colspan="5">{!! $data->_present_address ?? '' !!}</td>
                                        </tr>
                                ...
                                <table class="table table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>{{ __('label._per_country_id') }}</th>
                                            <td>{{ $data->_per_country->countryname ?? '' }}</td>

                                            <th>{{ __('label._per_division_id') }}</th>
                                            <td>{{ $data->_per_division->name ?? '' }}</td>
                                            <th>{{ __('label._per_district_id') }}</th>
                                            <td>{{ $data->_per_district->name ?? '' }}</td>
                                        </tr>
                                        <tr>
                                            <th>{{ __('label._per_thana_id') }}</th>
                                            <td>{{ $data->_per_thana->name ?? '' }}</td>

                                            <th>{{ __('label._per_union_id') }}</th>
                                            <td>{{ $data->_per_union->postOffice ?? '' }}</td>
                                            <th>{{ __('label._per_post_office') }}</th>
                                            <td>{{ $data->_per_post_office ?? '' }}</td>
                                        </tr>
                                        <tr>
                                            <th>{{ __('label._parmanent_address') }}</th>
                                            <td colspan="5">{!! $data->_parmanent_address ?? '' !!}</td>
                                        </tr>
                            ...
                            <div class="card-body section-div p-2">
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $data->_father_name_bangla ?? '' }}</td>

                                            <th>{{ __('label._father_name_english') }}</th>
                                            <td>{{ $data->_father_name_english ?? '' }}</td>
                                            <th>{{ __('label._occupation') }}</th>
                                            <td>{{ $data->_occupation ?? '' }}</td>
                                        </tr>
                                        <tr>
                                            <th>{{ __('label._annual_income') }}</th>
                                            <td>{{ $data->_annual_income ?? '' }}</td>

                                            <th>{{ __('label._f_mobile_no') }}</th>
                                            <td>{{ $data->_f_mobile_no ?? '' }}</td>
                                            <th>{{ __('label._f_nid_no') }}</th>
                                            <td>{{ $data->_f_nid_no ?? '' }}</td>
                                        </tr>
                                    </tbody>
                                ...
                                <table class="table table-bordered mb-2">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>{{ __('label._mother_name_of_bangla') }}</th>
                                            <td>{{ $data->_mother_name_of_bangla ?? '' }}</td>

                                            <th>{{ __('label._mother_name_english') }}</th>
                                            <td>{{ $data->_mother_name_english ?? '' }}</td>
                                            <th>{{ __('label._mother_occupation') }}</th>
                                            <td>{{ $data->_mother_occupation ?? '' }}</td>
                                        </tr>
                                        <tr>
                                             <th>{{ __('label._mother_anual_income') }}</th>
                                            <td>{{ $data->_mother_anual_income ?? '' }}</td>
                                            <th>{{ __('label._mother_mobile_no') }}</th>
                                            <td>{{ $data->_mother_mobile_no ?? '' }}</td>

                                           
                                            <th>{{ __('label._mother_nid_no') }}</th>
                                            <td>{{ $data->_mother_nid_no ?? '' }}</td>
                                        </tr>
                                    </tbody>
                                ...
                                <table class="table table-bordered mb-2">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>{{ __('label._local_guardian_name') }}</th>
                                            <td>{{ $data->_local_guardian_name ?? '' }}</td>
                                            <th>{{ __('label._local_guardian_address') }}</th>
                                            <td >{{ $data->_local_guardian_address ?? '' }}</td>

                                          
                                        </tr>
                                        <tr>
                                             
                                            <th>{{ __('label._local_guardian_mobile') }}</th>
                                            <td>{{ $data->_local_guardian_mobile ?? '' }}</td>
                                            <th>{{ __('label._local_guardian_nid') }}</th>
                                            <td>{{ $data->_local_guardian_nid ?? '' }}</td>
                            ...
                            <div class="card-body section-div p-2">
                                ...
                                <table class="table table-bordered mb-2">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>{{ __('label._previous_institute_name') }}</th>
                                            <td>{{ $data->_previous_institute_name ?? '' }}</td>

                                            <th>{{ __('label._pre_class') }}</th>
                                            <td>{{ $data->_pre_class ?? '' }}</td>
                                            <th>{{ __('label._pre_result') }}</th>
                                            <td>{{ $data->_pre_result ?? '' }}</td>
                                        </tr>
                                        <tr>
                                            <th>{{ __('label._pre_roll_no') }}</th>
                                            <td>{{ $data->_pre_roll_no ?? '' }}</td>
