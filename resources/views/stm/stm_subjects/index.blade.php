      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12" style="display: flex;">
            <a class="m-0 _page_name" href="{{ route('stm_subjects.index') }}">{!! $page_name ?? '' !!} </a>
            <ol class="breadcrumb float-sm-right ml-2">
               @can('stm_subjects_create')
             <li class="breadcrumb-item active">
                <a type="button" 
               class="btn btn-sm btn-info" 
              
               href="{{ route('stm_subjects.create') }}">
                     ...
                     <tbody>
                        ...
                        <tr>
                             ...
                             <td style="display: flex;">
                              @can('stm_subjects_delete')
                                 {!! Form::open(['method' => 'DELETE','route' => ['stm_subjects.destroy', $data->id],'style'=>'display:inline']) !!}
                               ...
                               @endcan 
                              <a  type="button" 
                                  href="{{ route('stm_subjects.show',$data->id) }}"
                                  class="btn btn-sm btn-default  mr-2"><i class="fa fa-eye"></i></a>

                             @can('stm_subjects_edit')
                                  <a  type="button" 
                                  href="{{ route('stm_subjects.edit',$data->id) }}"
