                  ...
                  <table class="table table-bordered _list_table">
                     <thead>
                        <tr>
                         ...
                         <th class=""><b>{{__('label.countrycode')}}</b></th>
                         <th class=""><b>{{__('label._name')}}</b></th>
                         <th class=""><b>{{__('label._code')}}</b></th>
                         <th class=""><b>{{__('label.language_code')}}</b></th>
                         <th class=""><b>{{__('label.language_name')}}</b></th>
                      </tr>
                     </thead>
                     <tbody>
                        ...
                        <tr>
                             ...
                             <td style="display: flex;">
                              @can('countries_delete')
                                 {!! Form::open(['method' => 'DELETE','route' => ['countries.destroy', $data->id],'style'=>'display:inline']) !!}
                               ...
                               @endcan 
                              <a  type="button" 
                                  href="{{ route('countries.show',$data->id) }}"
                                  class="btn btn-sm btn-default  mr-2"><i class="fa fa-eye"></i></a>

                             @can('countries_edit')
                                  <a  type="button" 
                                  href="{{ route('countries.edit',$data->id) }}"
