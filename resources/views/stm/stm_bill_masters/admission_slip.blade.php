...
<div class="_report_button_header">
 <a class="nav-link"  href="{{route('admission_fee_collection_list')}}" role="button"><i class="fa fa-arrow-left"></i></a>
...
$_collect_ledgers[]= $d_data->_collection_ledger_id ?? 0;
        ...
        <tr>
          <td>Admission Fee</td>
          <td class="text-right">{!! _report_amount($d_data->_receive_amount ?? 0) !!}</td>
        </tr>
        ...
        <tr>
          <th>Total</th>
          <th class="text-right">{!! _report_amount($_receive_amount_total) !!}</th>
        </tr>
      </tbody>
    </table>

    <p><strong>Amount in Words:</strong> {{nv_number_to_text($_receive_amount_total)}}</p>
