      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12" style="display: flex;">
            <a class="m-0 _page_name" href="{{ route('stm_divisions.index') }}">{!! $page_name ?? '' !!} </a>
            <ol class="breadcrumb float-sm-right ml-2">
               @can('stm_divisions_create')
             <li class="breadcrumb-item active">
                <a type="button" 
               class="btn btn-sm btn-info" 
              
               href="{{ route('stm_divisions.create') }}">
                     ...
                     <tbody>
                        ...
                        <tr>
                             ...
                             <td style="display: flex;">
                              @can('stm_divisions_delete')
                                 {!! Form::open(['method' => 'DELETE','route' => ['stm_divisions.destroy', $data->id],'style'=>'display:inline']) !!}
                               ...
                               @endcan 
                              <a  type="button" 
                                  href="{{ route('stm_divisions.show',$data->id) }}"
                                  class="btn btn-sm btn-default  mr-2"><i class="fa fa-eye"></i></a>

                             @can('stm_divisions_edit')
                                  <a  type="button" 
                                  href="{{ route('stm_divisions.edit',$data->id) }}"
