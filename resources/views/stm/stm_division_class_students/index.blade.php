      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="">
           <div class="row mb-2">
                  <div class="col-sm-6">
                    <a class="m-0 _page_name" href="{{ route('stm_division_class_students') }}">{!! $page_name !!} </a>
                  </div><!-- /.col -->
                  <div class="col-sm-6">
...
@endphp
           ...
           <form class="" action="{{route('stm_division_class_students')}}" method="GET">
            @csrf
...
<form action="{{route('stm_division_class_students_store')}}" method="POST">
    @csrf
...
<div class="col-xs-12 col-sm-12 col-md-12">
    ...
    <thead>
        <tr>
            ...
            <th>{{__('label._anual_fee')}}</th>
            <th>{{__('label._monthly_food_fee')}}</th>
            <th>{{__('label._residential_fee')}}</th>
            <th>{{__('label._other_fee')}}</th>
            <th>{{__('label._other_2_fee')}}</th>
            <th>{{__('label._other_3_fee')}}</th>
...
@endphp
        <tr>
            ...
            <td>{{($key+1)}}
                ...
                <input type="hidden" name="id[]" value="{{$_d_c_s->id ?? 0}}">
            ...
            <td>
                <select class="form-control _class_id" name="_class_id[]">
                  ...
                  @forelse($edu_class as $class)
                    <option value="{{$class->id }}"
                     @if($_stuendt_class_id ==$class->id) selected @endif > {!! $class->_name ?? '' !!} </option>
                  @empty
                  @endforelse
            ...
            <td class ="white_space">
                {!! $_d_c_s->_student->_name_in_english ?? '' !!}
            </td>
            <td>
            ...
            <td>
                <input type="number" name="_anual_fee[]" class="form-control _anual_fee" min="0" step="any" placeholder="{{__('label._anual_fee')}}" value="{{$_anual_fee}}">
            </td>
            <td>
            ...
            <td>
                <input type="number" name="_other_fee[]" class="form-control _other_fee" min="0" step="any" placeholder="{{__('label._other_fee')}}" value="{{$_other_fee}}">
            </td>
            <td>
                <input type="number" name="_other_2_fee[]" class="form-control _other_2_fee" min="0" step="any" placeholder="{{__('label._other_2_fee')}}" value="{{$_other_2_fee}}">
            </td>
            <td>
                <input type="number" name="_other_3_fee[]" class="form-control _other_3_fee" min="0" step="any" placeholder="{{__('label._other_3_fee')}}" value="{{$_other_3_fee}}">
            </td>
            <td>
