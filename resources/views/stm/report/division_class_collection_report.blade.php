                      ...
                      <div class="report_box">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2">
                          ...
                          <select name="_bill_type" class="form-control _bill_type" >
                            ...
                            <option value="_admission_fee">{{ __('label._admission_fee') }}</option>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-2 mt-3 mb-2 ">
                                   <button type="button" class="btn btn-primary due_bill_search_button" attr_url="{{route('division_class_collection_list')}}"><i class="fa fa-search "></i> Report</button>
