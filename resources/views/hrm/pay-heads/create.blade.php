  ...
  <div class="content ">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card">
           <div class="row mb-2">
                  <div class="col-sm-6">
                    <a class="m-0 _page_name" href="{{ route('pay-heads.index') }}">{!! $page_name !!} </a>
                  </div><!-- /.col -->
                  <div class="col-sm-6">
    ...
    @include('backend.message.message')
            ...
            <div class="card-body p-4" >
                {!! Form::open(array('route' => 'pay-heads.store','method'=>'POST')) !!}
                
                      <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <label>{{__('label._payhead')}}:</label>
                                <input type="text" name="_ledger" class="form-control" value="{{old('_ledger')}}">
                            </div>
                        </div>
                      <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <input type="hidden" id="_main_ledger_id" name="_ledger_id" class="form-control _main_ledger_id" value="{{old('_main_ledger_id')}}" placeholder="{{__('label._ledger_id')}}" required>
