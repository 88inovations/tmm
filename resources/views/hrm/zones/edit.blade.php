...
@section('content')
  ...
  <div class="content ">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card">
           <div class="row mb-2">
                  <div class="col-sm-6">
                    <a class="m-0 _page_name" href="{{ route('zones.index') }}">{!! $page_name !!} </a>
                  </div><!-- /.col -->
                  <div class="col-sm-6">
    ...
    @include('backend.message.message')
            ...
            <div class="card-body p-4" >
               {!! Form::model($data, ['method' => 'PATCH','route' => ['zones.update', $data->id]]) !!}
                <div class="form-group row">
     <label class="col-md-3">{!! __('label.organization') !!}:<span class="_required">*</span></label>
 ...
 <div class="form-group row">
     <label class="col-md-3">Branch:<span class="_required">*</span></label>
     <div class="col-xs-12 col-sm-12 col-md-9">
    <select class="form-control _master_branch_id" name="_branch_id" required >
       ...
       @endforelse
                            ...
                            <div class="form-group row">
                                <label class="col-md-3">{{__('label._name')}}:<span class="_required">*</span></label>
                      <div class="col-xs-12 col-sm-12 col-md-9">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3">{{__('label._details')}}:</label>
                      <div class="col-xs-12 col-sm-12 col-md-9">
                        <textarea class="form-control" name="_detail">{{old('_details',$data->_details ?? '' )}}</textarea>
                                
                            </div>
                        </div>
                      
                            <div class="form-group row">
                                <label class="col-md-3">{{__('label._status')}}:</label>
                      <div class="col-xs-12 col-sm-12 col-md-9">
