  ...
  <div class="content ">
    ...
    @include('backend.message.message')
            ...
            <div class="card-body p-4" >
                {!! Form::open(array('url' => 'salary_sheet_generate','method'=>'POST','enctype'=>'multipart/form-data')) !!}
...
<label class="col-sm-2 col-form-label _required" >{{__('label._month')}}:</label>
    ...
    ?>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-5 ">
                         ...
                         <div class="form-group row">
                             <label class="col-md-2">{{__('label._branch_id')}}:</label>
                        <div class="col-xs-12 col-sm-12 col-md-5 ">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 mt-4 mb-4  text-middle">
                            <button type="submit" class="btn btn-success  ml-5"><i class="fa fa-credit-card mr-2" aria-hidden="true"></i> {{__('label.submit')}}</button>
