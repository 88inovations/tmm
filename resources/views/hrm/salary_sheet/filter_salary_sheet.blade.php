  ...
  <div class="content ">
    ...
    @include('backend.message.message')
            ...
            <div class="card-body p-4" >
                {!! Form::open(array('url' => 'salary_sheet','method'=>'GET','enctype'=>'multipart/form-data')) !!}
                      ...
                      @php
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-5">
                            ...
                            <div class="form-group row">
                                <label class="col-md-2">{!!__('label.employee_category_id') !!}:<span class="_required">*</span></label>
                            ...
                            <div class="form-group row">
                                <label class="col-md-2">{!!__('label._department_id') !!}:<span class="_required">*</span></label>
                        ...
                        <div class="col-md-5 display_flex">
                            ...
                            <div class="form-group row">
                                <label class="col-md-2">{!!__('label._grade_id') !!}:<span class="_required">*</span></label>
                        <div class="col-md-5 display_flex">
