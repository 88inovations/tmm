...
<div class="card-body">
   @include('backend.message.message')
                 {!! Form::model($data, ['method' => 'PATCH','route' => ['attandance.update', $data->id]]) !!}
...
<div class="tab-pane active" id="tab1">
    ...
    <div class="form-group row pt-2">
                            <label class="col-sm-2 col-form-label" >{{__('EMP ID')}}:</label>
                             <div class="col-sm-6">
                                <input type="hidden" name="_employee_id" class="_employee_id" value="" value="{{old('_employee_id',$data->_employee_id)}}">
                                
                                <input type="text" name="_employee_id_text" class="form-control _employee_id_text" placeholder="{{__('EMP ID')}}" value="{{old('_employee_id_text',$data->_employee_info->_code ?? '')}}" required>
                ...
                <div class="form-group row pt-2">
                            <label class="col-sm-2 col-form-label" >{{__('Employee Name')}}:</label>
                             <div class="col-sm-6">
                                <input type="text" name="_employee_name_text" class="form-control _employee_name_text" placeholder="{{__('Employee')}}" value="{{old('_employee_name_text',$data->_employee_info->_name ?? '' )}}" required>
                               <div class="search_box_employee"> </div>
                            </div>
                        </div>
     ...
     <div class="form-group row">
            <label class="col-sm-2 col-form-label"  for="_datetime" class="_required">{{__('label._date')}}:</label>
            <div class="col-sm-3 ">
                <input type="date" name="_datetime" class="form-control" value="{{$data->_datetime ?? ''}}">
            </div>
    </div>
     
     <div class="form-group row">
        <label class="col-sm-2 col-form-label" for="in_time">{{__('label.in_time')}}:</label>
        <div class="col-sm-2">
            <input class="form-group" type="time" id="in_time" name="in_time" value="{{ $data->in_time ?? '' }}" required>
        </div>
</div>
     <div class="form-group row">
        <label class="col-sm-2 col-form-label" for="out_time">{{__('label.out_time')}}:</label>
        <div class="col-sm-2">
            <input class="form-group" type="time" id="out_time" name="out_time" value="{{$data->out_time ?? '' }}" >
        </div>
</div>
     <div class="form-group row">
        <label class="col-sm-2 col-form-label" for="remarks">{{__('label.remarks')}}:</label>
        <div class="col-sm-6">
            <input class="form-control" type="text" id="remarks" name="remarks" value="{{$data->remarks ?? ''}}" >
        </div>
</div>
