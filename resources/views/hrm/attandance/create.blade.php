...
<div class="tab-pane active" id="tab1">
    ...
    <div class="form-group row">
            ...
            <div class="col-sm-3 ">
                <input type="date" name="_datetime" class="form-control" value="{{old('_datetime')}}">
            </div>
    </div>
     ...
     <div class="form-group row">
        ...
        <div class="col-sm-2">
            <input class="form-group" type="time" id="in_time" name="in_time" value="{{old('in_time')}}" required>
        </div>
</div>
     <div class="form-group row">
        <label class="col-sm-2 col-form-label" for="out_time">{{__('label.out_time')}}:</label>
        <div class="col-sm-2">
            <input class="form-group" type="time" id="out_time" name="out_time" value="{{old('out_time')}}" >
        </div>
</div>
     <div class="form-group row">
        <label class="col-sm-2 col-form-label" for="remarks">{{__('label.remarks')}}:</label>
        <div class="col-sm-6">
            <input class="form-control" type="text" id="remarks" name="remarks" value="{{old('remarks')}}" >
        </div>
</div>
