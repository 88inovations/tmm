              ...
              <div class="modal-content">
                ...
                <div class="modal-body search_modal">
                 @php 
                  ...
                  <div class="form-group row">
                    <label for="_order_number" class="col-sm-3 col-form-label">{{__('label._month')}}:</label>
                    <div class="col-sm-9">
                     <select class="form-control _month" name="_month">
                                    <option value="">{{__('label.select')}}</option>
                                    @forelse(_month_names() as $month_key=>$month)
                                    <option value="{{$month_key}}" @if($request->_month && $request->_month==$month_key) selected @endif >{{$month ?? '' }}</option>
                                    @empty
                                    @endforelse
                                </select>
                    </div>
...
$year_array=[];
$currentYear = date('Y');
$requested_year = $request->_year ?? $currentYear;
...
for ($i = 2; $i > 0; $i--) {
    ...
    array_push($year_array,$currentYear);
    array_push($year_array,$nextYear);
   

?>

                        <select name="_year" class="form-control">
                          <option value="">{{__('label._year')}}</option>
                          @forelse($year_array as $year)
                          <option value="{{$year}}"  @if($year ==$requested_year) selected @endif >{{$year}}</option>
                          @empty
                          @endforelse
                          </select>
                    </div>
                  ...
                  <div class="form-group row">
                    <label for="_cost_center_id " class="col-sm-3 col-form-label">{{__('label._cost_center_id')}}:</label>
                    <div class="col-sm-9">
                  ...
                  <div class="form-group row">
                    <label for="_ledger_id " class="col-sm-3 col-form-label">Customer:</label>
                    <div class="col-sm-9">
                  ...
                  <div class="form-group row">
                    <label for="_sales_man_id" class="col-sm-3 col-form-label">Sales Man:</label>
                    <div class="col-sm-9">
