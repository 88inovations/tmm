...
<div class="card-body">
                ...
                <div class="form-group row ">
                            ...
                            <label class="col-sm-1 col-form-label" >{{__('label.id')}}:</label>
                            <div class="col-md-1">
                            ...
                            <label class="col-sm-2 col-form-label" >{{__('label._month')}}:</label>
                            <div class="col-md-2">
                                <select class="form-control _month" name="_month">
                                    <option value="">{{__('label.select')}}</option>
                                    @forelse(_month_names() as $month_key=>$month)
                                    <option value="{{$month_key}}" @if($data->_month==$month_key) selected @endif >{{$month ?? '' }}</option>
                                    @empty
                                    @endforelse
                                </select>
                            </div>
                    <label class="col-sm-1 col-form-label" >{{__('label._year')}}:</label>
                             <div class="col-sm-1">
    ...
    for ($i = 2; $i > 0; $i--) {
        $year = $currentYear - $i;
        echo "<option value='$year' @if($data->_year==$year) selected @endif>$year</option>";
    }

    // Display the current year
    echo "<option value='$currentYear' @if($data->_year==$currentYear) selected @endif>$currentYear</option>";

    // Display the next year
    $nextYear = $currentYear + 1;
    echo "<option value='$nextYear'  @if($data->_year==$nextYear) selected @endif>$nextYear</option>";
    ?>
</select>
                ...
                <div class="form-group row ">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="_employee_id_text" class="form-control _employee_id_text" placeholder="{{__('EMP ID')}}" value="{{$data->_emp_code}}">
                ...
                <div class="form-group row ">
                    <label class="col-md-2 col-form-label" >{{__('label.organization_id')}}:</label>
                     <div class="col-md-4">
                        <input type="text" name="organization_id_name" class="form-control organization_id_name" placeholder="{{__('label.organization_id')}}" readonly value="{{$data->_organization->_name ?? '' }}">
                         <input type="hidden" name="organization_id" class="organization_id" value="{{$data->organization_id}}">
                    </div>
                    <label class="col-md-2 col-form-label" >{{__('label._branch_id')}}:</label>
                     <div class="col-md-4">
                        <input type="text" name="_branch_id_name" class="form-control _branch_id_name" placeholder="{{__('label._branch_id')}}" readonly value="{{$data->_branch->_name ?? '' }}">
                         <input type="hidden" name="_branch_id" class="_branch_id" value="{{$data->_branch_id}}">
                    </div>
                ...
                <div class="form-group row ">
                    <label class="col-md-2 col-form-label" >{{__('label._cost_center_id')}}:</label>
                     <div class="col-md-4">
                        <input type="text" name="_cost_center_id_name" class="form-control _cost_center_id_name" placeholder="{{__('label._cost_center_id')}}" readonly value="{{$data->_cost_center->_name ?? '' }}">
                         <input type="hidden" name="_cost_center_id" class="_cost_center_id" value="{{$data->_cost_center_id}}">
                    </div>
                ...
                <div class="form-group row ">
                    <label class="col-md-2 col-form-label" >{{__('Department')}}:</label>
                     <div class="col-md-4">
                        <input type="text" name="_department" class="form-control _department" placeholder="{{__('Department')}}" readonly value="{{$data->_emp_department->_name ?? '' }}">
                         <input type="hidden" name="_department_id" class="_department_id" value="{{$data->_department_id}}">
                    </div>
                    <label class="col-md-2 col-form-label" >{{__('Designation')}}:</label>
                     <div class="col-md-4">
                        <input type="text" name="_emp_designation" class="form-control _emp_designation" placeholder="{{__('Designation')}}" readonly value="{{$data->_emp_designation->_name ?? ''}}">
                        <input type="hidden" name="_jobtitle_id" class="_jobtitle_id" value="{{$data->_jobtitle_id ?? ' '}}">
                    </div>
                </div>
                ...
                <div class="form-group row ">
                    <label class="col-md-2 col-form-label" >{{__('Grade')}}:</label>
                     <div class="col-md-4">
                        <input type="text" name="_emp_grade" class="form-control _emp_grade" placeholder="{{__('Grade')}}" readonly value="{{$data->_emp_grade->_name ?? '' }}">
                        <input type="hidden" name="_grade_id" class="_grade_id" value="{{$data->_grade_id}}">
                    </div>
                    <label class="col-md-2 col-form-label" >{{__('Emp Category')}}:</label>
                     <div class="col-md-4">
                        <input type="text" name="_employee_cat" class="form-control _employee_cat" placeholder="{{__('Emp Category')}}" readonly value="{{$data->_employee_cat->_name ?? '' }}">
                         <input type="hidden" name="_category_id" class="_category_id" value="{{$data->_category_id ?? ''}}">
                    </div>
                </div>
                    ...
                    <div class="col-md-3">
                            <table class="">
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" step="any" min="0" name="_present_days" class="form-control _present_days" value="{{$data->_present_days ?? 0}}">
                                    </td>
                                </tr>
                                <tr>
                                    <td>{{__('label._absent_days')}}</td>
                                    <td>
                                        <input type="number" step="any" min="0" name="_absent_days" class="form-control _absent_days" value="{{$data->_absent_days ?? 0}}">
                                    </td>
                                </tr>
                                <tr>
                                    <td>{{__('label._arrdays')}}</td>
                                    <td>
                                        <input type="number" step="any" min="0" name="_arrdays" class="form-control _arrdays" value="{{$data->_arrdays ?? 0}}">
                                    </td>
                                </tr>
                                <tr>
                                    <td>{{__('label._paydays')}}</td>
                                    <td>
                                        <input type="number" step="any" min="0" name="_paydays" class="form-control _paydays" value="{{$data->_paydays ?? 0}}">
                                    </td>
                                </tr>
                            </table>
                    </div>
                        ...
                        @if(sizeof($p_val) > 0)
                            ...
                            <label class="col-sm-6 col-form-label" for="_item">{{$l_val->_ledger ?? '' }}:</label>
                             <div class="col-sm-6">
                              ...
                              <input type="number"  name="_amount[]" class="form-control payhead_amount payhead_amount__{{$l_val->id}}  @if(isset($l_val->_payhead_type) && $l_val->_payhead_type->cal_type==1) _add_salary @endif  @if($l_val->_payhead_type->cal_type==2) _deduction_salary @endif"
