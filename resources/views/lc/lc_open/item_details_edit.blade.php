<!-- LC Item Details Section -->
 @if(isset($lc_item_costs) && sizeof($lc_item_costs) > 0)
                                ...
                                <div class="table-responsive">
                                      <table class="table table-bordered" >
                                          <thead >
                                            ...
                                            <th class="text-left" >LC Item Row</th>
...
@endphp
                                            ...
                                            @forelse($lc_item_costs as $key=>$item)

@php
$total_qty   +=$item->item_quantity ?? 0;
$_total_qty_amount   +=$item->_qty ?? 0;
$total_value  +=$item->_value ?? 0;
@endphp
                                            <tr class="_purchase_row">
                                              <td>
                                                {{$item->id ?? 0}}
                                                <input type="hidden" name="lc_item_costs_id[]" value="{{$item->id ?? 0}}">
                                              </td>
                                              <td>
                                                  <input type="text" name="purchase_detail_id[]" class="form-control purchase_detail_id" value="{{$item->_lc_item_id ?? ''}}" readonly>
                                              </td>
                                              <td class="__lc_cost_item_ledger">
                                                <select class="form-control _cost_deduct_ledger_id" name="_cost_deduct_ledger_id[]">
                                                  <option value="{{$item->_cost_deduct_ledger_id ?? ''}}">{{$item->_ledger->_name ?? ''}}</option>
                                                  
                                                </select>
                                              </td>
                                              <td class="__lc_cost_adjust_type">
                                                <select class="form-control _adjust_type" name="_adjust_type[]">
                                                  <option value="1" @if($item->_adjust_type==1) selected @endif >Add Cost</option>
                                                  <option value="2" @if($item->_adjust_type==2) selected @endif >Deduction</option>
                                                </select>
                                              </td>
                                              <td>
                                              ...
                                              <td>
                                                <input type="text" name="_search_item_id[]" class="form-control  width_280_px" placeholder="Item" value="{{$item->_items->_name ?? '' }}" readonly>
        ...
        attr_item_id="{{$conversion_units->_item_id}}"
                                              ...
                                              <td class="">
                                                <input type="text" name="_hs_code[]" class="form-control _hs_code 1__hs_code "  id="1__hs_code" value="{!! $item->_items->_hs_code ?? '' !!}">

                                                <input type="hidden" name="_ref_counter[]" value="{{($key+1)}}" class="_ref_counter" id="1__ref_counter">

                                              </td>
                                              <td class="">
                                                <input type="text" name="_hs_code_2[]" class="form-control _hs_code_2 1__hs_code_2 "  id="1__hs_code_2" value="{{$item->_items->_hs_code_2 ?? '' }}">
                                              ...
                                              <td>
                                                <input type="number" name="item_quantity[]" class="form-control item_quantity " value="{{$item->item_quantity ?? 0}}" readonly>
                                              </td>
                                              <td>
                                          ...
                                          <tfoot>
                                            <tr>
                                              ...
                                              <td>
                                                <input type="number" step="any" min="0" name="_order_qty" class="form-control _order_qty" value="{{$total_qty ?? 0}}" readonly required>
                                              </td>
                                              <td>
