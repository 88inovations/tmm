            ...
            <div class="card">
              <div class="card-header border-0 mt-1">
                <div class="row">
                   ...
                   @endphp
                    <div class="col-md-4">
                       @include('backend.sales-order.search')
                    </div>
                    <div class="col-md-8">
                  ...
                  <table class="table table-bordered _list_table">
                      <thead>
                        <tr>
                         ...
                         <th class=""><b>{{__('label._delivery_date')}}</b></th>
                      ...
                      @endphp
                        ...
                        <tr>
                          ...
                          <td style="display: flex;">
                                ...
                                <a target="__blank"  class=" btn btn-sm btn-default  mr-2" href="{{url('sales-order/print')}}/{{$data->id}}" ><i class="fa fa-eye "></i> </a>
                                ...
                                @can('sales-order-delete')
                                    <a class="btn btn-sm btn-danger  mr-1" onclick="return confirm('Are you Sure?')" href="{{ url('sales-order-delete') }}/{{$data->id}}">
                            ...
                            <td>{{ $data->id }}</td>
                               <td>
                                 @can('order_to_sales_invoice')
                                 <a class="btn btn-sm btn-info" href="{{url('order_to_invoice')}}/{{$data->id}}">Make Invoice</a>
                                 @endcan
                               </td>
                            <td>
                              <span class=" btn btn-sm @if($data->_delivery_status==4) btn-success @else btn-danger  @endif" >{{ _selected_delivery_status($data->_delivery_status ?? 1) }}</span>
                            </td>
                            <td>{{ _view_date_formate($data->_date ?? '') }}</td>
                            <td>{{ _view_date_formate($data->_delivery_date ?? '') }}</td>
                            <td>{{ _find_ledger($data->_sales_man_id ?? '') }}</td>
                              ...
                              <table class="table">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                     ...
                                     @endphp
                                            <td class="" >{!! $_item->_items->_code ?? '' !!}</td>
                                            <td class="" >{!! $_item->_items->_name ?? '' !!}</td>
                                            <td class="" >{!! $_item->_trans_unit->_name ?? '' !!}</td>
                                            <td class="" >{!!  id_to_cloumn($_item->_items->_pack_size_id,'_name','item_pack_sizes') !!}</td>
                                          
                                            <td class="text-left" >{!! _report_amount($_item->sale_qty ?? 0) !!}</td>
                                            <td class="text-left" >{!! _report_amount($_item->free_qty ?? 0) !!}</td>
                                            <td class="text-left" >{!! _report_amount($_item->_qty ?? 0) !!}</td>
                                            <td class="text-right" >{!! _report_amount($_item->_rate ?? 0) !!}</td>
                                            <td class="text-right" >{!! _report_amount($_item->_discount ?? 0) !!}</td>
