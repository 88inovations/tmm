               ...
               <form action="{{route('import-purchase.store')}}" method="POST" class="purchase_form" >
                @csrf
                       ...
                       <div class="col-xs-12 col-sm-12 col-md-2">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 ">
                            <div class="form-group">
                              <label class="mr-2" for="_lc_no">{{__('label.lc_ip_no')}}:</label>
                              <select class="form-control _lc_no select2" name="_lc_no" >
                                <option value=""><---Select {{__('label.lc_ip_no')}} --></option>
                               @forelse($lc_masters as $lc)
                               <option value="{{$lc->lc_ip_no}}">{!! $lc->lc_ip_no ?? '' !!}</option>
                               @empty
                               @endforelse
                              </select>
