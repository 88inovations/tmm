                 ...
                 <form action="{{ url('voucher/update') }}" method="POST" class="voucher-form">
                    ...
                    <div class="row">
                       ...
                       <div class="col-xs-12 col-sm-12 col-md-2">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 ">
                            <div class="form-group">
                              <label class="mr-2" for="_code">Voucher No:</label>
                              <input readonly type="text" id="_code" name="_code" class="form-control _code" value="{{old('_code',$data->_code ?? '')}}" placeholder="Voucher No" >
...
@include('backend.voucher.voucher_check_info')
                                  ...
                                  @endphp
                                            ...
                                            <tr class="_voucher_row">
                                              ...
                                              <td class="@if(sizeof($permited_organizations)==1) display_none @endif">
                                                 ...
                                                 <option value="{{$val->id}}" @if(isset($details->organization_id)) @if($details->organization_id == $val->id) selected @endif   @endif>{{ $val->id ?? '' }} - {{ $val->_name ?? '' }}</option>
                                                 @empty
                                                 @endforelse
                                                </select>
                                              </td>
                                              ...
                                              <td class="@if(sizeof($permited_budgets)==1) display_none @endif">
                                                <select class="form-control _budget_details_id" name="_budget_details_id[]"  >
                                                    ...
                                                    @forelse($permited_budgets as $b_val )
                                                                   <option value="{{$b_val->id}}" @if(isset($details->_budget_id)) @if($details->_budget_id == $b_val->id) selected @endif   @endif> {{ $b_val->_name ?? '' }}</option>
                                                     @empty
                                                     @endforelse
                                                 </select>
                                              </td>
                                              ...
                                              @can('ledger_report_foreign')
                                              <td>
                                                <input type="number" name="_foreign_amount[]" class="form-control  _foreign_amount" placeholder="{{__('label._foreign_amount')}}" value="{{old('_foreign_amount',$details->_foreign_amount)}}">
                                              </td>
                                              @endcan
                                              <td>
                                    ...
                                    @endphp
                                          ...
                                          <tfoot>
                                            <tr>
                                              ...
                                              @endcan
                                              <td>
                                                <input type="number" step="any" min="0" name="_total_dr_amount" class="form-control _total_dr_amount" value="{{ $data->_amount ?? 0  }}" readonly required>
                                              </td>
                                              <td>
                                                <input type="number" step="any" min="0" name="_total_cr_amount" class="form-control _total_cr_amount" value="{{ $data->_amount ?? 0  }}" readonly required>
                                              </td>
                                            </tr>
                                          </tfoot>
                                      </table>
...
@can('import_module')
                          <div class="import_item_display">
                            @include('lc.lc_open.item_details_edit')
                          </div>

                          <div class="import_item_displayMultiple">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-11">
                                    ...
                                    @endif
                                       ...
                                       <input type="hidden" class="number_of_row" name="number_of_row" value="{{sizeof($_master_details)}}">

                                    <input type="text" id="_note"  name="_note" class="form-control _note" value="{!! $data->_note ?? '' !!}" placeholder="Note" required >
                                  </div>
                                </div>
                            </div>
      ...
      $("#area__voucher_details").append(`<tr class="_voucher_row">
                      ...
                      <select class="form-control width_150_px _branch_id_detail _branch_id_detail__${new_row_number}" name="_branch_id_detail[]"  required >
                        ...
                        <td class="@if(sizeof($permited_budgets)==1) display_none @endif">
                         ...
                         <td>
                                                <input type="number" name="_foreign_amount[]" class="form-control  _foreign_amount" placeholder="{{__('label._foreign_amount')}}" value="{{old('_foreign_amount')}}">
                                              </td>
                            <td>
