                            ...
                            <div class="form-group">
                               ...
                               <select class="form-control" name="_account_head_id">
                                 ...
                                 @forelse($account_types as $account_type )
                                  <option value="{{$account_type->id}}" @if(isset($data->_account_head_id)) @if($data->_account_head_id == $account_type->id) selected @endif   @endif @if($account_type->_has_child==1) disabled @endif >{{ $account_type->id ?? '' }}-{{ $account_type->_name ?? '' }}</option>
