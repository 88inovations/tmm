...
<div class="_report_button_header">
 <a class="nav-link"  href="{{url('previous_sales_return')}}" role="button"><i class="fa fa-arrow-left"></i></a>
     ...
     <div class="row">
      ...
      <div class="col-6 text-center">
       ...
       <div style="text-align: center;">
         <h3><img src="{{asset($settings->logo)}}" alt="{{$settings->name ?? '' }}" style="height: 50px;width: 50px"  > {{$settings->name ?? '' }}
