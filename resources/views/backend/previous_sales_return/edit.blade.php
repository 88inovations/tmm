          ...
          <div class=" col-sm-6 ">
            <ol class="breadcrumb float-sm-right">
             ...
             <li class="breadcrumb-item ">
                 <a target="__blank" href="{{url('previous_sales_return/print')}}/{{$data->id}}" class="btn btn-sm btn-warning"> <i class="nav-icon fas fa-print"></i> </a>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
               <form action="{{url('previous_sales_return/update')}}" method="POST" class="purchase_form" >
                @csrf
                      <div class="row">
                                          ...
                                          <tbody class="area__purchase_details" id="area__purchase_details">
                                            ...
                                            <tr class="_purchase_row">
                                              ...
                                              <td>
                                               ...
                                               <td>
                                                <input type="text" name="_search_item_code[]" class="form-control _search_item_code width_150_px" placeholder="Code" value="{{ id_to_cloumn($detail->_item_id ,'_code','inventories')}}">
