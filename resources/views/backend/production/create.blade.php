          ...
          <div class=" col-sm-6 ">
            <ol class="breadcrumb float-sm-right">
             ...
             <li class="breadcrumb-item ">
              ...
              @endcan
              <li class="breadcrumb-item ">
                 <a class="btn btn-sm btn-success" title="List" href="{{ route('production.index') }}"> <i class="nav-icon fas fa-list"></i> </a>
               </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
               ...
               @endif
               <form action="{{route('production.store')}}" method="POST" class="purchase_form" >
                @csrf
                    <div class="row">
                            ...
                            <div class="form-group ">
                               ...
                               <select class="form-control" name="_type" required >
                                  @foreach($types as $type)
                                    <option value="{{$type}}" @if(isset($request->_type)) @if($request->_type == $type ) selected @endif   @endif>{{$type}}</option>
                                  @endforeach
                         ...
                         <div class="col-xs-12 col-sm-12 col-md-2 " >
                            ...
                            <div class="form-group ">
                               ...
                               <select class="form-control" name="_to_organization_id" required >
                                  ...
                                  <option value="{{$organization->id}}" @if(isset($request->_to_organization_id)) @if($request->_to_organization_id == $organization->id) selected @endif   @endif>{{ $organization->id ?? '' }} - {{ $organization->_name ?? '' }}</option>
                                  @empty
                                  @endforelse
                                </select>
                            </div>
                                ...
                                <div class="table-responsive">
                                      <table class="table table-bordered" >
                                            ...
                                            <tr class="_purchase_row _purchase_row__">
                                              ...
                                              <td class="">
                                                ...
                                                <input type="text" class="form-control _main_unit_val width_100_px" readonly name="_main_unit_val[]" />
                                                 <input type="number" name="_base_rate[]" min="0" step="any" class="form-control _base_rate display_none"  readonly>
                                              </td>
                                              <td class="">
                                          ...
                                          <tfoot>
                                            <tr>
                                              <td>
                                                <a href="#none"  class="btn btn-default btn-sm" onclick="purchase_row_add_stock_out(event)"><i class="fa fa-plus"></i></a>
                                              </td>
                                              <td colspan="2"  class="text-right"><b>Total</b></td>
                                                <td class="text-left " ></td>
                                            <td class="text-left " ></td>
                                            <td class="text-left @if(isset($form_settings->_show_unit)) @if($form_settings->_show_unit==0) display_none    @endif @endif" ></td>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 mb-10">
                          <table class="table" style="border-collapse: collapse;margin: 0px auto;">
                            ...
                            <tr>
                              ...
                              <td style="border:0px;width: 80%;">
                                @php
                                $_p_statues = \DB::table("production_status")->whereIn('id',[1,2])->get();
                                @endphp
...
@section('script')
@include('backend.production.stock_out_script')
@include('backend.production.stock_in_script')
@endsection
