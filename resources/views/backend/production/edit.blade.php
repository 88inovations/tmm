          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
               ...
               @endif
               <form action="{{url('production/update')}}" method="POST" class="purchase_form" >
                @csrf
                    <div class="row">
                                            ...
                                            @if(sizeof($permited_branch) > 1)  
                                             ...
                                             @if(sizeof($permited_costcenters) > 1)
                                              ...
                                              <td class="@if(isset($form_settings->_show_manufacture_date)) @if($form_settings->_show_manufacture_date==0) display_none  @endif @endif">
                                                <input type="date" name="_stock_in__manufacture_date[]" class="form-control _stock_in__manufacture_date "  value="{{ ( $detail->_manufacture_date ?? '') }}" >
                                              </td>
                                              <td class="@if(isset($form_settings->_show_expire_date)) @if($form_settings->_show_expire_date==0) display_none  @endif @endif">
                                                <input type="date" name="_stock_in__expire_date[]" class="form-control _stock_in__expire_date " value="{{ ($detail->_expire_date ?? '') }}"  >
                                              </td>
