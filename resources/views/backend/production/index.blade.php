          ...
          <div class="col-sm-12" style="display: flex;">
            ...
            <ol class="breadcrumb float-sm-right ml-2">
              ...
              <li class="breadcrumb-item active">
                  <a title="Add New" class="btn btn-info btn-sm" href="{{ route('production.create') }}"> Manual Production </a>
               </li>
              <li class="breadcrumb-item active">
                  <a title="Add New" class="btn btn-info btn-sm" href="{{ route('direct_productions.create') }}"> {{__('label.direct_productions')}} </a>
               </li>
              @endcan
            </ol>
          </div>
                      ...
                      @endphp
                        ...
                        <tr>
                             ...
                             <td style="display: flex;">
                              <div class="dropdown mr-1">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                     ...
                                     <a class="dropdown-item " href="{{url('transfer-production/stock-out')}}/{{$data->id}}" >
                                         Stock Out Print
                                      </a>
                                     @can('production-edit')
                            ...
                            <td>
                              ...
                              @else
                              @can('finished_goods_receive_to_stock')
                               <a href="{{url('finished_goods_receive_to_stock')}}?production_id={{$data->id}}" class="btn btn-info">{{__('label.finished_goods_receive_to_stock')}}</a>
                               @endcan
                              @endif
                        ...
                        <tr>
                          <td colspan="15" >
                           ...
                           <div class="card-header">
                                <b>Estimated Production Items</b>
                              </div>
                              <table class="table">
                                <thead>
                                  <th>ID</th>
