                       ...
                       <div class="row">
                         <div class="col-md-6">
                            <form action="" method="GET">
                                @csrf
                                <div >
                                            <select name="limit" class="form-control" style="" onchange="this.form.submit()">
                  ...
                  <table class="table table-bordered table-striped table-hover _list_table">
                    <thead>
                      <tr>
                         ...
                         @endif
                         <th class=""><b>{{__('label._purchase_type')}}</b></th>
...
<td style="display: flex;">
                        ...
                        <td>{{ $data->_master_branch->_name ?? '' }}</td>
                         ...
                         @endif
 <td>
@if($data->_purchase_type==2)
<span class="btn btn-sm btn-warning">Import</span>
@else
<span class="btn btn-sm btn-info">Local</span>
@endif
                            </td>
