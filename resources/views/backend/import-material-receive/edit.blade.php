                              ...
                              <table class="table" >
                                ...
                                <tr>
                                  ...
                                  <td>
                                      ...
                                      <input type="text" name="_loading_point[]" class="form-control _loading_point" value="{{$r_val->_loading_point ?? '' }}">
                                      
                                  </td>
                                  <td>
                                    <input type="text" name="_unloading_point[]" class="form-control _unloading_point" value="{{$r_val->_unloading_point ?? ''}}">
