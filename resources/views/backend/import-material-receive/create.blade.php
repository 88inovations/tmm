                ...
                <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2  ">
                            <div class="form-group">
                              ...
                              <select class="form-control import_invoice_no " name="import_invoice_no">
                                ...
                                <option value="{{$val->id}}">{{ $val->_order_number ?? '' }} | {{ $val->_lc_no ?? '' }}</option>
                                @empty
                                @endforelse
                              </select>
                            </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2  ">
                            <div class="form-group">
                              ...
                              <input type="text" name="_mother_vessel_no_text" class="form-control _mother_vessel_no_text" readonly>
                              <input type="hidden" name="_mother_vessel_no" class="form-control _mother_vessel_no" readonly>
                            </div>
                        </div>
                   ...
                   <div class="row">
                       ...
                       <div class="col-xs-12 col-sm-12 col-md-2">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 ">
                            <div class="form-group">
                              <label class="mr-2 _required" for="_store_id">{{__('label._store_id')}}:</label>
                              ...
                              <table class="table" >
                                ...
                                <tr>
                                  ...
                                  <td>
                                      ...
                                      <input type="text" name="_loading_point[]" class="form-control _loading_point">
                                      
                                  </td>
                                  <td>
                                    <input type="text" name="_unloading_point[]" class="form-control _unloading_point">
...
$(document).on('change','.import_invoice_no',function(){
  var import_invoice_id = $(this).val();
  var request = $.ajax({
      url: "{{url('import-invoice-wise-detail')}}",
      method: "GET",
      data: { import_invoice_id },
      dataType: "JSON"
    });

  request.done(function( result ) {
console.log(result)
    $(document).find("._mother_vessel_no_text").val(result?._mother_vessel?._name);
    $(document).find("._mother_vessel_no").val(result?._vessel_no);
    $(document).find("._search_main_ledger_id").val(result?._ledger?._name);
    $(document).find("._main_ledger_id").val(result?._ledger_id);



     var data = result?._master_details;
      console.log(data)
  ...
  $(document).on('click','.submit-button',function(event){
    ...
    if(_store_id  ==""){
       alert(" Please Select Warehouse  ");
        $(document).find('._store_id').addClass('required_border').focus();
        return false;
    }
