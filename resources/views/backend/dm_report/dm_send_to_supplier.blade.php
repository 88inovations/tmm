        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body filter_body" >
               <form  action="{{url('dm_send_to_supplier')}}" method="GET">
                @csrf
                    <div class="row">
                      <div class="col-md-6">
                    ...
                    <div class="row">
                     ...
                     <div class="row mt-3">
                         ...
                         <div class="col-xs-6 col-sm-6 col-md-6 ">
                                     <a href="{{url('dm_send_to_supplier')}}" class="btn btn-danger mt-2 form-control" title="Search Reset"><i class="fa fa-retweet mr-2"></i> Reset</a>
                        </div>
                        <br><br>
                     </div>
                    {!! Form::close() !!}
  ...
  @endforeach  </b></td> </tr>
   ...
   <table class="cewReportTable">
          ...
          <tr>
            ...
            <th style="width: 10%;" colspan="2">{{__('label._customer_id')}}</th>
          ...
          <tbody>
            ...
            <td style="width: 10%;white-space: nowrap;">{{ $g_value->_code ?? '' }}  </td>
            <td style="width: 10%;white-space: nowrap;">{{ $g_value->_ledger_name ?? '' }} </td>
            <td style="width: 10%;">{!! _view_date_formate($g_value->_date ?? '') !!}</td>
            <td style="width: 10%;white-space: nowrap;">{{ $g_value->_item_id ?? '' }} {{ $g_value->_item_name ?? '' }} </td>
