        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body filter_body" >
               <form  action="{{url('report-damage-stock-balance')}}" method="POST">
                @csrf
                    <div class="row">
                   ...
                   @endif 
                    ...
                    <div class="row">
                      <label>Manufacture Company:</label><br>
                        <select class="form-control  _manufacture_company select2" multiple  name="_manufacture_company[]"   >
                     ...
                     <div class="row mt-3">
                         ...
                         <div class="col-xs-6 col-sm-6 col-md-6 ">
                                     <a href="{{url('reset-stock-possition')}}" class="btn btn-danger mt-2 form-control" title="Search Reset"><i class="fa fa-retweet mr-2"></i>Reset </a>
                        </div>
                        <br><br>
                     </div>
                    {!! Form::close() !!}
