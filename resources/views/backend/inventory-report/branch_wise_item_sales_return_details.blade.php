...
$_ledger_id = $request->_ledger_id ?? '';
          ...
          @endphp
            ...
            <div class="card-body filter_body" >
               <form  action="{{url('branch_wise_item_sales_return_details_report')}}" method="POST">
                @csrf
                ...
                $report_type = $previous_filter['report_type'] ?? 1;
                    ...
                    <div class="row">
                      <label>Report Type:</label>
                        <select class="form-control report_type" name="report_type">
                          <option value="1" @if($report_type==1) selected  @endif>Product Wise Customer Sales & Return Details</option>
                          <option value="3" @if($report_type==3) selected  @endif>Product,Territory,Customer,Invoice Wise Product Sales & Return Details</option>
                        </select>
                    </div>
                    <div class="row">
                     <div class="col-xs-12 col-sm-12 col-md-12 ">
                            <label class="mr-2" for="_main_item__search_item_id">Item: <span class="_required">*</span></label>
                            <input type="text" id="_main_item__search_item_id" name="_main_item__search_item_id" class="form-control _main_item__search_item_id width_280_px" placeholder="Item" value="{{$_main_item__search_item_id}}" required>
                    ...
                    <div class="row">
                     ...
                     <div class="row mt-3">
                         ...
                         <div class="col-xs-6 col-sm-6 col-md-6 ">
                                     <a href="{{url('branch_wise_item_sales_return_details')}}" class="btn btn-danger mt-2 form-control" title="Search Reset"><i class="fa fa-retweet mr-2"></i> Reset</a>
                        </div>
                        <br><br>
                     </div>
                    {!! Form::close() !!}
 ...
 @if($report_type==1)
  @include("backend.inventory-report.p_t_c_i_wise_sales_statement_2")
  @endif


 @if($report_type==3)
  @include("backend.inventory-report.p_t_c_i_wise_sales_statement")
  @endif
