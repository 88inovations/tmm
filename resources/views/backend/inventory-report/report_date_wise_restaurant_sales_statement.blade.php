...
<div class="wrapper print_content">
  ...
  <div class="_report_button_header">
    <a class="nav-link"  href="{{url('date-wise-restaurant-sales')}}" role="button">
            ...
            @forelse($master_val as $d_key=> $del_val)
              <tr>
                <th colspan="9" class="text-left">
                  <a style="text-decoration: none;" target="__blank" href="{{ url('restaurant-sales/print',$del_val->id) }}">
