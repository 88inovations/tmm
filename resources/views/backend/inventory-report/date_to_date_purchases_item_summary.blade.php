        ...
        <div class="row">
          ...
          <div class="card">
            <div class="card-body filter_body" >
               <form  action="{{url('date_to_date_purchases_item_summary')}}" method="GET">
                @csrf
                    <div class="row">
                     ...
                     <div class="row mt-3">
                         ...
                         <div class="col-xs-6 col-sm-6 col-md-6 ">
                                     <a href="{{url('date_to_date_purchases_item_summary')}}" class="btn btn-danger mt-2 form-control" title="Search Reset"><i class="fa fa-retweet mr-2"></i> Reset</a>
                        </div>
                        <br><br>
                     </div>
                    {!! Form::close() !!}
...
?>
        ...
        <table class="table" style="border:1px solid silver;width: 100%;margin-bottom: 0px !important;">
         <thead>
           <tr>
             ...
             <th class="border_silver text-right">{{__('label._rate')}}</th>
             <th class="border_silver text-right">{{__('label._value')}}</th>
         ...
         <tbody>
          ...
          @forelse($datas as $key=>$data)
           <tr>
             <td colspan="7" class="text-bold border_silver">{{$key ?? '' }}</td>
           </tr>
     ...
     <tr>
             ...
             <td class="border_silver"  style="white-space:nowrap;">{{$val->item_code ?? '' }}</td>
           ...
           @endforelse
          <tr>
             <th class="border_silver" colspan="3">Total {{$key ?? '' }}</th>
