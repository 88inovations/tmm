        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body filter_body" >
               <form  action="{{url('date_to_date_sales_item_summary')}}" method="GET">
                @csrf
                    <div class="row">
                     ...
                     <div class="row mt-3">
                         ...
                         <div class="col-xs-6 col-sm-6 col-md-6 ">
                                     <a href="{{url('date_to_date_sales_item_summary')}}" class="btn btn-danger mt-2 form-control" title="Search Reset"><i class="fa fa-retweet mr-2"></i> Reset</a>
                        </div>
                        <br><br>
                     </div>
                    {!! Form::close() !!}
     ...
     <tr>
          ...
          <tr>
           ...
           @endforelse
            ...
            <tr>
             <th class="border_silver " colspan="3">Net Total [Sales - Sales Return]</th>
