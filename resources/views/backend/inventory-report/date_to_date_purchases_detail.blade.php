        ...
        <div class="row">
          ...
          <div class="card">
            <div class="card-body filter_body" >
               <form  action="{{url('date_to_date_purchases_detail')}}" method="GET">
                @csrf
                    <div class="row">
                     ...
                     <div class="row mt-3">
                         ...
                         <div class="col-xs-6 col-sm-6 col-md-6 ">
                                     <a href="{{url('date_to_date_purchases_detail')}}" class="btn btn-danger mt-2 form-control" title="Search Reset"><i class="fa fa-retweet mr-2"></i> </a>
                        </div>
                        <br><br>
                     </div>
                    {!! Form::close() !!}
        ...
        <table class="table" style="width: 100%;margin-bottom: 0px !important;">
         <thead>
           <tr>
             ...
             <th class="border_silver text-right">{{__('label._sub_total')}}</th>
             <th class="border_silver text-right">{{__('label._total_discount')}}</th>
             <th class="border_silver text-right">{{__('label._total_vat')}}</th>
             <th class="border_silver text-right">{{__('label._total')}}</th>
           </tr>
         </thead>
         <tbody>
          @php
          ...
          @forelse($datas as $key=>$data)
           <tr>
             <td class="border_silver" colspan="9" class="text-bold">{{$key ?? '' }}</td>
           </tr>
      ...
      <tr>
          ...
          <tr>
           ...
           @endforelse
            ...
            <tr>
             <th class="border_silver" colspan="6">Net Total [Purchase - Purchase Return]</th>
