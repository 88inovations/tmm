        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body filter_body" >
               <form  action="{{url('report-date-wise-purchase-return')}}" method="POST">
                @csrf
                    <div class="row">
...
@include('basic.org_report')
            ...
            @endif >{{$group->_name}}</option>
                     ...
                     <div class="row mt-3">
                         ...
                         <div class="col-xs-6 col-sm-6 col-md-6 ">
                                     <a href="{{url('reset-date-wise-purchase-return')}}" class="btn btn-danger mt-2 form-control" title="Search Reset"><i class="fa fa-retweet mr-2"></i> </a>
                        </div>
                        <br><br>
                     </div>
                    {!! Form::close() !!}
...
<script type="text/javascript">
  ...
  function _nv_group_base_ledger(_account_group_id){
    var request = $.ajax({
        url: "{{url('group-base-ledger-purchase-return')}}",
        method: "GET",
