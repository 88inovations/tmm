@if($request->has('_datex') && $request->has('_datey') && $report_type==1)
...
$item_info = \App\Models\Inventory::with(['_pack_size'])->find($request->_main_item_id);
          ...
          <tr>
            ...
            <td style="border:1px solid silver;white-space: nowrap;"> Name of Customer </td>
            <td style="border:1px solid silver;white-space: nowrap;">  Customer ID</td>
            <td style="width: 10%;border:1px solid silver;white-space: nowrap;"> Name of Proprietor</td>
  ...
  @forelse($datas as $key=>$data)
    ...
    @php
        ...
        <tr>
            ...
            <td style="width: 10%;border:1px solid silver;white-space: nowrap;">{!! $data->_alious ?? '' !!}</td>
