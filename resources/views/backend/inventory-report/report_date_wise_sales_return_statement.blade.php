...
<div class="wrapper print_content">
  ...
  <div class="_report_button_header">
    <a class="nav-link"  href="{{url('sales-return-detail')}}" role="button">
            ...
            @forelse($master_val as $d_key=> $del_val)
              <tr>
                <th colspan="9" class="text-left">
                  <a style="text-decoration: none;" target="__blank" href="{{ url('sales-return/print',$del_val->id) }}">
              ...
              <tr>
                ...
                <td class="text-left">{!! $_master_details->_trans_unit->_name ?? '' !!}</td>
                <td class="text-right">{!! _report_amount($_master_details->_qty ?? 0) !!}</td>
                <td class="text-right">{!! _report_amount($_master_details->_rate ?? 0 * $_master_details->_unit_conversion ?? 0) !!}</td>
