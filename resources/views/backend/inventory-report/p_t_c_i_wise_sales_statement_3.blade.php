@if($request->has('_datex') && $request->has('_datey') && $report_type==2)
    ...
    <div class="container-fluid">
      <table class="table table-borderd" >
         <thead style="border:0px !important">
          <tr>
            <td colspan="11" style="border:0px !important">
...
@endif
  ...
  @php
$ledger = \App\Models\AccountLeadger::with(['_entry_branch'])->find($request->_ledger_id);
  @endphp
              <div style="width:100%;overflow: hidden;">
                <div style="width:130px;float: left;"><b>Name of Customer  </b> </div>
                <div style="float: left;">: {!! $ledger->_name ?? 'All Customer' !!}</div>
              </div>
              <div style="width:100%;overflow: hidden;">
                <div style="width:130px;float: left;"><b>Customer ID  </b> </div>
                <div style="float: left;">: {!! $ledger->_code ?? '' !!}</div>
              </div>
              <div style="width:100%;overflow: hidden;">
                <div style="width:130px;float: left;"><b>{{__('label._branch_id')}}  </b> </div>
                <div style="float: left;">: {!! $ledger->_entry_branch->_name ?? '' !!}</div>
              </div>
@endif
              <div style="width:100%;overflow: hidden;">
          ...
          <tr>
            ...
            <td style="border:1px solid silver;white-space: nowrap;">Product Code </td>
            <td style="border:1px solid silver;white-space: nowrap;">  Product Name</td>
            <td style="width: 10%;border:1px solid silver;white-space: nowrap;"> Pack Size</td>
            <td style="border:1px solid silver;white-space: nowrap;"> Invoice Date</td>
  ...
  @forelse($datas as $key=>$data)
    ...
    @php
        ...
        <tr>
            ...
            <td style="width: 10%;border:1px solid silver;white-space: nowrap;">{!! $data->_code ?? '' !!}</td>
            <td style="border:1px solid silver;white-space: nowrap;">{!! $data->_name ?? '' !!} </td>
            <td style="width: 10%;border:1px solid silver;white-space: nowrap;">{!! $data->_pack_name ?? '' !!}</td>
...
@endforelse
          <tr>
            <th colspan="6" class="text-left"  style="border:1px solid silver;">Grand Total </th>
