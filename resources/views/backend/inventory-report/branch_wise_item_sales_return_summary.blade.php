...
$_ledger_id = $request->_ledger_id ?? '';
          ...
          @endphp
            ...
            <div class="card-body filter_body" >
               <form  action="{{url('branch_wise_item_sales_return_summary')}}" method="GET">
                @csrf
                ...
                $report_type = $previous_filter['report_type'] ?? 1;
                    ...
                    <div class="row">
                     ...
                     <div class="row mt-3">
                         ...
                         <div class="col-xs-6 col-sm-6 col-md-6 ">
                                     <a href="{{url('branch_wise_item_sales_return_summary')}}" class="btn btn-danger mt-2 form-control" title="Search Reset"><i class="fa fa-retweet mr-2"></i> Reset</a>
                        </div>
                        <br><br>
                     </div>
                    {!! Form::close() !!}
