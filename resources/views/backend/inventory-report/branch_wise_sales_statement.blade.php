...
$_ledger_id = $request->_ledger_id ?? '';
          ...
          @endphp
            ...
            <div class="card-body filter_body" >
               <form  action="{{url('branch_wise_sales_statement')}}" method="GET">
                @csrf
                ...
                $report_type = $previous_filter['report_type'] ?? 1;
                    ...
                    <div class="row">
                      <label>Report Type:</label>
                        <select class="form-control report_type" name="report_type">
                          ...
                          <option value="4" @if($report_type==4) selected  @endif>Territory Wise Product Sales & Return Summary</option>
                        </select>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                     ...
                     <div class="row mt-3">
                         ...
                         <div class="col-xs-6 col-sm-6 col-md-6 ">
                                     <a href="{{url('branch_wise_sales_statement')}}" class="btn btn-danger mt-2 form-control" title="Search Reset"><i class="fa fa-retweet mr-2"></i> Reset</a>
                        </div>
                        <br><br>
                     </div>
                    {!! Form::close() !!}
 ...
 @if($report_type==3)
  ...
  @endif
 @if($report_type==4)
              @include("backend.inventory-report.branch_wise_sales_return_summary")
@endif
