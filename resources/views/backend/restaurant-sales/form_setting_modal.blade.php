...
<div class="form-group row">
      ...
      <div class="form-group row">
        <label for="_default_service_charge" class="col-sm-5 col-form-label">Default Service Charge Account</label>
        <select class="form-control col-md-7" name="_default_service_charge">
           <option value="0">---Select---</option>
          @foreach($_income_accounts as $account)
          <option value="{{$account->id}}" @if(isset($form_settings->_default_service_charge))@if($form_settings->_default_service_charge==$account->id) selected @endif @endif>{{ $account->_name ?? '' }}</option>
          @endforeach
        </select>
      </div>
      <div class="form-group row">
        <label for="_default_other_charge" class="col-sm-5 col-form-label">Default Other Charge Account</label>
        <select class="form-control col-md-7" name="_default_other_charge">
          @foreach($_income_accounts as $account)
          <option value="{{$account->id}}" @if(isset($form_settings->_default_other_charge))@if($form_settings->_default_other_charge==$account->id) selected @endif @endif>{{ $account->_name ?? '' }}</option>
          @endforeach
        </select>
      </div>
      <div class="form-group row">
        <label for="_default_delivery_charge" class="col-sm-5 col-form-label">Default Delivery Charge Account</label>
        <select class="form-control col-md-7" name="_default_delivery_charge">
          @foreach($_income_accounts as $account)
          <option value="{{$account->id}}" @if(isset($form_settings->_default_delivery_charge))@if($form_settings->_default_delivery_charge==$account->id) selected @endif @endif>{{ $account->_name ?? '' }}</option>
          @endforeach
        </select>
      </div>
      <div class="form-group row">
