...
<div class="_report_button_header">
 ...
 @can('purchase-return-edit')
    ...
    <a class="nav-link"  title="Edit"
    href="{{ route('purchase-return.edit',$data->id) }}"><i class="nav-icon fas fa-edit"></i></a>
  @endcan
     ...
     <div class="row invoice-info">
      <div class="col-sm-4 invoice-col">
       ...
       <address>
        ...
        Address: {{$data->_ledger->_address ?? '' }}<br>
                                        ...
                                        <span>{{$barcode}}</span><br>
                                          ...
                                          <td class="text-left" >{!! $_item->_trans_unit->_name ?? '' !!}</td>
                                           ...
                                           <td class="text-right  " style="vertical-align: top;">{!! _report_amount($_item->_qty ?? 0) !!}</td>
                                            <td class="text-right  " style="vertical-align: top;">{!! _report_amount($_item->_rate ?? 0) !!}</td>
