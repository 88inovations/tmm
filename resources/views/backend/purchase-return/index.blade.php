                  ...
                  <table class="table table-bordered _list_table">
                      <thead>
                        <tr>
                         ...
                         <th class=""><b>Purchase Ref</b></th>
                         <th class=""><b>Referance</b></th>
                         <th class=""><b>Supplier</b></th>
                      ...
                      @endphp
                        ...
                        <tr>
                          ...
                          <td style="display: flex;">
                                ...
                                <a  type="button" 
                                  href="{{url('purchase-return/print')}}/{{$data->id}}"
                                   
                                  class="btn btn-sm btn-default  mr-1"><i class="fa fa-eye"></i></a>


                                  @can('purchase-return-edit')
                                  <a  href="{{ route('purchase-return.edit',$data->id) }}" 
                          ...
                          @can('money-receipt-print')
                              ...
                              <div class="dropdown mr-1">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <a class="dropdown-item " href="{{ url('purchase-return-money-receipt') }}/{{$data->id}}">
                                         Money Receipt
                                        </a>
                            ...
                            <td>
                              <a target="__blank" href="{{url('purchase/print')}}/{{$data->_order_ref_id}}">{{ $data->_order_ref_id ?? '' }}</a>
...
function after_request_date__today(_date){
 ...
 $(document).on('keyup','._search_main_ledger_id',delay(function(e){
  ...
  $(document).on("click","._invoice_lock",function(){
    ...
    var _table_name ="purchase_returns";
   if($(this).is(':checked')){
