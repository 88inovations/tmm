          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
               ...
               @endif
               <form action="{{route('damage_from_stocks.store')}}" method="POST" class="purchase_form" >
                @csrf
                    <div class="row">
                ...
                <input type="hidden" id="_search_form_value" name="_search_form_value" class="_search_form_value" value="2" >
                      ...
                      <div class="row" >
                       ...
                       <div class="col-xs-12 col-sm-12 col-md-3 ">
                            <div class="form-group">
                              <label class="mr-2" for="_main_ledger_id">Damage Ledger:<span class="_required">*</span></label>
                            <input type="text" id="_search_main_ledger_id" name="_search_main_ledger_id" class="form-control _search_main_ledger_id" value="{{old('_search_main_ledger_id',_ledger_name($_defaut_customer))}}" placeholder="Damage Ledger" required>

                            <input type="hidden" id="_main_ledger_id" name="_main_ledger_id" class="form-control _main_ledger_id" value="{{old('_main_ledger_id',$_defaut_customer)}}" placeholder="Damage Ledger" required>
                              ...
                              <td style="border:0px;width: 80%;">
                                @if ($_print = Session::get('_print_value'))
                                    ...
                                    @if ($_master_id = Session::get('_master_id'))
                                     <input type="hidden" name="_master_id" value="{{url('damage_from_stocks/print')}}/{{$_master_id}}" class="_master_id">
