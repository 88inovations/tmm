...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class=" col-sm-6 ">
            <a class="m-0 _page_name" href="{{ route('damage_from_stocks.index') }}">{!! $page_name ?? '' !!} </a>
          </div><!-- /.col -->
          <div class=" col-sm-6 ">
            <ol class="breadcrumb float-sm-right">
             ...
             <li class="breadcrumb-item ">
                 <a target="__blank" href="{{url('damage_from_stocks/print')}}/{{$data->id}}" class="btn btn-sm btn-warning"> <i class="nav-icon fas fa-print"></i> </a>
             ...
             <li class="breadcrumb-item ">
              ...
              @endcan
               @can('sales-create')
              <li class="breadcrumb-item ">
                        <a title="Add New" class="btn btn-success btn-sm" href="{{ route('damage_from_stocks.create') }}"> <i class="nav-icon fas fa-plus"></i> </a>
               </li>
              @endcan
              <li class="breadcrumb-item ">
                 <a class="btn btn-sm btn-success" title="List" href="{{ route('damage_from_stocks.index') }}"> <i class="nav-icon fas fa-list"></i> </a>
               </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
               <form action="{{url('damage_from_stocks/update')}}" method="POST" class="purchase_form" >
                @csrf
                      <div class="row">

                       <div class="col-xs-12 col-sm-12 col-md-2">
                        <input type="hidden" name="_form_name" class="_form_name"  value="damage_from_stocks">
                            <div class="form-group">
                                <label>Date:</label>
 ...
 $(document).on('click','._purchase_row_remove',function(event){
  ...
  $(document).on('click','.submit-button',function(event){
    ...
    $(document).find('._p_p_l_id').each(function(index){
     ...
     var table_name="damage_from_stock_details";
    ...
    if(_p_p_l_ids_qtys.length > 0){
        var request = $.ajax({
                ...
                method: "GET",
                async:false,
                data: { _p_p_l_ids_qtys,unique_p_ids,_sales_id,table_name },
                dataType: "JSON"
              });
