          ...
          <div class="col-sm-12" style="display: flex;">
            ...
            <ol class="breadcrumb float-sm-right ml-2">
              ...
              <li class="breadcrumb-item active">
                  <a title="Add New" class="btn btn-info btn-sm" href="{{ route('damage_from_stocks.create') }}"> Add New </a>
               </li>
              @endcan
            </ol>
          </div>
            ...
            <div class="card">
              <div class="card-header border-0 mt-1">
                <div class="row">
                   ...
                   @endphp
                    <div class="col-md-4">
                       @include('backend.damage_from_stocks.search')
                    </div>
                    <div class="col-md-8">
                      ...
                      @endphp
                          ...
                          <td style="display: flex;">
                              <div class="dropdown mr-1">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                     <a target="__blank" class="dropdown-item " href="{{url('damage_from_stocks/print')}}/{{$data->id}}" >
                                        Invoice 
                                      </a>
                                      
                                    
                                     @can('sales-edit')
                                        <a class="dropdown-item " href="{{ route('damage_from_stocks.edit',$data->id) }}" >
                                          Edit
                                        </a>
                                    @endcan
                        ...
                        <tr>
                          ...
                          <!--   <div class="_single_data_display__{{$data->id}}">
                            ...
                            @include('backend.damage_from_stocks.sales_details')
