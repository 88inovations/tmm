...
<div class="_report_button_header">
 <a class="nav-link"  href="{{url('damage_from_stocks')}}" role="button"><i class="fa fa-arrow-left"></i></a>
 @can('sales-edit')
    <a class="nav-link"  title="Edit" href="{{ route('damage_from_stocks.edit',$data->id) }}">
...
@endif
     ...
     <div class="row invoice-info">
      ...
      <div class="col-sm-4 invoice-col">
       Customer:
       <address>
        <strong>@if($form_settings->_defaut_customer ==$data->_ledger_id)
         ...
         @php
                                  ...
                                  <tr>
                                     ...
                                     @endphp
                                            ...
                                            <td class="  " style="word-break: break-all;vertical-align: text-top;">{!! $_item->_trans_unit->_name ?? '' !!}
                                            </td>
                                          
                                            
                                           <td class="text-right  " style="vertical-align: text-top;">{!! _report_amount($_item->_qty ?? 0) !!}</td>
                                            <td class="text-right  " style="vertical-align: text-top;">{!! _report_amount($_item->_sales_rate ?? 0) !!}</td>
