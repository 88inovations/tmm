              ...
              <div class="card-body" style="margin-bottom: 20px;">
               ...
               @csrf
                    <div class="row">
                      ...
                      <div class="col-xs-6 col-sm-6 col-md-4">
                            <div class="form-group">
                               ...
                               <img id="output_2" class="banner_image_create" src="{{asset('/')}}{{$settings->small_logo ?? ''}}"  style="max-height:100px;max-width: 100px; " />
                            </div>
                        </div>
                      <div class="col-xs-6 col-sm-6 col-md-4">
                            <div class="form-group">
                               ...
                               <img id="output_3" class="banner_image_create" src="{{asset($settings->_water_mark_image ?? '')}}"  style="max-height:100px;max-width: 100px; " />
                            </div>
                        </div>
                      <div class="col-xs-6 col-sm-6 col-md-4">
                            <div class="form-group">
                               ...
                               <img id="output_4" class="banner_image_create" src="{{asset($settings->bg_image ?? '')}}"  style="max-height:100px;max-width: 100px; " />
                            </div>
                        </div>
                    ...
                    <div class="row" style="background: #ffeb3b42;padding: 10px;">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-4">
                            <div class="form-group">
                                <label>{{__('label._order_phones')}}:</label>
                                <textarea  name="_order_phones"  class="form-control">{{old('_order_phones',$settings->_order_phones ?? '' )}}</textarea>
                              
                            </div>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-4">
                            <div class="form-group">
                                <label>{{__('label._sales_phones')}}:</label>
                                <textarea  name="_sales_phones"  class="form-control">{{old('_sales_phones',$settings->_sales_phones ?? '' )}}</textarea>
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-3">
                            <div class="form-group">
                                <label>{{__('label.sms_url')}}:</label>
                                <textarea  name="sms_url"  class="form-control">{{old('sms_url',$settings->sms_url ?? '' )}}</textarea>
                              
                            </div>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-3">
                            <div class="form-group">
                                <label>{{__('label.sms_sender')}}:</label>
                               <input type="text" name="sms_sender"  class="form-control" value="{{old('sms_sender',$settings->sms_sender ?? '' )}}">
                            </div>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-3">
                            <div class="form-group">
                                <label>{{__('label.sms_apikey')}}:</label>
                               <input type="text" name="sms_apikey"  class="form-control" value="{{old('sms_apikey',$settings->sms_apikey ?? '' )}}">
                            </div>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-3">
                            <div class="form-group">
                                <label>{{__('label.sms_secretkey')}}:</label>
                               <input type="text" name="sms_secretkey"  class="form-control" value="{{old('sms_secretkey',$settings->sms_secretkey ?? '' )}}">
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                  <label>Bank Group:</label>
                                   <select class="form-control select2" name="_bank_group[]" multiple>
                                      @forelse($all_groups as $_group)
                                      <option value="{{$_group->id}}" @if(in_array($_group->id,$_bank_group_array)) selected @endif >{{$_group->_name ?? ''}}</option>
                                    @empty
                                    @endforelse
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                  <label>Direct Income & Expense Heads:</label>
                                   <select class="form-control select2" name="_direct_inc_exp_heads[]" multiple>
                                      @forelse($income_expenses_heads as $_group)
                                      <option value="{{$_group->id}}" 
                                ...
                                <div class="form-group">
                                  <label>Indirect Income & Expense Heads:</label>
                                   <select class="form-control select2" name="_indirect_inc_exp_heads[]" multiple>
                                      @forelse($income_expenses_heads as $_group)
                                      <option value="{{$_group->id}}" 
                                        @if(in_array($_group->id,$_indirect_inc_exp_heads_array)) selected @endif >{{$_group->_name ?? ''}}</option>
                                    @empty
                                    @endforelse
                                    </select>
                                </div>
...
WHERE t3.id IN(5) ");
                     ...
                     <div class="form-group">
                        <label>Customer Incentive Ledger </label>
                            <input type="text" id="_search_customer_incentive_ledger" name="_search_customer_incentive_ledger" class="form-control _search_customer_incentive_ledger" value="{{old('_search_customer_incentive_ledger',_find_ledger($settings->_customer_incentive_ledger ?? ''))}}" placeholder="Customer Incentive Ledger"   attr_url="{{url('main-ledger-search')}}" >

                            <input type="hidden" id="_customer_incentive_ledger" name="_customer_incentive_ledger" class="form-control _customer_incentive_ledger" value="{{old('_customer_incentive_ledger',$settings->_customer_incentive_ledger ?? '')}}"  >
                     ...
                     <div class="form-group">
                        <label>Bad Debt Expense Ledger </label>
                            <input type="text" id="_search_baddebt_ledgers" name="_search_baddebt_ledgers" class="form-control _search_baddebt_ledgers" value="{{old('_search_baddebt_ledgers',_find_ledger($settings->_baddebt_ledgers ?? ''))}}" placeholder="Bad Debt Expense Ledger"   attr_url="{{url('main-ledger-search')}}" >

                            <input type="hidden" id="_baddebt_ledgers" name="_baddebt_ledgers" class="form-control _baddebt_ledgers" value="{{old('_baddebt_ledgers',$settings->_baddebt_ledgers ?? '')}}"  >
                    ...
                    @can('honorarium_module')
                     ...
                     <div class="form-group">
                        <label>{{__('label._honorarium_ledger')}}</label>
                            <input type="text" id="_search_honorarium_ledger" name="_search_honorarium_ledger" class="form-control _search_honorarium_ledger" value="{{old('_search_honorarium_ledger',_find_ledger($settings->_honorarium_ledger ?? ''))}}" placeholder="{{__('label._honorarium_ledger')}}"   attr_url="{{url('main-ledger-search')}}" >

                            <input type="hidden" id="_honorarium_ledger" name="_honorarium_ledger" class="form-control _honorarium_ledger" value="{{old('_honorarium_ledger',$settings->_honorarium_ledger ?? '')}}"  >
