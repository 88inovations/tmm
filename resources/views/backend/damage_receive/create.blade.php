...
<div class="content-header">
   ...
   $_inline_discount = $form_settings->_inline_discount ?? 0;
    ...
    @endphp
              <div class="card-body">
               <form action="{{route('damage_receive.store')}}" method="POST" class="purchase_form" >
                @csrf
                                   <div class="row">
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-2 ">
                            <div class="form-group">
                              ...
                              <select class="form-control _damage_type" name="_damage_type" required>
                                ...
                                <option value="0">Receive From Customer</option>
                                <option value="1">Damage From Warehouse</option>
                              </select>
                      ...
                      <div class="row">
                         <div class="col-xs-12 col-sm-12 col-md-3 ">
                            ...
                            <input type="text" id="_search_main_ledger_id" name="_search_main_ledger_id" class="form-control _search_main_ledger_id" value="{{old('_search_main_ledger_id')}}" placeholder="{{__('label._ledger_id')}}" required>

                            <input type="hidden" id="_main_ledger_id" name="_main_ledger_id" class="form-control _main_ledger_id" value="{{old('_main_ledger_id')}}" placeholder="{{__('label._ledger_id')}}" required>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="form-group row ">
        <label for="_default_purchase" class="col-sm-5 col-form-label">Default Damage Account</label>
   ...
   var _item_row_count = (parseFloat(i)+1);
    ...
    $(document).find("._item_row_count").val(_item_row_count)
      ...
      $(document).find("#area__purchase_details").append(`<tr class="_purchase_row">
                                              ...
                                              <td class="@if($form_settings->_show_unit==0) display_none @endif">
                                                <select class="form-control ${_item_row_count}_transection_unit _transection_unit" name="_transection_unit[]">
