            ...
            <div class="card">
              <div class="card-header border-0 mt-1">
                <div class="row">
                   ...
                   @endphp
                    <div class="col-md-6">
                       @include('backend.damage_receive.search')
                    </div>
                    <div class="col-md-6">
                      <div class="d-flex flex-row justify-content-end">
                         @can('damage_receive-print')
...
<td style="display: flex;">
                                ...
                                <a  
                                  href="{{url('damage_receive/print')}}/{{$data->id}}"
                                  class="btn btn-sm btn-default  mr-1"><i class="fa fa-eye"></i></a>


                                  @can('damage_receive-edit')
                                  
                                  <a  href="{{ route('damage_receive.edit',$data->id) }}" 
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                     <a class="dropdown-item " href="{{url('damage_receive/print')}}/{{$data->id}}" >
                                         View & Print
                                      </a>
                                ...
                                <a class="btn btn-sm btn-default mr-2 _action_button " attr_invoice_id="{{$data->id}}" _attr_key="{{$key}}" data-toggle="collapse" href="#collapseExample__{{$key}}" role="button" aria-expanded="false" aria-controls="collapseExample">
...
$(document).on("click","._single_data_click",function(){
      ...
      if(has_class){return false; }
        ...
        $.ajax({
           type:'POST',
           url:"{{ url('damage_receive-wise-detail') }}",
...
//   })
  ...
  $(document).on("click","._invoice_lock",function(){
    ...
    var _table_name ="damage_receive_masters";
   if($(this).is(':checked')){
