...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class=" col-sm-6 ">
           <a class="m-0 _page_name" href="{{ route('damage_receive.index') }}">{!! $page_name ?? '' !!} </a>
          ...
          <div class=" col-sm-6 ">
            <ol class="breadcrumb float-sm-right">
             ...
             <li class="breadcrumb-item ">
                 <a target="__blank" href="{{url('damage_receive/print')}}/{{$data->id}}" class="btn btn-sm btn-warning"> <i class="nav-icon fas fa-print"></i> </a>
             ...
             <li class="breadcrumb-item ">
              ...
              <li class="breadcrumb-item ">
                 <a class="btn btn-sm btn-success" title="List" href="{{ route('damage_receive.index') }}"> <i class="nav-icon fas fa-list"></i> </a>
               </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
               <form action="{{url('damage_receive/update')}}" method="POST" class="purchase_form" >
                @csrf
                      <div class="row">

                       <div class="col-xs-12 col-sm-12 col-md-3">
                        <input type="hidden" name="_form_name" class="_form_name"  value="damage_receive_masters">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 ">
                            <div class="form-group">
                              <label class="mr-2" for="_damage_type">Receive From:<span class="_required">*</span></label>
                              <select class="form-control _damage_type" name="_damage_type" required>
                                <option value=""><---Select ---></option>
                                <option value="0" @if($data->_damage_type==0) selected @endif >Receive From Customer</option>
                                <option value="1" @if($data->_damage_type==1) selected @endif >Damage From Warehouse</option>
                              </select>
                      ...
                      <div class="row">
                         <div class="col-xs-12 col-sm-12 col-md-3 ">
                            ...
                            <input type="text" id="_search_main_ledger_id" name="_search_main_ledger_id" class="form-control _search_main_ledger_id" value="{{old('_search_main_ledger_id',$data->_ledger->_name ?? '' )}}" placeholder="{{__('label._ledger_id')}}" required>

                            <input type="hidden" id="_main_ledger_id" name="_main_ledger_id" class="form-control _main_ledger_id" value="{{old('_main_ledger_id',$data->_ledger_id)}}" placeholder="{{__('label._ledger_id')}}" required>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form action="{{ url('damage_receive-settings')}}" method="POST">
        @csrf
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Damage Receive Form Settings</h5>
 ...
 $(document).on('click','._purchase_row_remove',function(event){
  ...
  $(document).on('click','.submit-button',function(event){
    ...
    var _main_ledger_id = $(document).find('._main_ledger_id').val();
     var _damage_type = $(document).find('._damage_type').val();



    if(_damage_type  ==""){
       alert(" Please Select Receive From Dropdown");
        $(document).find('._damage_type').addClass('required_border').focus();
        return false;
    }
