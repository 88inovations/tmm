...
$_fescal_year  = $data->_fescal_year ?? 0;
            @endphp
              <div class="card-body">
                {!! Form::model($data, ['method' => 'PATCH','route' => ['ta_da_setups.update', $data->id]]) !!}
                @csrf
                  <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-3">
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-3 ">
                            ...
                            <input type="text" id="_sloat_min" name="_sloat_min" class="form-control _sloat_min " value="{{old('_sloat_min',$data->_sloat_min ?? 0)}}" >
                        </div>
                          <div class="col-xs-12 col-sm-12 col-md-3 ">
                            <label class="mr-2" for="_sloat_max">Max Collection Amount:<span class="_required">*</span></label>
                            <input type="text" id="_sloat_max" name="_sloat_max" class="form-control _sloat_max " value="{{old('_sloat_max',$data->_sloat_max ?? 0 )}}">
                        </div>
                        @php
$_type  =  $data->_type ?? '';
$_status  = old('_status') ?? $data->_status ?? 1;
                        @endphp
                        <div class="col-xs-12 col-sm-12 col-md-2 ">
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-2 _ta_rate_row">
                            ...
                            <input type="text" id="_ta_rate" name="_ta_rate" class="form-control _ta_rate " value="{{old('_ta_rate',$data->_ta_rate ?? 0)}}">
                        </div>
                        
                         
                          <div class="col-xs-12 col-sm-12 col-md-2 _fixed_amount_row">
                            <label class="mr-2" for="_fixed_amount">Fixed Amount:</label>
                            <input type="text" id="_fixed_amount" name="_fixed_amount" class="form-control _fixed_amount " value="{{old('_fixed_amount',$data->_fixed_amount ?? 0)}}" >
                        </div>
