...
<option value="">{{__('label.Cost center')}}</option>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-2 ">
                            ...
                            <input type="text" id="_search_main_ledger_id" name="_search_main_ledger_id" class="form-control _search_main_ledger_id" value="{{old('_search_main_ledger_id',$data->_customer_ledger->_name ?? '')}}" placeholder="Customer" required>

                            <input type="hidden" id="_main_ledger_id" name="_customer_id" class="form-control _main_ledger_id" value="{{old('_customer_id',$data->_customer_id)}}" placeholder="Supplier" required>
