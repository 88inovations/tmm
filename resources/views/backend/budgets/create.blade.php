                     ...
                     <div class="form-group ">
                        ...
                        <select class="form-control _master_organization_id" name="organization_id" required >
                           ...
                           @if(sizeof($permited_organizations)>1) 
                            <option value="">{{__('label.organization')}}</option>
                            @endif
...
<option value="">{{__('label.Cost center')}}</option>
                           @endif
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-2 ">
                            ...
                            <input type="hidden" id="_main_ledger_id" name="_customer_id" class="form-control _main_ledger_id" value="{{old('_customer_id')}}" placeholder="Supplier" required>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-2">
                            <div class="form-group">
                                <label>{{__('label._po_order')}}:</label>
                                {!! Form::text('_po_order', null, array('placeholder' => __('label._po_order'),'class' => 'form-control')) !!}
                            </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-2">
                            <div class="form-group">
                                <label>{{__('label._wo_order')}}:</label>
                                {!! Form::text('_wo_order', null, array('placeholder' => __('label._wo_order'),'class' => 'form-control')) !!}
                            </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-2">
                            <div class="form-group">
                                <label>{{__('label.start_date')}}:</label>
                                {!! Form::date('_start_date', null, array('placeholder' => __('label.start_date'),'class' => 'form-control')) !!}
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-2">
                            <div class="form-group">
                                <label>{{__('label.end_date')}}:</label>
                                {!! Form::date('_end_date', null, array('placeholder' => __('label.end_date'),'class' => 'form-control')) !!}
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-2">
                            <div class="form-group">
                                      ...
                                      <table class="table table-bordered" >
                                          ...
                                          <tbody class="area__voucher_details form_body" id="area__voucher_details">
                                            <tr class="_voucher_row">
                                              ...
                                              <td>
                                                <input type="number" name="_cr_amount[]" class="form-control  _cr_amount budget_income" placeholder="Cr. Amount" value="{{old('_cr_amount',0)}}">
                                              </td>
                                            </tr>
                                          </tbody>
                                          <tfoot>
                                      ...
                                      <table class="table table-bordered" >
                                          ...
                                          <tbody class="area__voucher_details_expenses form_body" id="area__voucher_details_expenses">
                                            <tr class="_voucher_row">
                                              ...
                                              <td>
                                                <input type="number" name="_exp_dr_amount[]" class="form-control  _dr_amount" placeholder="Dr. Amount" value="{{old('_dr_amount',0)}}">
                                              </td>
...
function all_total_calculations(){
 ...
 var single_row =  `<tr class="_voucher_row">
  ...
  var expense_single_row = `<tr class="_voucher_row">
                                              ...
                                              <td>
                                                <input type="number" name="_exp_dr_amount[]" class="form-control  _dr_amount" placeholder="Dr. Amount" value="{{old('_exp_dr_amount',0)}}">
                                              </td>
