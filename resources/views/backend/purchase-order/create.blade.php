        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
               <form action="{{route('purchase-order.store')}}" method="POST" class="purchase_form" >
                @csrf
                                   <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 ">
                            <div class="form-group">
                              ...
                              <input type="text" id="_supplier_so_no" name="_supplier_so_no" class="form-control _supplier_so_no" value="{{old('_supplier_so_no')}}" placeholder="{{__('label._supplier_so_no')}}" >
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 mb-10">
                          <table class="table" style="border-collapse: collapse;">
                            ...
                            <tr>
                              ...
                              <td style="width: 70%;border:0px;">
                               <textarea class="form-control summernote" id="summernote" name="_term_condition">{{old('_term_condition')}}</textarea>
