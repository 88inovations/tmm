                ...
                <div class="modal-body search_modal">
                 @php 
                  ...
                  <div class="form-group row">
                    <label for="_date" class="col-sm-2 col-form-label">{{__('label._date')}}:</label>
                    <div class="col-md-10">
                      <div class="row">
                  ...
                  @include('backend.widgets.search_o_b_cSelect')
                  
                  <div class="form-group row">
                    <label for="id" class="col-sm-4 col-form-label">{{__('label.id')}}:</label>
                    <div class="col-md-8">
                  ...
                  <div class="form-group row">
                    <label for="_search_main_item_id " class="col-sm-4 col-form-label">{{__('label._item_id')}}:</label>
                    <div class="col-md-8">
                  ...
                  <div class="form-group row">
                    <label for="_user_name" class="col-sm-4 col-form-label">User:</label>
                    <div class="col-md-8">
                   ...
                   <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-4 col-form-label">Limit:</label>
                    <div class="col-md-8">
                    ...
                    <div class="col-md-8">
                      @php
             $cloumns = [ 'id'=>'ID','_date'=>'Date','_item_id'=>'Item Name'];
                          ...
                          <div class="col-md-8">
                              <div class="form-group ">
                                    ...
                                    <button type="button" class="btn btn-sm btn-warning mr-3" data-toggle="modal" data-target="#modal-default" title="Advance Search"><i class="fa fa-search mr-2"></i> </button>
                                     <a href="{{url('item_bonus_setups')}}" class="btn btn-sm btn-danger" title="Search Reset"><i class="fa fa-retweet mr-2"></i> </a>
                              </div>
                          </div>
                        </div><!-- end row -->
