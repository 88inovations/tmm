              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                 @php 
                  ...
                  <div class="form-group row">
                    <label for="_rate" class="col-sm-2 col-form-label">Rate:</label>
                    <div class="col-sm-10">
                      <input type="text" id="_rate" name="_rate" class="form-control" placeholder="Search By Rate" value="@if(isset($request->_rate)) {{$request->_rate ?? ''}}  @endif">
                    </div>
                  </div>
                    ...
                    <div class="col-sm-10">
                      @php
                      $cloumns = [ 'id'=>'ID','_name'=>'Name','_rate'=>'Rate'];
                          ...
                          <div class="col-md-8">
                              <div class="form-group mt-1">
                                    ...
                                    <button type="button" class="btn btn-sm btn-warning mr-3" data-toggle="modal" data-target="#modal-default" title="Advance Search"><i class="fa fa-search mr-2"></i> </button>
                                     <a href="{{url('vat-rules-reset')}}" class="btn btn-sm btn-danger" title="Search Reset"><i class="fa fa-retweet mr-2"></i> </a>
                              </div>
                          </div>
                        </div><!-- end row -->
