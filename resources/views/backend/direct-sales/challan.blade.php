...
<section class="invoice" id="printablediv">
     ...
     <div class="row invoice-info">
      ...
      @if($bin !='')
      <br>
      <b>VAT REGISTRATION NO:</b> {{ $settings->_bin ?? '' }}
      @endif
       </address>
      </div>
      ...
      <div class="col-sm-4 invoice-col">
       <b>Challan: {{ $data->_order_number ?? '' }}</b><br>
        ...
        <tbody>
         ...
         @php
                                  ...
                                  <tr>
                                     ...
                                     @endphp
                                            <td style="border:1px solid silver;" class="  " >{!! $_item->_items->_name ?? '' !!}</td>
                                            <td style="border:1px solid silver;" class="  " >{!! $_item->_trans_unit->_name ?? '' !!}</td>
