...
<div class="form-group row">
        ...
        <select class="form-control col-sm-7" name="_default_inventory">
          ...
          <option value="{{$account->id}}" @if(isset($form_settings->_default_inventory))@if($form_settings->_default_inventory==$account->id) selected @endif @endif>{{ $account->_code ?? '' }}-{{ $account->_name ?? '' }}</option>
          @endforeach
        </select>
      </div>
      <div class="form-group row">
        ...
        <select class="form-control col-sm-7" name="_default_sales">
          ...
          <option value="{{$account->id}}" @if(isset($form_settings->_default_sales))@if($form_settings->_default_sales==$account->id) selected @endif @endif>{{ $account->_code ?? '' }}-{{ $account->_name ?? '' }}</option>
          @endforeach
        </select>
      </div>
      <div class="form-group row">
        ...
        <select class="form-control col-sm-7" name="_default_cost_of_solds">
          ...
          <option value="{{$account->id}}" @if(isset($form_settings->_default_cost_of_solds))@if($form_settings->_default_cost_of_solds==$account->id) selected @endif @endif>{{ $account->_code ?? '' }}-{{ $account->_name ?? '' }}</option>
          @endforeach
        </select>
      </div>
      <div class="form-group row">
        ...
        <select class="form-control col-md-7" name="_default_discount">
          ...
          <option value="{{$account->id}}" @if(isset($form_settings->_default_discount))@if($form_settings->_default_discount==$account->id) selected @endif @endif>{{ $account->_code ?? '' }}-{{ $account->_name ?? '' }}</option>
          @endforeach
        </select>
      </div>
      <div class="form-group row">
        ...
        <select class="form-control col-md-7" name="_default_vat_account">
          <option value="">--Select ledger--</option>
          @foreach($dis_accounts as $account)
          <option value="{{$account->id}}" @if(isset($form_settings->_default_vat_account))@if($form_settings->_default_vat_account==$account->id) selected @endif @endif>{{ $account->_code ?? '' }}-{{ $account->_name ?? '' }}</option>
          @endforeach
        </select>
      </div>
      ...
      <div class="form-group row">
        ...
        <select class="form-control col-md-7" name="_default_cash_account">
          <option value="">--Select ledger--</option>
          @foreach($dis_accounts as $account)
          <option value="{{$account->id}}" @if(isset($form_settings->_default_cash_account))@if($form_settings->_default_cash_account==$account->id) selected @endif @endif>{{ $account->_code ?? '' }}-{{ $account->_name ?? '' }}</option>
          @endforeach
        </select>
      </div>
