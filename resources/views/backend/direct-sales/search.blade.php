...
$_payment_terms = $request->_payment_terms ?? '';
                  @endphp
                  <div class="form-group row">
                    <label for="id" class="col-sm-2 col-form-label">Sales Type:</label>
                    <div class="col-sm-10">
                   <select class="_payment_terms form-control" name="_payment_terms" >
                     <option value=""><-- Sales Type --></option>
                     @forelse($transection_terms as $tkey=>$tval)
                     <option value="{{$tval->id}}" @if($_payment_terms==$tval->id) selected @endif >{{$tval->_name ?? ''}}</option>
                     @empty
                     @endforelse
                   </select>
                    </div>
                  ...
                  @php
                  $_period = $request->_period ?? 0;
                  @endphp
                  <div class="form-group row">
                    <label for="id" class="col-sm-2 col-form-label">Sales Time:</label>
                    <div class="col-sm-10">
                    <select class="form-control _period" name="_period">
                                   <option value="0">---{{__('label._period')}}---</option>
                                   @forelse(_sales_periods() as $key=> $period)
                                   <option value="{{$key}}" @if($_period==$key) selected @endif >{{$period}}</option>
                  ...
                  <div class="form-group row">
                    <label for="BillNo" class="col-sm-2 col-form-label">Bill No:</label>
                    <div class="col-sm-10">
                      <input type="text" id="BillNo" name="BillNo" class="form-control" placeholder="BillNo" 
                      value="@if(isset($request->BillNo)){{$request->BillNo ?? ''}}@endif">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    <label for="_token_number" class="col-sm-2 col-form-label">{{__('label._token_number')}}:</label>
                    <div class="col-sm-10">
                      <input type="text" id="_token_number" name="_token_number" class="form-control" placeholder="{{__('label._token_number')}}" value="@if(isset($request->_token_number)){{$request->_token_number ?? ''}}@endif">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="track_no" class="col-sm-2 col-form-label">{{__('label.track_no')}}:</label>
                    <div class="col-sm-10">
                      <input type="text" id="track_no" name="track_no" class="form-control" placeholder="{{__('label.track_no')}}" value="@if(isset($request->track_no)){{$request->track_no ?? ''}}@endif">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="driver_name" class="col-sm-2 col-form-label">{{__('label.driver_name')}}:</label>
                    <div class="col-sm-10">
                      <input type="text" id="driver_name" name="driver_name" class="form-control" placeholder="{{__('label.driver_name')}}" value="@if(isset($request->driver_name)){{$request->driver_name ?? ''}}@endif">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="driver_mob_no" class="col-sm-2 col-form-label">{{__('label.driver_mob_no')}}:</label>
                    <div class="col-sm-10">
                      <input type="text" id="driver_mob_no" name="driver_mob_no" class="form-control" placeholder="{{__('label.driver_mob_no')}}" value="@if(isset($request->driver_mob_no)){{$request->driver_mob_no ?? ''}}@endif">
                    </div>
                  </div>
                  <div class="form-group row">
