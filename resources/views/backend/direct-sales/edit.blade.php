...
<div class="content-header">
          ...
          <div class=" col-sm-6 ">
            <ol class="breadcrumb float-sm-right">
             ...
             <li class="breadcrumb-item ">
                 <a target="__blank" href="{{url('direct-sales/print')}}/{{$data->id}}" class="btn btn-sm btn-warning"> <i class="nav-icon fas fa-print"></i> </a>
             ...
             <li class="breadcrumb-item ">
              ...
              @endcan
               @can('sales-create')
              <li class="breadcrumb-item ">
                        <a title="Add New" class="btn btn-success btn-sm" href="{{ route('direct-sales.create') }}"> <i class="nav-icon fas fa-plus"></i> </a>
               </li>
              @endcan
              <li class="breadcrumb-item ">
   ...
   $_inline_discount = $form_settings->_inline_discount ?? 0;
    ...
    $_show_payment_terms  = $form_settings->_show_payment_terms  ?? 0;
     $_session_period=$data->_period ?? 0;
    @endphp
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
               <form action="{{url('direct-sales/update')}}" method="POST" class="purchase_form" >
                @csrf
                       ...
                       <div class="col-xs-12 col-sm-12 col-md-2">
                        <input type="hidden" name="_form_name" class="_form_name"  value="sales_without_lots">
                            <div class="form-group">
                                <label>Date:</label>
                                  <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                      <input type="text" name="_date" class="form-control _date datetimepicker-input _submit_event_prevent" data-target="#reservationdate" value="{{_view_date_formate($data->_date)}}" />
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-3 ">
                            ...
                            <input type="text" id="_search_main_ledger_id" name="_search_main_ledger_id" class="form-control _search_main_ledger_id _submit_event_prevent" value="{{old('_search_main_ledger_id',$data->_ledger->_name ?? '' )}}" placeholder="Customer" required>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 ">
                            <div class="form-group">
                              ...
                              <input type="text" id="_order_number"  name="_order_number"  class="form-control _order_number _submit_event_prevent"  value="{{old('_order_number' ,$data->_order_number)}}" placeholder="Invoice Number"  readonly>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 ">
                                <div class="form-group">
                                  <label class="mr-2" for="_token_number">{{__('label._token_number')}}:</label>
                                  <input type="text" id="_token_number" name="_token_number" class="form-control _token_number _submit_event_prevent" value="{{old('_token_number',$data->_token_number)}}" placeholder="{{__('label._token_number')}}" >
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-2 ">
                                <div class="form-group">
                                  <label class="mr-2" for="track_no">{{__('label.track_no')}}:</label>
                                  <input type="text" id="track_no" name="track_no" class="form-control track_no _submit_event_prevent" value="{{old('track_no',$data->track_no)}}" placeholder="{{__('label.track_no')}}" >
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-1 ">
                                <div class="form-group">
                                  <label class="mr-2" for="_period">{{__('label._period')}}:</label>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-2 display_none">
                                <div class="form-group">
                                  ...
                                  <input type="text" id="driver_name" name="driver_name" class="form-control driver_name" value="{{old('driver_name',$data->driver_name)}}" placeholder="{{__('label.driver_name')}}" >
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-2 display_none">
                                <div class="form-group">
                                  <label class="mr-2" for="driver_mob_no">{{__('label.driver_mob_no')}}:</label>
                                  <input type="text" id="driver_mob_no" name="driver_mob_no" class="form-control driver_mob_no" value="{{old('driver_mob_no',$data->driver_mob_no)}}" placeholder="{{__('label.driver_mob_no')}}" >
                                </div>
                            </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 ">
                            <div class="form-group">
                              ...
                              <input type="text" id="_phone" name="_phone" class="form-control _phone _submit_event_prevent" value="{{old('_phone',$data->_phone)}}" placeholder="Phone" >
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 ">
                            <div class="form-group">
                              ...
                              <input type="text" id="_address" name="_address" class="form-control _address _submit_event_prevent"  value="{{old('_address',$data->_address)}}" placeholder="Address" >
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 ">
                            <div class="form-group">
                              ...
                              <input type="text" id="_referance" name="_referance" class="form-control _referance _submit_event_prevent" value="{{old('_referance',$data->_referance)}}" placeholder="Referance" >
                                      ...
                                      <table class="table table-bordered" >
                                          ...
                                          <tbody class="area__purchase_details" id="area__purchase_details">
                                            ...
                                            <tr class="_purchase_row">
                                              ...
                                              <td>
                                                <input type="text" name="_search_item_code[]" class="form-control _search_item_code width_150_px _submit_event_prevent" placeholder="Code" value="{{$detail->_items->_code ?? '' }}">
                                                <div class="search_box_item"></div>
                                              </td>
                                              <td>
                                                <input type="text" name="_search_item_id[]" class="form-control _submit_event_prevent _search_item_id _search_item_id__counter_{{($m_key+1)}} width_280_px _search_item_id__{{$detail->_p_p_l_id}}" placeholder="Item" value="{{$detail->_items->_name ?? '' }}">
                    ...
                    <div class="display_none">
                      ...
                      @endif 
                            ...
                            <tr>
                              ...
                              <td style="width: 70%;border:0px;">
                                @if ($_print = Session::get('_print_value'))
                                    ...
                                    <input type="text" id="_note"  name="_note" class="form-control _note" value="{{old('_note',$data->_note ?? 'Coupon Sales' )}}" placeholder="Note" required >
                              </td>
                            </tr>
                            <tr>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 bottom_save_section text-middle">
                          <a style="cursor:not-allowed;"  class="btn btn-default display_none">Net Total Tk. <b class="_net_amount">{{_php_round($data->_total ?? 0)}}</b> </a>
