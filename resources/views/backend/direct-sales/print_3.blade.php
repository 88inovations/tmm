...
<br>
@can('sales-edit-wl')
<a class="tm_invoice_btn tm_color2"  title="Edit" href="{{ route('direct-sales.edit',$data->id) }}">Edit</a>
@endcan
<br>
<a class="tm_invoice_btn tm_color2"  title="Back" href="{{ url('direct-sales') }}">Back</a>
