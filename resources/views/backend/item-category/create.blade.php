              ...
              <div class="col-sm-12 mb-1">
                <input required class="form-control  @error('dep_rate') is-invalid @enderror" name="dep_rate" type="number" min="0" step="any" placeholder="{{__('label.dep_rate')}}" value="{{old('dep_rate')}}" />
                  ...
                  <div class="col-sm-12 mb-1">
                      ...
                      <input type="hidden" id="asset_ledger_id" name="asset_ledger_id" class="form-control asset_ledger_id _main_ledger_id" value="{{old('asset_ledger_id')}}"  required>
                      <div class="search_box_main_ledger"> </div>
                  </div>
                   <div class="col-sm-12">
                   <label class=" mb-1 text-1000">{{__('label.asset_dep_ledger_id')}}</label>
                   </div>
                    <div class="col-sm-12 mb-1">
                  
                            <input type="text" id="_search_asset_dep_ledger_id" name="_search_asset_dep_ledger_id" class="form-control _search_asset_dep_ledger_id" value="{{old('_search_asset_dep_ledger_id')}}" placeholder="{{__('label.asset_dep_ledger_id')}}"   attr_url="{{url('main-ledger-search')}}">

                            <input type="hidden" id="asset_dep_ledger_id" name="asset_dep_ledger_id" class="form-control asset_dep_ledger_id" value="{{old('asset_dep_ledger_id')}}"  >
                            <div class="asset_dep_search_box_main_ledger"> </div>
                    </div>
                <div class="col-sm-12">
                   <label class=" mb-1 text-1000">{{__('label.asset_dep_exp_ledger_id')}}</label>
                   </div>
                    <div class="col-sm-12 mb-1">
                  
                            <input type="text" id="_search_asset_dep_exp_ledger_id" name="_search_asset_dep_exp_ledger_id" class="form-control _search_asset_dep_exp_ledger_id" value="{{old('_search_asset_dep_exp_ledger_id')}}" placeholder="{{__('label.asset_dep_exp_ledger_id')}}"   attr_url="{{url('main-ledger-search')}}">

                            <input type="hidden" id="asset_dep_exp_ledger_id" name="asset_dep_exp_ledger_id" class="form-control asset_dep_exp_ledger_id" value="{{old('asset_dep_exp_ledger_id')}}"  >
