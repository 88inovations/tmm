<div  >
    ...
    <div class="modal fade" id="modal-default">
        <div class="modal-dialog modal-lg">
           <form action="{{url('partical_production_receive_list')}}" method="GET" class="form-horizontal">
            @csrf
              <div class="modal-content">
                ...
                <div class="modal-body search_modal">
                 @php 
                  ...
                  <div class="form-group row">
                    <label for="_from_cost_center " class="col-sm-3 col-form-label">From Cost Center:</label>
                    <div class="col-sm-9">
                  ...
                  <div class="form-group row">
                    <label for="_to_branch " class="col-sm-3 col-form-label">To Branch:</label>
                    <div class="col-sm-9">
                  ...
                  <div class="form-group row">
                    <label for="_to_cost_center " class="col-sm-3 col-form-label">To Cost Center:</label>
                    <div class="col-sm-9">
        ...
        <!-- /.modal-dialog -->
                  ...
                  <form action="{{url('partical_production_receive_list')}}" method="GET">
                    @csrf
                          ...
                          <div class="col-md-8">
                              <div class="form-group ">
                                    ...
                                    <button type="button" class="btn btn-sm btn-warning mr-3" data-toggle="modal" data-target="#modal-default" title="Advance Search"><i class="fa fa-search mr-2"></i> </button>
                                     <a href="{{url('partical_production_receive_list')}}" class="btn btn-sm btn-danger" title="Search Reset"><i class="fa fa-retweet mr-2"></i> </a>
                              </div>
                          </div>
                        </div><!-- end row -->
