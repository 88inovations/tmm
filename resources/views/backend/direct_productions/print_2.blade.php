                ...
                <table>
                  <thead>
                    <tr>
                      ...
                      <th class="tm_width_3 tm_semi_bold tm_primary_color tm_gray_bg" style="border:1px solid silver;">Description</th>
                      ...
                      <th class="tm_width_1 tm_semi_bold tm_primary_color tm_gray_bg" style="border:1px solid silver;">Rate</th>
                      <th class="tm_width_1 tm_semi_bold tm_primary_color tm_gray_bg" style="border:1px solid silver;">Amount</th>
                    </tr>
                  </thead>
                  <tbody>
                    @php
                   ...
                   @forelse($detail_data as $akey=>$val)
                    <tr>
                     @php
                    $sub_qty +=$val->_qty ?? 0;
                    $sub__value +=$val->_value ?? 0;
                    @endphp
                      <td>{{($akey+1)}}</td>
                      <td class="tm_width_3" style="border:1px solid silver;">{{$val->_items->_name ?? ''}}</td>

                      <td class="tm_width_1" style="border:1px solid silver;">{{$val->_units->_name ?? ''}}</td>
                      <td class="tm_width_1" style="border:1px solid silver;">{{ _report_amount($val->_qty ?? '')}}</td>
                      <td class="tm_width_1" style="border:1px solid silver;">{{ _report_amount($val->_rate ?? '')}}</td>
                      <td class="tm_width_1" style="border:1px solid silver;">{{ _report_amount($val->_value ?? '')}}</td>
                    ...
                    <tr>
                      ...
                      <th class="tm_width_1" style="border:1px solid silver;">{{ _report_amount($sub_qty)}}</th>
                      <th style="border:1px solid silver;"></th>
                      <th style="border:1px solid silver;">{{_report_amount($sub__value)}}</th>
