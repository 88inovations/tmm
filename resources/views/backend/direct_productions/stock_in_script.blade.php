...
function _stock_in_purchase_row_add(event){
 ...
 console.log(_stock_in__item_row_count)
                        ...
                        for (var i = 0; i < data.length; i++) {
                         ...
                         search_html += `<tr class="_stock_in_search_row_item" >
                                  ...
                                  <input type="hidden" name="_item_vat" class="_item_vat" value="${data[i]._vat}">
                                   <input type="hidden" name="_item_vat" class="_item_vat" value="${data[i]._vat}">
                                   <input type="hidden" name="_main_unit_id" class="_stock_in_main_unit_id" value="${data[i]._unit_id}">
                                  <input type="hidden" name="_main_unit_text" class="_stock_in_main_unit_text" value="${data[i]._units?._name}">
                                   </td>
...
var _stock_in_main_unit_id = $(this).children('td').find('._stock_in_main_unit_id').val();
  ...
  console.log(_stock_in_main_unit_id)
var self = $(this);
