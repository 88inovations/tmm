...
<div class="content-header">
    ...
    <div class="content">
      <div class="container-fluid">
          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
               ...
               <form action="{{route('direct_productions.store')}}" method="POST" class="purchase_form" >
                @csrf
                    <div class="row">
                       <div class="col-xs-12 col-sm-12 col-md-2">
                        <input type="hidden" name="_form_name" class="_form_name"  value="direct_productions">
        ...
        <div class="col-xs-12 col-sm-12 col-md-2 ">
         <div class="form-group ">
             <label>{!! __('label._start_date') !!}:<span class="_required">*</span></label>
            <input type="date" name="_start_date" class="form-control _start_date" value="{{old('_start_date')}}" required>
         </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-2 ">
         <div class="form-group ">
             <label>{!! __('label._end_date') !!}:</label>
            <input type="date" name="_end_date" class="form-control _end_date" value="{{old('_end_date')}}">
         </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-2 ">
         <div class="form-group ">
             <label>{!! __('label._quatation_no') !!}:</label>
            <input type="text" name="_quatation_no" class="form-control _quatation_no" value="{{old('_quatation_no')}}">
         </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-2 ">
         <div class="form-group ">
             <label>{!! __('label._sales_order_no') !!}:</label>
            <input type="text" name="_sales_order_no" class="form-control _sales_order_no" value="{{old('_sales_order_no')}}">
         </div>
        </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-2 @if(sizeof($permited_organizations)==1) display_none @endif">
                     <div class="form-group ">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 display_none" >
                            <div class="form-group ">
                                <label>{{__('label._pm_id')}}:<span class="_required">*</span></label>
                               <select class="form-control" name="_pm_id"  >
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 display_none" >
                            <div class="form-group ">
                                <label>{{__('label._apporoved_by_id')}}:<span class="_required">*</span></label>
                               <select class="form-control" name="_apporoved_by_id"  >
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 display_none">
                            <div class="form-group">
                              <label class="mr-2" for="_budget_id">{{__('label._budget_id')}}:</label>
                              <input type="text" id="_budget_id" name="_budget_id" class="form-control _budget_id" value="{{old('_budget_id')}}" placeholder="Referance" >
                            </div>
                        </div>
                                ...
                                <div class="table-responsive">
                                      <table class="table table-bordered" >
                                          <thead >
                                            ...
                                            <th class="text-left  @if($form_settings->_show_unit==0) display_none    @endif " >Tran. Unit</th>
                                          ...
                                          <tbody class="area__purchase_details" id="_stock_in_area__purchase_details">
                                            @forelse($_stock_ins as $m_key=>$val)

                                             @php
                                              $_total_qty_amount += $val->_qty ??  0;
                                              $_total_value_amount += $val->_value ??  0;
                                              @endphp
                                            <tr class="_purchase_row">
                                              ...
                                              <td></td>
                                              <td>
                                                <input type="text" name="_stock_in__search_item_id[]" class="form-control _stock_in__search_item_id width_280_px" placeholder="Item" value="{{$val->_items->_name ?? ''}}">
                                                 <input type="hidden" name="_stock_in__item_id[]" class="form-control _stock_in__item_id width_200_px" value="{{$val->_items->id ?? ''}}">
                                                <input type="hidden" name="_stock_in__p_p_l_id[]" class="form-control _stock_in__p_p_l_id " value="{{$val->_p_p_l_id ?? ''}}">
                                                <input type="hidden" name="_stock_in__purchase_invoice_no[]" class="form-control _stock_in__purchase_invoice_no" value="{{$val->_no}}">
                                                <input type="hidden" name="_stock_in__purchase_detail_id[]" class="form-control _stock_in__purchase_detail_id" value="{{$val->id}}">
                                                <div class="_stock_in_search_box_item">
                                                  
                                                </div>
                                              </td>
                                                 <td class="display_none">
                                                <input type="hidden" class="form-control _stock_in_base_unit_id width_100_px" name="_stock_in_base_unit_id[]" value="{{$val->_base_unit}}" />
                                                <input type="text" class="form-control _stock_in_main_unit_val width_100_px" readonly name="_stock_in_main_unit_val[]" value="{{$val->_units->_name ?? '' }}" />
                                              </td>
                                              <td class="display_none">
                                                <input type="number" name="_stock_inconversion_qty[]" min="0" step="any" class="form-control _stock_inconversion_qty " value="{{$val->_unit_conversion ?? 1}}" readonly>
                                                <input type="number" name="_stock_in_base_rate[]" min="0" step="any" class="form-control _stock_in_base_rate "  readonly value="{{$val->_base_rate ?? 1}}">
                                              </td>
                                              <td>
                                              <select class="form-control _transection_unit" name="_transection_unit[]">
                                                  @forelse($val->_items->unit_conversion as $conversion_units )
                                                    <option 
        ...
        attr_item_id="{{$conversion_units->_item_id}}"
                                                    ...
                                                    @if($conversion_units->_conversion_unit==$val->_transection_unit) selected @endif >{!! $conversion_units->_conversion_unit_name ?? '' !!}</option>
                                                  @empty
                                                  @endforelse
                                                </select>
                                              </td>
                                              <td class="@if(isset($form_settings->_show_barcode)) @if($form_settings->_show_barcode==0) display_none   @endif @endif">
                                                <input type="text" name="{{($m_key+1)}}__stock_in__barcode__{{$val->_item_id}}" class="form-control _stock_in__barcode {{($m_key+1)}}__stock_in__barcode"  value="{{$val->_stock_in__barcode ?? '' }} " id="{{($m_key+1)}}__barcode" >
                                               

                                                <input type="hidden" name="_stock_in__ref_counter[]" value="{{($m_key+1)}}" class="_stock_in__ref_counter" id="{{($m_key+1)}}__stock_in__ref_counter">


                                              </td>
                                              
                                              <td>
                                                <input type="number" name="_stock_in__qty[]" class="form-control _stock_in__qty _stock_in_common_keyup" value="{{$val->_qty ?? 0}}">
                                              </td>
                                              <td>
                                                <input type="number" name="_stock_in__rate[]" class="form-control _stock_in__rate _stock_in_common_keyup" value="{{$val->_rate ?? 0}}">
                                              </td>
                                              <td>
                                                <input type="number" name="_stock_in__sales_rate[]" class="form-control _stock_in__sales_rate " value="{{$val->_sales_rate ?? 0}}" >
                                              </td>
                                              <td>
                                                <input type="number" name="_stock_in__value[]" class="form-control _stock_in__value " readonly value="{{$val->_value ?? 0}}">
                                              </td>
                                              ...
                                              <td class="@if(isset($form_settings->_show_manufacture_date)) @if($form_settings->_show_manufacture_date==0) display_none  @endif @endif">
                                                <input type="date" name="_stock_in__manufacture_date[]" class="form-control _stock_in__manufacture_date " value="{{$val->_manufacture_date ?? '' }}">
                                              </td>
                                              <td class="@if(isset($form_settings->_show_expire_date)) @if($form_settings->_show_expire_date==0) display_none  @endif @endif">
                                                <input type="date" name="_stock_in__expire_date[]" class="form-control _stock_in__expire_date " value="{{$val->_expire_date ?? '' }}">
                                              </td>
                                             <td class="@if(isset($form_settings->_show_self)) @if($form_settings->_show_self==0) display_none  @endif @endif">
                                                <input type="text" name="_stock_in__store_salves_id[]" class="form-control _stock_in__store_salves_id " value="{{$val->_store_salves_id ?? '' }}">
                                              </td>
                                          ...
                                          <tfoot>
                                            ...
                                            @endif
                                              <td>
                                                <input type="number" step="any" min="0" name="_total_qty_amount" class="form-control _stock_in__total_qty_amount" value="{{$_total_qty_amount ?? 0}}" readonly required>
                                              </td>
                                              <td></td>
                                              <td></td>
                                              ...
                                              <td>
                                                <input type="number" step="any" min="0" name="_total_value_amount" class="form-control _stock_in__total_value_amount" value="{{$_total_value_amount ?? 0}}" readonly required>
                                              </td>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 mb-10">
                          <table class="table" style="border-collapse: collapse;margin: 0px auto;">
                            ...
                            <tr>
                              ...
                              <td style="border:0px;width: 80%;">
                          <input type="text" name="_stock_in__total" class="form-control width_200_px" id="_stock_in__total" readonly value="{{$_total_value_amount}}">

                          <input type="hidden" name="_stock_in__item_row_count" value="{{sizeof($_stock_ins)}}" class="_stock_in__item_row_count">
                              </td>
                            </tr>
