            ...
            <input type="text" name="_sales_order_no" class="form-control _sales_order_no" value="{{old('_sales_order_no')}}">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-2 ">
                     <div class="form-group ">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 mb-10">
                          <table class="table" style="border-collapse: collapse;margin: 0px auto;">
                            ...
                            <tr>
                              ...
                              <td style="border:0px;width: 80%;">
                                @php
                                $_p_statues = \DB::table("production_status")->whereIn('id',[2,3])->get();
                                @endphp
                            ...
                            <tr>
                              <td style="border:0px;width: 20%;"><label for="_lock">Is Close?</label></td>
                              <td style="border:0px;width: 80%;">
                                
                                
                               <select class="form-control" name="_lock" required >
                                  <option value="0" >Production Runnig </option>
                                  <option value="1" >Production Close & Lock </option>
                                </select>
                              </td>
                            </tr>
                        ...
                        <button 
                          type="button" 
                            attr_url="{{ url('check_available_row_materials')}}"
                            data-toggle="modal" data-target="#checkAbailableModal" 
                            class="btn btn-warning mt-2 check_row_materials" 
                            >Check Raw Materials <i class="fa fa-check" aria-hidden="true"></i>
                        </button> 
