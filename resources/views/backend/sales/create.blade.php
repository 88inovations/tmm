...
<div class="content-header">
          ...
          <div class=" col-sm-6 ">
            <ol class="breadcrumb float-sm-right">
             ...
             <li class="breadcrumb-item ">
              ...
              <li class="breadcrumb-item ">
                 <a class="btn btn-sm btn-success" title="List" href="{{ route('sales-order.index') }}"> Sales Order/Quotation </a>
               </li>
               @endcan
            </ol>
          </div><!-- /.col -->
    ...
    $form_settings = \App\Models\SalesFormSetting::first();
                                          ...
                                          <tbody class="area__purchase_details" id="area__purchase_details">
                                            <tr class="_purchase_row _purchase_row__">
                                              ...
                                              <td class=" @if($_show_model  ==0) display_none @endif ">
                                                ...
                                                <input type="text" name="_model[]" class="form-control _model 1__barcode"  value=""  >
...
$(this).parent().parent().parent().parent().parent().parent().find('.'+find_counter_id+"__barcode").attr('name',_new_name_for_barcode); 
  ...
  $(this).parent().parent().parent().parent().parent().parent().find('._model').val(_model);
