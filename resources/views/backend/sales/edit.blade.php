                                ...
                                <div class="table-responsive">
                                      <table class="table table-bordered" >
                                          <thead >
                                            ...
                                            <th class="text-left @if($form_settings->_show_model == 0) display_none @endif" >Model</th>
  ...
  $_unit_conversion =1;
                                             ...
                                             <td class=" @if($form_settings->_show_barcode == 0) display_none  @endif ">
                                               ...
                                               <td class=" @if($_show_model  ==0) display_none @endif ">
                                                ...
                                                <input type="text" name="_model[]" class="form-control _model 1__barcode"  value="{{$detail->_model ?? '' }}"  >
                                          ...
                                          <tfoot>
                                            <tr>
                                              ...
                                              <td class="@if($form_settings->_show_unit==0) display_none @endif"></td>
                                                ...
                                                <td class=" @if($_show_model  ==0) display_none @endif "></td>
                ...
                <input type="hidden" name="_id_item" class="_id_item" value="${data[i]._item_id}">
                              ...
                              search_html +=`<td class="text-center">
                                      ...
                                      for (var j = 0; j < _barcode_array.length; j++) {
                                       ...
                                       _attr__p_item__model="${data[i]._model}"
...
//alert(p_item__code)
 ...
 _attr__p_item__model = isEmpty(_attr__p_item__model);
      ...
      if(data.length > 0 ){
            ...
            <thead>
              ...
              <th>Sale Rate</th>
                      ...
                      <input type="hidden" name="_p_item_barcode" class="_p_item_model" value="${isEmpty(data[i]._model)}">
  ...
  <input type="hidden" name="_p_item_warranty" class="_p_item_warranty" value="${data[i]._warranty}">
   ...
   <input type="hidden" name="_main_unit_text" class="_main_unit_text" value="${data[i]?._unit_name}">
                                   ...
                                   <td>${data[i]._qty} ${data[i]?._unit_name}</td>
                                    <td class=" @if($_show_model  ==0) display_none @endif">${isEmpty(data[i]._model)}</td>
...
$(document).on('click','.search_row_item',function(){
  ...
  var _p_item_model = $(this).find('._p_item_model').val();
...
$(this).parent().parent().parent().parent().parent().parent().find('.'+find_counter_id+"__barcode").attr('name',_new_name_for_barcode); 
  ...
  $(this).parent().parent().parent().parent().parent().parent().find('._model').val(isEmpty(_p_item_model));
  ...
  $("._item_row_count").val(_item_row_count)
      ...
      $("#area__purchase_details").append(`<tr class="_purchase_row">
                                              ...
                                              <td class="@if($form_settings->_show_unit==0) display_none @endif">
                                               ...
                                               <td>
                                                <input readonly type="text" name="pack_size[]" class="form-control pack_size " value="" >
                                              </td>
