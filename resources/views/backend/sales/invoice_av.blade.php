      ...
      <tr>
        <td colspan="10" style="padding-bottom: 10px;">
          <div style="width: 100%;position: relative;">
            <div class="logo_araa">
               <img src="{{url($settings->logo ?? '')}}" alt="{{$settings->name ?? '' }}" style="width: 120px;margin-top:0px;"  >
            </div>
...
Customer Copy
       ...
       <tr>
        ...
        @endphp
        <td colspan="5" style="text-align:right;white-space: nowrap;padding-top:5px;">
        ...
        <td colspan="4" style="border: 1px solid #56585bc2;">
          <table style="width:100%;border-collapse:collapse;font-size: 12px;">
            <tr>
              ...
              <td style="width:75%;border-bottom: 1px solid #56585bc2;">: {{ id_to_cloumn($data->_order_ref_id ?? '','_order_number','sales_orders') }}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td style="width:75%;border-bottom: 1px solid #56585bc2;">:<span style="color:{{$data->_terms_con->_font_color ?? '#00000'}}"> {{ $data->_terms_con->_name ?? '' }} </span></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td style="width50%;">:{{ $data->_referance ?? '' }}</td>
            </tr>
          </table>
        </td>
      </tr>
    ...
    <tbody style="">
      ...
      <tr>
       ...
       <tr>
          ...
          <th style="border:1px solid #56585bc2;width: 30%;font-size:12px;text-align:left;white-space: nowrap;" >Name of Products</th>
