                                ...
                                <div class="table-responsive">
                                      <table class="table table-bordered" >
                                          ...
                                          $m_key=0;
                                           ...
                                           $__master_details = $productPrices ?? [];
                                          @endphp
                                          <tbody class="area__purchase_details" id="area__purchase_details">
                                            @if(sizeof($productPrices) > 0)
                                            @forelse($productPrices as $itmem_key=> $details)
                                            @if(sizeof($details) > 0)
                                            ...
                                            <tr class="_purchase_row">
                                              ...
                                              <td>
                                               ...
                                               <td>
                                                <input type="text" name="_search_item_code[]" class="form-control _search_item_code width_150_px" placeholder="Code" value="{{$detail->_item_code ?? '' }}">
                                                <div class="search_box_item">
                                                  
                                                </div>
                                              </td>
                                              <td>
                                                <input type="text" name="_search_item_id[]" class="form-control _search_item_id _search_item_id__counter_{{($m_key+1)}} width_280_px _search_item_id__{{$detail->_p_p_l_id}}" placeholder="Item" value="{{$detail->_name ?? '' }}">
                                              ...
                                              <td class="@if($form_settings->_show_unit==0) display_none @endif">
                                               ...
                                               <td>
                                                <input readonly type="text" name="pack_size[]" class="form-control pack_size pack_size__counter_{{($m_key+1)}}" value="{{ id_to_cloumn($detail->_pack_size_id,'_name','item_pack_sizes')}}" >
                                              </td>
                                              ...
                                              <td class=" @if($form_settings->_show_barcode == 0) display_none  @endif ">
                                               ...
                                               @endphp
                                                ...
                                                <input type="hidden" name="_ref_counter[]" value="counter_{{($m_key+1)}}" class="_ref_counter _ref_counter__counter_{{($m_key+1)}} _ref_counter__{{$detail->_p_p_l_id}}" id="counter_{{($m_key+1)}}__ref_counter">
                                                 ...
                                                 @php
                                                $_unique_barcode = $detail->_unique_barcode ?? 0;
                                                @endphp
                                              ...
                                              <td>
                                                <input type="number" min="0"  name="sale_qty[]" class="form-control sale_qty sale_qty__counter_{{($m_key+1)}}  sale_qty__{{$detail->_p_p_l_id}} _common_keyup"  value="{{$detail->sale_qty ?? 0 }}" >
                                              </td>
                                              <td class="@if($_show_free_qty==0) display_none @endif">
                                                <input type="number" min="0"  name="free_qty[]" class="form-control free_qty free_qty__counter_{{($m_key+1)}}  free_qty__{{$detail->_p_p_l_id}} _common_keyup"  value="{{$detail->free_qty ?? 0 }}" >
                                              </td>
                                              <td class="@if($_show_free_qty==0) display_none @endif">
                                              ...
                                              <td class="@if($form_settings->_show_cost_rate == 0) display_none @endif">
                                                <input type="number" min="0"  name="_rate[]" class="form-control _rate _rate__counter_{{($m_key+1)}} _rate__{{$detail->_p_p_l_id}}  " value="{{$detail->_pur_rate ?? 0 }}" readonly>
                                              </td>
                                              <td>
                                              ...
                                              <td class="@if($form_settings->_inline_discount == 0) display_none @endif">
                                                <input type="number" name="_discount[]" class="form-control  _discount _discount__counter_{{($m_key+1)}}  _discount__{{$detail->_p_p_l_id}} _common_keyup" value="{{$detail->_discount ?? 0}}">
                                              </td>
                                              <td class="@if($form_settings->_inline_discount == 0) display_none @endif">
