...
<head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <link rel="stylesheet" href="{{asset('backend/invoices/style.css?v=1.4')}}">
  <style>
      .tm_mb2{
        ...
        <div class="tm_invoice_in">
          <div class="tm_invoice_head tm_align_center tm_mb20">
            <div class="tm_invoice_left">
              <div class="tm_logo">
                <img src="{{asset($settings->logo ?? '')}}" alt="Logo" style="width:250px;height:auto;">
              </div>
            </div>
          ...
          <div class="tm_invoice_head tm_mb10">
            <div class="tm_invoice_left">
              <p class="tm_mb2"><b class="tm_primary_color"> {{$settings->name ?? '' }}</b></p>
            ...
            <div class="tm_invoice_right tm_text_right">
              ...
              <p >
                ...
                @if($form_settings->_defaut_customer ==$data->_ledger_id)
                  Customer :    {{ $data->_referance ?? $data->_ledger->_name }}
                  @else
                   Customer : {{$data->_ledger->_name ?? '' }}
                  @endif
                  </span> <br>
                  @if($_alious !='')
                Proprietor:{{$data->_ledger->_alious ?? '' }}<br>
                @endif
                </b>
         ...
         @php
                    ...
                    <tr>
                              ...
                              <td style="font-size: 1em;color: #000;line-height: 1.2em;border:1px solid silver;vertical-align:top;"> <b>{{ _report_amount($_qty_total ?? 0)}}</b> </td>
                              <td style="font-size: 1em;color: #000;line-height: 1.2em;border:1px solid silver;vertical-align:top;"></td>
                              
                              <td style="font-size: 1em;color: #000;line-height: 1.2em;border:1px solid silver;vertical-align:top;text-align:right;"><b> {{ _report_amount($_value_total ?? 0) }}</b>
                              </td>
                            </tr>
                            <tr>
                                      ...
                                      <th colspan="2" style="font-size: 1em;color: #000;line-height: 1.2em;border:1px solid silver;vertical-align:top;text-align:right;">{!! _report_amount($data->_sub_total ?? 0) !!}</th>
                                    </tr>
                                   @if($data->_total_discount > 0)
                                    <tr>
                                      ...
                                      <th  colspan="2"  style="font-size: 1em;color: #000;line-height: 1.2em;border:1px solid silver;vertical-align:top;text-align:right;">{!! _report_amount($data->_total_discount ?? 0) !!}</th>
                                    </tr>
                                   @endif
                                    ...
                                    <tr>
                                      ...
                                      <th  colspan="2"  style="font-size: 1em;color: #000;line-height: 1.2em;border:1px solid silver;vertical-align:top;text-align:right;">{!! _report_amount($data->_total_vat ?? 0) !!}</th>
                                    </tr>
                                    @endif
                                    <tr>
                                      ...
                                      <th  colspan="2"  style="font-size: 1em;color: #000;line-height: 1.2em;border:1px solid silver;vertical-align:top;text-align:right;">{!! _report_amount($data->_total ?? 0) !!}</th>
                                    </tr>
                                    @php
                                    ...
                                    @if($ac_val->_ledger->id !=$data->_ledger_id)
                                     ...
                                     @endphp
                                    <tr>
                                      <th  colspan="3"  style="font-size: 1em;color: #000;line-height: 1.2em;border:1px solid silver;vertical-align:top;text-align: right;" ><b> {!! $ac_val->_ledger->_name ?? '' !!}[+]
                                        </b></th>
                                      <th  colspan="2"  style="font-size: 1em;color: #000;line-height: 1.2em;border:1px solid silver;vertical-align:top;">{!! _report_amount( $ac_val->_cr_amount ?? 0 ) !!}</th>
                                    </tr>
                                    @endif
                                    ...
                                    <tr>
                                      ...
                                      <th  colspan="2"  style="font-size: 1em;color: #000;line-height: 1.2em;border:1px solid silver;vertical-align:top;text-align:right;">{!! _report_amount( $ac_val->_dr_amount ?? 0 ) !!}</th>
                                    </tr>
                                    @endif
                                    ...
                                    <tr>
                                      ...
                                      <th  colspan="2"  style="font-size: 1em;color: #000;line-height: 1.2em;border:1px solid silver;vertical-align:top;text-align:right;">{!! _report_amount( $_due_amount) !!}</th>
                                    </tr>
                              ...
                              <tr>
                                      ...
                                      <th  colspan="2"  style="font-size: 1em;color: #000;line-height: 1.2em;border:1px solid silver;vertical-align:top;text-align:right;">{!! _show_amount_dr_cr(_report_amount($data->_p_balance ?? 0)) !!}</th>
                                    </tr>
                              ...
                              @if($_l_balance !=0)
                                    <tr>
                                      ...
                                      <th  colspan="2"  style="font-size: 1em;color: #000;line-height: 1.2em;border:1px solid silver;vertical-align:top;text-align:right;">{!! _show_amount_dr_cr(_report_amount($data->_l_balance ?? 0)) !!}</th>
                                    </tr>
                            @endif
                            @endif
                            <tr>
                                  <td  colspan="5"  style="font-size: 1em;"><p class="lead"> In Words:  {{ nv_number_to_text($data->_total ?? 0) }} </p></td>
                                </tr>
                                @php
