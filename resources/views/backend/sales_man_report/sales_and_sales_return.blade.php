...
@endphp
            ...
            <td style="width: 6%;white-space: nowrap;">{!! _view_date_formate($val->_date ?? '') !!}</td>
...
<tr>
            ...
            <th style="width: 10%;">{{_report_amount($sales_man_sub__sales_amount)}}</th>
            <th style="width: 10%;">{{_report_amount($sales_man_sub__sales_return_amount)}}</th>
