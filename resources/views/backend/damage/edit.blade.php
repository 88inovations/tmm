...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class=" col-sm-6 ">
             <a class="m-0 _page_name" href="{{ route('damage.index') }}"> {{ $page_name ?? '' }} </a>
          </div><!-- /.col -->
          <div class=" col-sm-6 ">
            <ol class="breadcrumb float-sm-right">
             ...
             <li class="breadcrumb-item ">
                 <a target="__blank" href="{{url('damage/print')}}/{{$data->id}}" class="btn btn-sm btn-warning"> <i class="nav-icon fas fa-print"></i> </a>
             ...
             <li class="breadcrumb-item ">
              ...
              @endcan
               @can('damage-create')
              <li class="breadcrumb-item ">
                        <a title="Add New" class="btn btn-success btn-sm" href="{{ route('damage.create') }}"> <i class="nav-icon fas fa-plus"></i> </a>
               </li>
              @endcan
              <li class="breadcrumb-item ">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
               <form action="{{url('damage/update')}}" method="POST" class="purchase_form" >
                @csrf
                      <div class="row">

                       <div class="col-xs-12 col-sm-12 col-md-2">
                        <input type="hidden" name="_form_name" class="_form_name"  value="damage_adjustments">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 display_none">
                            <div class="form-group">
                              <label class="mr-2" for="_order_ref_id">Damage Order:</label>
                              <input type="text" id="_order_ref_id" name="_order_ref_id" class="form-control _order_ref_id" value="{{old('_order_ref_id',$data->_order_ref_id)}}" placeholder="Damage Order" >
       ...
       @endforelse
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2">
                         ...
                         <div class="col-xs-12 col-sm-12 col-md-3 ">
                            ...
                            <input type="text" id="_search_main_ledger_id" name="_search_main_ledger_id" class="form-control _search_main_ledger_id" value="{{old('_search_main_ledger_id',$data->_ledger->_name ?? '' )}}" placeholder="Ledger" required>

                            <input type="hidden" id="_main_ledger_id" name="_main_ledger_id" class="form-control _main_ledger_id" value="{{old('_main_ledger_id',$data->_ledger_id)}}" placeholder="Ledger" required>
                                ...
                                <div class="table-responsive">
                                      <table class="table table-bordered" >
                                          <thead >
                                            ...
                                            <th class="text-left @if($_show_cost_rate == 0) display_none @endif" >Cost Rate</th>
                                          ...
                                          <tbody class="area__purchase_details" id="area__purchase_details">
                                            ...
                                            <tr class="_purchase_row">
                                              ...
                                              <td>
                                                ...
                                                <input type="hidden" name="_sales_detail_row_id[]" class="form-control _sales_detail_row_id" value="{{$detail->id}}" >
                                              ...
                                              <td class="@if($_show_barcode == 0) display_none @endif">
                                                ...
                                                <input type="hidden" name="_unique_barcode[]" value="{{$detail->_items->_unique_barcode}}" class="_unique_barcode   1__unique_barcode" id="{{($m_key+1)}}_unique_barcode">
      ...
      showPlusAfter: 1,
                                            ...
                                            @endif
                                              <td class="@if($_show_warranty  ==0) display_none @endif">
                                                <select name="_warranty[]" class="form-control _warranty {{($m_key+1)}}___warranty">
                                              ...
                                              <td>
                                                <input type="number" min="0"  name="_qty[]" class="form-control _qty _common_keyup"  value="{{$detail->_qty ?? 0 }}"  @if($detail->_items->_unique_barcode==1) readonly @endif >
                                              </td>
                                              <td class="@if($_show_cost_rate == 0) display_none @endif">
                                                <input type="number" min="0"  name="_rate[]" class="form-control _rate  " value="{{$detail->_rate ?? 0 }}" readonly>
                                              </td>
                                              <td>
                                                <input type="number" min="0"  name="_sales_rate[]" class="form-control _sales_rate " value="{{$detail->_sales_rate ?? 0 }}" >
                                              </td>
...
<script type="text/javascript">
 ...
 $(document).on("click","#form_settings",function(){
  ...
  var request = $.ajax({
      url: "{{url('item-damage-search-edit')}}",
      method: "GET",
...
var _previous_row_id = $(this).parent().parent().parent().parent().parent().parent().find('._p_p_l_id').val();

if(_previous_row_id ==row_id){
    var _previous__barcode=  $(this).parent().parent().parent().parent().parent().parent().find('._barcode').val();
    _barcode = _barcode+","+_previous__barcode;
 ...
 $(document).on('click','._purchase_row_remove',function(event){
  ...
  $(document).on('click','.submit-button',function(event){
    ...
    if(_p_p_l_ids_qtys.length > 0){
        var request = $.ajax({
                url: "{{url('check-available-qty-update-damage')}}",
                method: "GET",
                async:false,
                data: { _p_p_l_ids_qtys,unique_p_ids,_sales_id,_all_barcode,_form_name },
                dataType: "JSON"
              });
    ...
    if(_stop_sales ==1){
      alert(" You Can not add Damage Item More then Available Qty  ");
       var _message =" You Can not add Damage Item More then Available Qty";
    ...
    if(empty_qty.length > 0){
       alert(" You Can not Damage empty qty !");
      return false;
