    ...
    <!-- Table row -->
     <table class="cewReportTable">
          ...
          <tr>
            ...
            <th style="width: 15%;">Account Group</th>
...
@forelse($main_account as $first_head_key=>$first_head_val)
              <tr>
                <td></td>
                <td >{{ key_wise_value($first_head_key,$account_heads) }}</td>
                @forelse($first_head_val as $led_key=>$led_val)
...
@endforelse
           ...
           <tr>
              <th class="text-left " colspan="2">TOTAL {{ id_wise_name($main_account_key,"main_account_head",'_name') }}</th>
            ...
            @if($key ==2)
            <tr>
              <th class="red_color" colspan="2">GROSS PROFIT</th>
