...
<section class="invoice" id="printablediv">
   ...
   <table class="cewReportTable">
          ...
          <tr>
            ...
            <th style="width: 10%;">{{__('label._opening_amount')}}</th>
            <th style="width: 10%;">{{__('label._current_amount')}}</th>
...
@if(($val->_opeing_balance + $val->_current_balance ) !=0)
            ...
            <td style="width: 10%;">{!! _show_amount_dr_cr(_report_amount($val->_opeing_balance?? 0)) !!}</td>
            <td style="width: 10%;">{!! _show_amount_dr_cr(_report_amount($val->_current_balance?? 0)) !!}</td>
                        ...
                        do {
                            ...
                            if ($available_quantity < $_l_balance_update) {
                               // return $available_quantity;
                                 $due_sales_info = \App\Models\Sales::select('id','_date','_order_number','_total','_total_discount','_total_vat')
...
<tr>
            ...
            <th style="width: 10%;">{{_show_amount_dr_cr(_report_amount($grand_total_opeing_balance))}}</th>
            <th style="width: 10%;">{{_show_amount_dr_cr(_report_amount($sub_total_branch_current_balance))}}</th>
  ...
  <tr>
            ...
            <th style="width: 10%;">{{_show_amount_dr_cr(_report_amount($grand_total_opeing_balance))}}</th>
            <th style="width: 10%;">{{_show_amount_dr_cr(_report_amount($grand_total_current_balance))}}</th>
