...
._red_bg{
 ...
 font-weight: bold;
    ...
    <div class="_report_button_header">
      <a class="nav-link"  href="{{url('advance_balance_sheet')}}" role="button"><i class="fas fa-search"></i></a>
...
@if(sizeof($l_4value) > 0)
<tr class="grey_bg">
                     <th style="text-align: left;border:1px solid silver;"><b>&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;TOTAL  {!! $l_4key ?? '' !!} :</b></th>
...
<tr class="grey_bg">
                     ...
                     <th style="text-align: right;font-weight: bold;">{!! _show_amount_dr_cr(_report_amount(  $l2_total_amount_with_dr_cr_opening ))  !!}</th>
                     <th style="text-align: right;padding-right: 10px;"><b> {!! _show_amount_dr_cr(_report_amount(  $l2_total_amount_with_dr_cr_opening ))  !!}</b></th>
</tr>
