@include('backend.restaurant-pos.header')
...
<body class="skin-blue layout-top-nav pace-done" style="height: auto;" cz-shortcut-listen="true">
	...
	<div class="wrapper" style="height: auto;">
		<header class="main-header display_none">
		...
		<div class="modal fade" id="tableInormation">
				<div class="modal-dialog modal-lg" style="width: 100%;margin: 0;">
					<div class="modal-content" style="height: 110vh;overflow-y: scroll;">
						...
						<div class="modal-body tableInformationDisplay" style="padding: 5px;">
						...
						<div class="box box-primary">
								...
								<div class="box-header with-border" style="padding-bottom: 3px;">
									<div class="row">
										<div class="col-md-12">
											...
											<input type="hidden" id="_final_satalement" name="_final_satalement" value="0">
											...
											<div class="col-md-3" >
												...
												<input type="hidden" name="_table_id[]" class="form-control _table_id ">
												<input type="text" name="_selected_table_name" class="form-control _selected_table_name " readonly>
												<!-- <select multiple class="form-control _table_id " name="_table_id[]" >
											...
											<div class="col-md-3" >
												<small>Delivery Company</small><br/>
												
												 <select  class="form-control delivery_company_id " name="delivery_company_id" >
													
													@forelse(delivery_company() as $key=>$val)
													<option value="{{$key}}">{{$val ?? ''}}</option>
													@empty
													@endforelse
												</select> 
											...
											<div class="col-md-3" >
												...
												<select  class="form-control _served_by_ids select2" name="_served_by_ids[]" >
                            ...
                            <div class="search_box_main_ledger" style="margin-top: 40px;"> </div>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<div class="col-sm-12" style="overflow-y: auto;height: 46vh;margin-top: -20px;">
								...
								style="
									...
									<div class="row" >
										...
										<div class="col-md-12">
												<div class="form-group">
													<label for="_line_total_discount" class="col-sm-6 control-label">Sub Total :</label>
													<div class="col-sm-6 text-right">
														 <span style="font-size: 24px;" class="tot_amt text-bold"></span>
													</div>
												</div>
											</div>
										<div class="col-md-12 display_none">
											...
											<div class="col-md-2 display_none" >
												<div class="form-group">
													...
													<div class="col-sm-5">
														<input  type="text" class="form-control text-right" id="other_charges" name="_other_charge" placeholder="0.00" value=""> <span id="other_charges_msg" style="" class="text-danger"></span> </div>
												</div>
											</div>
											<div class="col-md-12" >
												<div class="form-group">
													<label for="_service_charge_rate" class="col-sm-6 control-label">Service Charge Rate
														<label class="text-danger">*</label>
													</label>
													<div class="col-sm-6 text-right">
														<input  type="text" class="form-control text-right _service_charge_rate" id="_service_charge_rate" name="_service_charge_rate" placeholder="0.00" value=""> 
												</div>
											</div>
											</div>
											<div class="col-md-12" >
												<div class="form-group">
													<label for="_service_charge" class="col-sm-6 control-label">Service Charge
														<label class="text-danger">*</label>
													</label>
													<div class="col-sm-6 text-right">
														<input  type="text" class="form-control text-right" id="_service_charge" name="_service_charge" placeholder="0.00" value=""> <span id="_service_charge_msg" style="display:none" class="text-danger"></span> </div>
												</div>
											</div>
											<div class="col-md-2 display_none" >
												<div class="form-group">
													...
													<div class="col-sm-5">
														<input  type="text" class="form-control text-right" id="_delivery_charge" name="_delivery_charge" placeholder="0.00" value=""> <span id="_delivery_charge_msg" style="" class="text-danger"></span> </div>
												</div>
											</div>
											<div class="col-md-12" >
												<div class="form-group">
													...
													<div class="col-sm-6 text-right">
														<input  type="text" name="__total_discount" class="__total_discount form-control text-right" id="__total_discount" placeholder="Discount" value="0">
													</div>
												</div>
											</div>
										...
										<div class="col-md-3 text-right display_none">
											...
											<br> TK <span style="font-size: 19px;" ></span>
										</div>
									</div>
									<div class="row" >
    ...
    padding-bottom: 5px;">
											...
											<div class="col-sm-2">
												<button type="button" id="" name="" class="btn btn-primary btn-block btn-flat btn-lg show_payments_modal" title="Multiple Payments [Ctrl+M]"> <i class="fa fa-credit-card" aria-hidden="true"></i> Final Settlement </button>
											</div>
											<!-- <div class="col-sm-3">
											...
											<div class="col-sm-2 text-left">
													...
													<div>
													<b>Net Payable:TK. <span style="font-size: 30px;" class="tot_grand" id="tot_grand"></span></b>
												</div>
												
											</div>
											<div class="col-sm-1 text-left" >
												<button type="button"  class="btn bg-yellow btn-block btn-flat btn-lg recent_invoice_list" data-toggle="modal" data-target="#salesListModal">   Online  </button>
											...
											<div class="col-sm-1">
												...
												<button type="button"  class="btn bg-green btn-block btn-flat btn-lg tableInormationModal" >  Table </button>
											...
											<div class="col-sm-2 text-left"  >
												...
												<a target="__blank" class="btn bg-danger btn-block btn-flat btn-lg " href="{{url('kitchen')}}" title="View Items List"><i class="fa  fa-cubes  "></i> <span style="font-weight:bold;">Kitchen </span>
												</a>
				          					   @endcan
											...
											<div class="col-sm-2 " >
												<a target="__blank" class="btn bg-danger btn-block btn-flat btn-lg " href="{{url('home')}}" title="Dashboard"><i class="fa  fa-list  "></i> <span style="font-weight:bold;">Dashboard </span>
												</a>
								...
								<div class="row">
									<div class="col-md-4" >
										...
										<div class="category_area row" style="border-right: 2px solid #fff;border-left: 2px solid #fff;margin-top: 2px;overflow-y: scroll;min-height: 100px;height: 84vh;">
											@php
											$colorHexLighter = ["Tomato","Orange","DodgerBlue","skyblue","Blue","Violet"];
											  
											@endphp
												@forelse($categories as $category)
												<div class="col-md-12 " >
													<div style="font-size: 22px;font-weight: bold;color: #fff;background: {{$colorHexLighter[rand(1,5)]}}"  class="sub_category _single_item_area _single_item_area__{{$category->id}}"
									...
									<div class="col-md-12">
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<select class="form-control " id="popup_tax_type" name="popup_tax_type" style="width: 100%;" tabindex="-1" aria-hidden="true">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<select class="form-control " id="popup_tax_id" name="popup_tax_id" style="width: 100%;" tabindex="-1" aria-hidden="true">
								...
								@endforelse
															...
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<select class="form-control " id="item_discount_type" name="item_discount_type" style="width: 100%;" tabindex="-1" aria-hidden="true">
...
<script type="text/javascript">
		...
		<script>
		 ...
		 var _all_table_infomations =  <?php echo json_encode($tables) ?>;
		 var _booked_table_list = [];
		...
		function table_names(table_ids=""){
			...
			for (var i = 0; i < _table_infos.length; i++) {
				...
				for (var j = 0; j < table_id_array.length; j++) {
					if(_table_infos[i].id == table_id_array[j] && table_id_array[j] !=0){
		...
		function table_info_show(){
			_book_table_list_ajax()
			setTimeout(function(){
				console.log(_booked_table_list)
				
			var _all_table_html =`<div class="row">`;
			for(var i=0; i<_all_table_infomations.length; i++){
				
					_all_table_html +=`<div class="col-md-2"><h3 attr_table_id="${_all_table_infomations[i].id}"  class="free_table click_non_selected_table"`;
					 for(var j=0; j< _booked_table_list.length; j++){
					 		if(_booked_table_list[j]._table_id ==_all_table_infomations[i].id){
					 			_all_table_html +=`  style="background:red;"   attr_invoice_id="${_booked_table_list[j].id}" `;
					 		}
						 }

					 _all_table_html +=` >${_all_table_infomations[i]._name}</h3>
					</div>`;
			}
			 _all_table_html +=`<div class="col-md-2"><h3 style="background:red;"   class=" free_table OnlineOrderTable">On Line Order </h3></div></div>`;

			 $(document).find(".tableInformationDisplay").html(_all_table_html);


			$(document).find('#tableInormation').modal('toggle');
		...
		$(document).on("click",".tableInormationModal",function(){
			table_info_show();

		})

		$(document).on("click",".click_non_selected_table",function(){
			$("._sales_spot").val(1)
			var attr_table_id = $(this).attr("attr_table_id");
			var attr_invoice_id = $(this).attr("attr_invoice_id");
			attr_invoice_id = parseFloat(attr_invoice_id);
			if(isNaN(attr_invoice_id)){ attr_invoice_id=0 }
			if(attr_invoice_id==0){
				console.log("attr_invoice_id "+attr_invoice_id)
				console.log("attr_table_id "+attr_table_id)
				$(document).find("._table_id").val(attr_table_id);
				$(document).find("._selected_table_name").val(table_names(attr_table_id));
				$(document).find('#tableInormation').modal('toggle');

			}else{
				hold_invoice_edit(attr_invoice_id);
			}
		})
		$(document).on("click",".OnlineOrderTable",function(){
			var attr_table_id = $(this).attr("attr_table_id");
			var attr_invoice_id = $(this).attr("attr_invoice_id");
			attr_invoice_id = parseFloat(attr_invoice_id);
			if(isNaN(attr_invoice_id)){ attr_invoice_id=0 }
		...
		function _book_table_list_ajax(){
			$.ajax({
				type: "GET",
				url: "{{url('book_table_list_ajax')}}",
				async: false,
				success: function(response) {
					var data = JSON.parse(response);
					_booked_table_list = data;
				//	console.log(data)
		...
		$(document).on('change','._service_charge_rate',function(){
		...
		function default_service_charge(){
			...
			var tot_amt = $(".tot_amt").text();
			var _service_charge_rate = parseFloat($(document).find("._service_charge_rate").val());
			if(isNaN(_service_charge_rate)){_service_charge_rate=0}

			tot_amt = parseFloat(tot_amt);
			if(isNaN(tot_amt)){ tot_amt=0 };
			 on_invoice_service_charge = (tot_amt*_service_charge_rate)/100;
		...
		if(order_id !=""){
				$.ajax({
					...
					success: function(response) {
						...
						var _sales_spot = response._sales_spot;
						var delivery_company_id = response.delivery_company_id;
						...
						if(_main__table_idss !=""){
							...
							for (var i = 0; i < table_array.length; i++) {
								...
								$("._selected_table_name").val(table_names(table_array[i]))
							}
						}
						...
						$(document).find(".tot_disc").text(round_off(_total_discount));
						$(document).find(".tot_amt").text(round_off(tot_amt));
						//$(document).find(".tot_grand").text(round_off(_total));

 

						$(document).find('._table_id').val(table_s).change();
						$(document).find('._served_by_ids').val(_servers).change();
						$(document).find('._sales_spot').val(_sales_spot).change();
						$(document).find('.delivery_company_id').val(delivery_company_id).change();
...
$('#add_payment_row').click(function(e) {
	...
	function addrow(id,hold_invoice=false,hold_data="",row_index=0,barcode) {
		...
		var tax_value = parseFloat(hold_data._vat);
		...
		var quantity = '<div class="input-group input-group-sm"><span class="input-group-btn"><button onclick="decrement_qty(' + item_id + ',' + rowcount + ')" type="button" class="btn btn-default btn-flat"><i class="fa fa-minus text-danger"></i></button></span>';
			...
			var remove_btn = '<a class="text-red" style="cursor: pointer;font-size: 20px;" onclick="removerow(' + rowcount + ')" title="Delete Item?">X</a>';
		...
		function final_total() {
			...
			var line_discount_amount = parseFloat($("#__total_discount").val());
...
$('#hold_invoice').click(function (e) {
	...
	save(print=false,pay_all=false,reference_id,_f_status="sales");
		...
		function save(print = false, pay_all = false, _reference = "N/A", _f_status = "sales") {
			...
			var _final_satalement = $("#_final_satalement").val();
			var delivery_company_id = $(".delivery_company_id").val();
			var _sales_spot = $("._sales_spot").val();
			//console.log(_sales_spot)
...
const formattedDate = `${day}-${month}-${year}`;
			...
			data.append("_date", formattedDate);


			data.append("_master_sales_id", _master_sales_id);
			data.append("_sales_spot", _sales_spot);
			data.append("_final_satalement", _final_satalement);
			data.append("delivery_company_id", delivery_company_id);
			...
			var request = $.ajax({
				...
				request.done(function( response ) {
					...
					$(document).find("#tot_grand").text(0);
					$(document).find("#_service_charge").val(0);
					$(document).find("#_line_total_discount").val(0);
					$(document).find("#_line_vat_total").val(0);
					$(document).find("#other_charges").val(0);
					$(document).find("#_delivery_charge").val(0);
					$(document).find("#__total_discount").val(0);
					$(document).find(".tot_disc").text(0);
					$(document).find(".tot_amt").text(0);
