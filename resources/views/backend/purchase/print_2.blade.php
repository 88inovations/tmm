                                  ...
                                  <tr>
                                     ...
                                     @endphp
                                            <td class="  " style="word-break: break-all;vertical-align: text-top;">{!! $_item->_items->_name ?? '' !!}</td>
                                             <td class="text-left @if($form_settings->_show_barcode==0)  display_none @endif" >{!! $_item->_trans_unit->_name ?? $_item->_items->_units->_name !!}</td>
                                            ...
                                            <td class=" @if($form_settings->_show_model==0)  display_none @endif">
                                              {!!  $_item->_model ?? '' !!}
                                            </td>
