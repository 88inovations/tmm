     ...
     <div class="row">
      ...
      <div class="col-6 text-center">
       ...
       <div style="text-align: center;">
         <h3><img src="{{url('/')}}/{{$settings->logo}}" alt="{{$settings->name ?? '' }}" style="width: 120px;height: auto;"  > {{$settings->name ?? '' }}
       ...
       <table class="table table-striped _grid_table">
        <thead>
         <tr>
          ...
          <th class="text-left @if($form_settings->_show_barcode ==0) display_none @endif" style="width: 12%;">Barcode</th>
          <th class="text-left @if($form_settings->_show_model ==0) display_none @endif" style="width: 12%;">Model</th>
          <th class="text-right" style="width: 10%;">Qty</th>
          <th class="text-right" style="width: 10%;">Rate</th>
          <th class="text-right @if($form_settings->_inline_discount==0) display_none @endif" style="width: 10%;">Discount</th>
          <th class="text-right @if($form_settings->_show_vat==0) display_none @endif" style="width: 10%;">VAT</th>
        ...
        <tbody>
         ...
         @php
                                  ...
                                  <tr>
                                     ...
                                     @endphp
                                           <td class="  " style="word-break: break-all;vertical-align: text-top;">{!! $_item->_items->_name ?? '' !!}</td>
                                           <td class="text-left" >{!! $_item->_trans_unit->_name ?? $_item->_items->_units->_name !!}</td>
                                            <td class=" @if($form_settings->_show_barcode ==0) display_none @endif " style="word-break: break-all;vertical-align: text-top;"> @php
                                             ...
                                             <td class="text-left  @if($form_settings->_show_model ==0) display_none @endif" style="vertical-align: text-top;">{!! $_item->_model ?? '' !!}</td>
                                            ...
                                            <td class="text-right @if($form_settings->_inline_discount==0) display_none @endif " style="vertical-align: text-top;">{!! _report_amount($_item->_discount_amount ?? 0) !!}</td>
                                            <td class="text-right @if($form_settings->_show_vat==0) display_none @endif " style="vertical-align: text-top;">{!! _report_amount($_item->_vat_amount ?? 0) !!}</td>
                            ...
                            <tr>
                              ...
                              <td  class="text-right @if($form_settings->_show_model ==0) display_none @endif ">  </td>
                              <td></td>
                              <td class="text-right @if($form_settings->_inline_discount==0) display_none @endif"> <b>{{ _report_amount($_total_discount_amount ?? 0) }}</b> </td>
                              <td class="text-right @if($form_settings->_show_vat==0) display_none @endif"> <b>{{ _report_amount($_vat_total ?? 0) }}</b> </td>
