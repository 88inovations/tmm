		...
		<div class="col-md-2 col-sm-6 col-6">
			<div class="card text-center ">
			    	...
			    	<div class="card-footer text_blue text-bold">
			    		<h3>{{_report_amount($sales_orders[0]->number_of_rows ?? 0)}}</h3>
			    	</div>
			  </div>
		</div>
		<div class="col-md-2 col-sm-6 col-6">
			<div class="card text-center ">
			    	<div class="card-header"><h6>Sales Order ৳</h6></div>
			    	<div class="card-footer text_blue text-bold">
			    		<h3>{{_report_amount($sales_orders[0]->_total_amount ?? 0)}}</h3>
			    	</div>
			  </div>
		</div>
 ...
 ?>
		...
		<div class="col-md-2 col-sm-6 col-6">
			<div class="card text-center">
			    	...
			    	<div class="card-footer text_blue text-bold">
			    		<h3>{{_report_amount($sales[0]->number_of_rows ?? 0)}}</h3>
			    	</div>
			  </div>
		</div>
		<div class="col-md-2 col-sm-6 col-6">
			<div class="card text-center">
			    	<div class="card-header"><h6>Sales Invoice ৳</h6></div>
			    	<div class="card-footer text_blue text-bold">
			    		<h3>{{_report_amount($sales[0]->_total_amount ?? 0)}}</h3>
			    	</div>
			  </div>
		</div>
 ...
 ?>
		<div class="col-md-2 col-sm-6 col-6">
			<div class="card text-center">
			    	...
			    	<div class="card-footer text_blue text-bold">
			    		<h3>{{_report_amount($sales_returns[0]->number_of_rows ?? 0)}}</h3>
			    	</div>
			  </div>
		</div>
		<div class="col-md-2 col-sm-6 col-6">
			<div class="card text-center">
			    	<div class="card-header"><h6>Sales Return ৳</h6></div>
			    	<div class="card-footer text_blue text-bold">
			    		<h3>{{_report_amount($sales_returns[0]->_total_amount ?? 0)}}</h3>
			    	</div>
			  </div>
		</div>
@endcan

@can('dashboard_purchase_order')
 ...
 ?>
		...
		<div class="col-md-2 col-sm-6 col-6">
			<div class="card text-center">
			    	...
			    	<div class="card-footer text_blue text-bold">
			    		<h3>{{_report_amount($purchase_orders[0]->number_of_rows ?? 0)}}</h3>
			    	</div>
			  </div>
		</div>
		<div class="col-md-2 col-sm-6 col-6">
			<div class="card text-center">
			    	<div class="card-header"><h6>Purchase Order ৳</h6></div>
			    	<div class="card-footer text_blue text-bold">
			    		<h3>{{_report_amount($purchase_orders[0]->_total_amount ?? 0)}}</h3>
			    	</div>
			  </div>
		</div>
 ...
 ?>
		<div class="col-md-2 col-sm-6 col-6">
			<div class="card text-center">
			    	...
			    	<div class="card-footer text_blue text-bold">
			    		<h3>{{_report_amount($purchases[0]->number_of_rows ?? 0)}}</h3>
			    	</div>
			  </div>
		</div>
		<div class="col-md-2 col-sm-6 col-6">
			<div class="card text-center">
			    	<div class="card-header"><h6>Purchase ৳</h6></div>
			    	<div class="card-footer text_blue text-bold">
			    		<h3>{{_report_amount($purchases[0]->_total_amount ?? 0)}}</h3>
			    	</div>
			  </div>
		</div>
 ...
 ?>
		<div class="col-md-2 col-sm-6 col-6">
			<div class="card text-center">
			    	...
			    	<div class="card-footer text_blue text-bold">
			    		<h3>{{_report_amount($purchase_returns[0]->number_of_rows ?? 0)}}</h3>
			    	</div>
			  </div>
		</div>
		<div class="col-md-2 col-sm-6 col-6">
			<div class="card text-center">
			    	<div class="card-header"><h6>Purchase Return ৳</h6></div>
			    	<div class="card-footer text_blue text-bold">
			    		<h3>{{_report_amount($purchase_returns[0]->_total_amount ?? 0)}}</h3>
			    	</div>
			  </div>
		</div>
@endcan
 ...
 ?>
		...
		<div class="col-md-2 col-sm-6 col-6">
			<div class="card text-center">
			    	...
			    	<div class="card-footer text_blue text-bold">
			    		<h3>{{_report_amount($collections[0]->number_of_rows ?? 0)}}</h3>
			    	</div>
			  </div>
		</div>
		<div class="col-md-2 col-sm-6 col-6">
			<div class="card text-center">
			    	<div class="card-header"><h6>Collection ৳</h6></div>
			    	<div class="card-footer text_blue text-bold">
			    		<h3>{{_report_amount($collections[0]->_total_amount ?? 0)}}</h3>
			    	</div>
			  </div>
		</div>
 ...
 ?>
		...
		<div class="col-md-2 col-sm-6 col-6">
			<div class="card text-center">
			    	...
			    	<div class="card-footer text_blue text-bold">
			    		<h3>{{_report_amount($payments[0]->number_of_rows ?? 0)}}</h3>
			    	</div>
			  </div>
		</div>
		<div class="col-md-2 col-sm-6 col-6">
			<div class="card text-center">
			    	<div class="card-header"><h6>Payment ৳</h6></div>
			    	<div class="card-footer text_blue text-bold">
			    		<h3>{{_report_amount($payments[0]->_total_amount ?? 0)}}</h3>
			    	</div>
			  </div>
		</div>
@endcan
@can('outstanding_detail_report')
		<div class="col-md-2">
			<div class="card text-center">
			    	...
			    	<div class="card-footer text_blue text-bold">
			    		<a target="__blank" class="btn btn-sm btn-info" href="{{url('outstanding_detail_report')}}">{{__('label.outstanding_detail_report')}}</a>
			    	</div>
			  </div>
		</div>
		@endcan
			...
			<div class="card text-left">
			    	...
			    	<div class="card-footer  text-bold">
			    		<table class="table table-striped">
			    			@if(sizeof($cash_possitions) > 0)
							@php
							$cash_total =0;
							@endphp
			    				@forelse($cash_possitions as $cash_possitions)
								@php
								$cash_total +=$cash_possitions->_total_amount ?? 0;
								@endphp
			    				<tr>
			    					<td>{!! $cash_possitions->_name ?? '' !!}</td>
			    					<td class="text-right">{!! _show_amount_dr_cr(_report_amount($cash_possitions->_total_amount ?? 0)) !!}</td>
			    				</tr>
			    				@empty
			    				@endforelse
			    			...
			    			<tr>
			    				...
			    				<th class="text_blue text-right">{!! _show_amount_dr_cr(_report_amount($cash_total ?? 0)) !!}</th>
			    			</tr>
