...
@endif
   ...
   <table class="cewReportTable">
          ...
          <tr>
            ...
            <th style="width: 5%;">{{__('label._date')}}</th>
            <th style="width: 10%;">Type</th>
            <th style="width: 10%;">Invoice No.</th>
            <th style="width: 5%;">{{__('label._code')}}</th>
            <th style="width: 5%;">{{__('label._ledger_id')}}</th>
            <th style="width: 5%;">{{__('label._phone')}}</th>
            <th style="width: 5%;">{{__('label._address')}}</th>
            <th style="width: 5%;">Sales Amount</th>
            <th style="width: 5%;">Return Amount</th>
...
@endphp
        ...
        <tr>
            ...
            <td style="width: 5%;white-space: nowrap;">{{  _view_date_formate($data->_date ?? '') }}</td>
            <td style="width: 10%;">{{ $data->_type ?? '' }}</td>
            <td style="width: 10%;white-space: nowrap;">{{ $data->_order_number ?? '' }}</td>
