                      ...
                      <div class="form-group row">
                             ...
                             <div class="col-xs-12 col-sm-12 col-md-6">
                               <select type_base_group="{{url('type_base_group')}}" class="form-control _account_head_id " name="_account_head_id" required>
                                  ...
                                  <option value="{{$account_type->id}}"  @if(old('_account_head_id') == $account_type->id) selected @endif  @if($account_type->_has_child==1) disabled @endif >{{ $account_type->id ?? '' }}-{{ $account_type->_name ?? '' }}</option>

                                  @php
                                  $_child_groups = $account_type->_child_group ?? [];
                                  @endphp
                                  @forelse($_child_groups as $group)
                                        <option value="{{$group->id}}"  @if(old('_account_head_id') == $group->id) selected @endif   > &nbsp; &nbsp; &nbsp; &nbsp;{{ $group->id ?? '' }}-{{ $group->_name ?? '' }}</option>
                                  @empty
                                  @endforelse
                        ...
                        @php
                         ...
                         <div class="form-group row  @if(sizeof($permited_costcenters)==1) display_none @endif">
