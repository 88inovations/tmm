                 ...
                 @php 
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-10 ">
                      <select class="form-control  _branch_id" name="_branch_id">
                          <option value="">{{__('label._branch_id')}}</option>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      ...
                      <input type="hidden" name="_type" class="form-control" placeholder="Exp:1,2,3,4" value="@if(isset($request->_type)) {{$request->_type ?? 'honorarium'}}  @endif">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    <label for="_status" class="col-sm-2 col-form-label">{{__('label._status')}}:</label>
                    <div class="col-sm-10">
                      @php
 ...
 <button type="button" class="btn btn-info  btn-sm mr-2 display_none" data-toggle="modal" data-target="#exampleModal">
  Excel File Upload
                                    ...
                                    <button type="button" class="btn btn-sm btn-warning mr-3" data-toggle="modal" data-target="#modal-default" title="Advance Search"><i class="fa fa-search mr-2"></i> </button>
                                     <a href="{{url('customer_list')}}" class="btn btn-sm btn-danger" title="Search Reset"><i class="fa fa-retweet mr-2"></i> </a>
                                     </div>
                                </div>
                          </div>
