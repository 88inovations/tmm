    ...
    <div class="content">
      <div class="container-fluid">
                                ...
                                <div class="table-responsive">
                                  ...
                                  @endphp
                                            <tr class="_purchase_row">
                                              ...
                                              <td >
                                                <input type="hidden" class="form-control _base_unit_id width_100_px" name="_base_unit_id[]" value="{!! $input_d->_base_unit !!}" />
                                                <input type="text" class="form-control _main_unit_val width_100_px" readonly name="_main_unit_val[]" value="{!! $input_d->_input_item->_units->_name ?? '' !!}" />
                                              </td>
                                              <td >
                                                <input type="text" name="conversion_qty[]"  class="form-control conversion_qty " value="{!! $input_d->_unit_conversion ?? 1 !!}" readonly>
                                                <input type="hidden" name="_base_rate[]" class="form-control _base_rate _common_keyup" value="{!! $input_d->_base_rate ?? 0 !!}" >
                                              </td>
                                              <td class="">
                                                <select class="form-control _transection_unit" name="_transection_unit[]">
                                                  @forelse($input_d->_input_item->unit_conversion as $conversion_units )
                                                    <option 
        ...
        attr_item_id="{{$conversion_units->_item_id}}"
                                                    ...
                                                    @if($conversion_units->_conversion_unit==$input_d->_transection_unit) selected @endif >{!! $conversion_units->_conversion_unit_name ?? '' !!}</option>
                                                  @empty
                                                  @endforelse
                                                </select>
                                              </td>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 mb-10">
                          <table class="table" style="border-collapse: collapse;margin: 0px auto;">
                            ...
                            <tr class="">
                              ...
                              <td style="border:0px;width: 80%;">
                                <input type="text" name="_sales_price" class="form-control width_200_px" id="_sales_price"  value="{{$data->_sales_price ?? 0}}">
                              </td>
                            </tr>
                            ...
                            <tr class="">
                              ...
                              <td style="border:0px;width: 80%;">
                                <input type="text" name="_gp_amount" class="form-control width_200_px" id="_gp_amount"  value="{{$data->_gp_amount ?? 0}}">
                              </td>
                            </tr>
                            <tr class="">
                              <td style="border:0px;width: 20%;"><label for="_gp_per">GP%</label></td>
                              <td style="border:0px;width: 80%;">
                                <input type="text" name="_gp_per" class="form-control width_200_px" id="_gp_per"  value="{{$data->_gp_per ?? 0}}">
                              </td>
                            </tr>
