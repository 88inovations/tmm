        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
               <form action="{{route('musak-four-point-three.store')}}" method="POST" class="purchase_form" >
                @csrf
                       ...
                       <div class="col-xs-12 col-sm-12 col-md-3 ">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 ">
                         ...
                         <div class="col-xs-12 col-sm-12 col-md-3 ">
                            ...
                            <input type="text" id="_search_main_ledger_id" name="_search_main_ledger_id" class="form-control _search_main_ledger_id" value="{{old('_search_main_ledger_id')}}" placeholder="Responsible Person" required>

                            <input type="hidden" id="_main_ledger_id" name="_responsible_person" class="form-control _main_ledger_id" value="{{old('_responsible_person')}}" placeholder="Supplier" required>
                                      ...
                                      <table class="table table-bordered" >
                                          ...
                                          <tbody class="area__purchase_details" id="area__purchase_details">
                                            <tr class="_purchase_row">
                                              ...
                                              <td>
                                                <input type="number" min="0" step="any" name="_rate[]" class="form-control _rate _common_keyup" >
                                              </td>
                                              <td>
                                          ...
                                          <tfoot>
                                            <tr>
                                              ...
                                              <td></td>
                                              <td>
                                                <input type="number" min="0" step="any" step="any" min="0" name="_total_value_amount" class="form-control _total_value_amount" value="0" readonly required>
                                              </td>
                                              <td>
                                                <input type="number" min="0" step="any" step="any" min="0" name="_total_wastage_amt" class="form-control _total_wastage_amt" value="0" readonly required>
                                              </td>
                                              <td colspan="2"></td>
                                      ...
                                      <table class="table table-bordered" >
                                          ...
                                          <tbody class="area__voucher_details form_body" id="area__voucher_details">
                                            <tr class="_voucher_row">
                                              ...
                                              <td>
                                                <input type="number" min="0" step="any" name="_amount[]" class="form-control  _amount" placeholder="Amount" value="{{old('_amount',0)}}">
                                              </td>
                                              <td class="">
                                          ...
                                          <tfoot>
                                            <tr>
                                              ...
                                              <td>
                                                <input type="number" min="0" step="any" step="any" min="0" name="_total_amount" class="form-control _total_amount" value="0" readonly required>
                                              </td>
                                              <td></td>
                                            </tr>
                                          </tfoot>
                          ...
                          <table class="table" style="border-collapse: collapse;margin: 0px auto;">
                            ...
                            <tr>
                              ...
                              <td style="border:0px;width: 80%;">
                                <input type="text" name="_cost_price" class="form-control width_200_px" id="_cost_price" readonly value="0">
                              </td>
                            </tr>
                            ...
                            <tr class="">
                              ...
                              <td style="border:0px;width: 80%;">
                                <input type="text" name="_sales_price" class="form-control width_200_px" id="_sales_price"  value="0">
                              </td>
                            </tr>
                            <tr class="">
                              <td style="border:0px;width: 20%;"><label for="_gp_amount">GP</label></td>
                              <td style="border:0px;width: 80%;">
                                <input type="text" name="_gp_amount" class="form-control width_200_px" id="_gp_amount"  value="0">
                              </td>
                            </tr>
                            <tr class="">
                              <td style="border:0px;width: 20%;"><label for="_gp_per">GP%</label></td>
                              <td style="border:0px;width: 80%;">
                                <input type="text" name="_gp_per" class="form-control width_200_px" id="_gp_per"  value="0">
                              </td>
                            </tr>
...
$(document).on('keyup','._wastage_amt',function(){
  ...
  if(isNaN(_value)){_value=0}
    var _wastage_rate  = parseFloat((_wastage_amt/_value)*100).toFixed(after_desimal);
...
//    if(isNaN(_wastage_rate)){ _wastage_rate   = 0 }
//    if(isNaN(conversion_qty)){ conversion_qty   = 1 }
//     var converted_qty = (( conversion_qty/1)*_qty);

//    if(isNaN(_qty)){ _qty   = 0 }
//    if(isNaN(_rate)){ _rate =0 }
//    var _value = parseFloat(converted_qty*_rate).toFixed(after_desimal);
