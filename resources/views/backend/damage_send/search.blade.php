                        ...
                        <div class="row">
                          <div class="col-md-12 d-flex">
                            ...
                            <div class="form-group ml-2">
                                @can('damage_send-create')
                             
                                    <a title="Add New" class="btn btn-info btn-sm mr-1" href="{{ route('damage_send.create') }}"><i class="nav-icon fas fa-plus"></i> Create New </a>
                                  @endcan
                              </div>
                              ...
                              <div class="form-group ml-2">
                                    <button type="button" class="btn btn-sm btn-warning mr-3" data-toggle="modal" data-target="#modal-default" title="Advance Search"><i class="fa fa-search mr-2"></i> </button>
                                     <a href="{{url('damage_send-reset')}}" class="btn btn-sm btn-danger" title="Search Reset"><i class="fa fa-retweet mr-2"></i> </a>
                              </div>
