            ...
            <div class="card">
              <div class="card-header border-0 mt-1">
                <div class="row">
                   ...
                   @endphp
                    <div class="col-md-6">
                       @include('backend.damage_send.search')
                    </div>
                    <div class="col-md-6">
                      <div class="d-flex flex-row justify-content-end">
                         @can('damage_send-print')
...
<td style="display: flex;">
                                ...
                                <a  
                                  href="{{url('damage_send/print')}}/{{$data->id}}"
                                  class="btn btn-sm btn-default  mr-1"><i class="fa fa-eye"></i></a>


                                  @can('damage_send-edit')
                                  
                                  <a  href="{{ route('damage_send.edit',$data->id) }}" 
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                     <a class="dropdown-item " href="{{url('damage_send/print')}}/{{$data->id}}" >
                                         View & Print
                                      </a>
...
$(document).on("click","._single_data_click",function(){
      ...
      if(has_class){return false; }
        ...
        $.ajax({
           type:'POST',
           url:"{{ url('damage_send-wise-detail') }}",
...
//   })
  ...
  $(document).on("click","._invoice_lock",function(){
    ...
    var _table_name ="damage_send_masters";
   if($(this).is(':checked')){
