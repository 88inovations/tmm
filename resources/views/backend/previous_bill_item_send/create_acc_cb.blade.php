                                      ...
                                      <table class="table table-bordered" >
                                          ...
                                          <tbody class="area__voucher_details form_body" id="area__voucher_details">
                                            <tr class="_voucher_row">
                                              ...
                                              <td>
                                                @php
                                                $_default_cash_account = $form_settings->_default_cash_account ?? 0;
                                                $_show_default_cash = $form_settings->_show_default_cash ?? 0;

                                                @endphp
                                                <input type="text" name="_search_ledger_id[]" class="form-control _search_ledger_id width_280_px"
                                                @if($_show_default_cash ==1)
                                                 value="{{_find_ledger($_default_cash_account)}}"
                                                @endif
                                                  placeholder="Ledger" @if($__user->_ac_type==1) attr_account_head_no="{{_cash_bank_type_id()}}" @endif   >

                                                <input type="hidden"
                                                 @if($_show_default_cash ==1)
                                                 value="{{$_default_cash_account}}"
                                                   @endif
                                              ...
                                              <td>
                                                <input type="number" name="_dr_amount[]" class="form-control  _dr_amount first_dr_amount" placeholder="Dr. Amount" value="{{old('_dr_amount',0)}}">
                                              </td>
