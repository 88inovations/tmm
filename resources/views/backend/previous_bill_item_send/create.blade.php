          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
               ...
               @endif
               <form action="{{route('previous_bill_item_send.store')}}" method="POST" class="purchase_form" >
                @csrf
                    <div class="row">
 ...
 //console.log("this row id "+row_id)
  ...
  //First check added this row is available yes or not if yes then increase the item qty amount or create new row
      ...
      if(_has_item_row ==true){
        ...
        _add_new_row_for_barcode(_warranty,row_id,_name,_p_item_item_id,_unit_id,_barcode,_manufacture_date,_expire_date,_sales_rate,_qty,_pur_rate,_sales_discount,_sales_vat,_purchase_detail_id,_master_id,_branch_id,_cost_center_id,_store_id,_store_salves_id,_sales_vat,_discount_amount,_vat_amount,_value,_item_code,_pack_name,_attr__p_item_qty);
        _purchase_total_calculation();
      }
}
...
function _add_new_row_for_barcode(_warranty,row_id,_name,_p_item_item_id,_unit_id,_barcode,_manufacture_date,_expire_date,_sales_rate,_qty,_pur_rate,_sales_discount,_sales_vat,_purchase_detail_id,_master_id,_branch_id,_cost_center_id,_store_id,_store_salves_id,_sales_vat,_discount_amount,_vat_amount,_value,_item_code,_pack_name,_attr__p_item_qty){
