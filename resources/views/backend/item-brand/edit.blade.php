          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">
                 <a class="btn btn-primary" href="{{ route('item-brand.index') }}"> <i class="fa fa-th-list" aria-hidden="true"></i></a>
               </li>
               @endcan
            </ol>
          </div><!-- /.col -->
          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
                     ...
                     {!! Form::model($data, ['method' => 'PATCH','route' => ['item-brand.update', $data->id]]) !!}
                    @csrf
                    <div class="row">
