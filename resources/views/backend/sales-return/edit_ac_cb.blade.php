                                      ...
                                      <table class="table table-bordered" >
                                          ...
                                          <tbody class="area__voucher_details form_body" id="area__voucher_details">
                                            ...
                                            <tr class="_voucher_row">
                                              ...
                                              <td>
                                                <input type="text" name="_search_ledger_id[]" class="form-control _search_ledger_id width_280_px" placeholder="Ledger" value="{{ $_s_acc->_ledger->_name ?? '' }}" @if($__user->_ac_type==1) attr_account_head_no="{{_cash_bank_type_id()}}" @endif > 
