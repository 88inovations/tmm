      ...
      if(data.length > 0 ){
            search_html +=`<div class="card"><table table-bordered style="width: 100%;">
                            <thead>
                              ...
                              <th style="border:1px solid #ccc;text-align:center;">Sales Invoice</th>
                        ...
                        for (var i = 0; i < data.length; i++) {
                         ...
                         search_html += `<tr class="search_row_purchase_order" >
                                        ...
                                        <input type="hidden" name="_order_number_main_ledger" class="_order_number_main_ledger" value="${data[i]?._order_number}">
...
$(document).on("click",'.search_row_purchase_order',function(){
    ...
    var _order_number_main_ledger = $(this).find('._order_number_main_ledger').val();
    ...
    $("._search_order_ref_id").val(_order_number_main_ledger);
