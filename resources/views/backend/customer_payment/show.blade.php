          ...
          <div class="col-lg-12">
            <div class="card">
             <div class="card-header">
                <div class="row">
                  <div class="col-md-6">
                     <h4><a  href="{{ route('customer_payment.index') }}"> {!! $page_name ?? '' !!} </a>  
                  ...
                  <div class="col-md-6">
                   <div class="d-flex right" style="float: right;">
                      ...
                      @can('customer_payment_edit')
                                    <a title="Edit" class="btn  btn-default  mr-3" href="{{ route('customer_payment.edit',$data->id) }}">
                      ...
                      @can('customer_payment_list')
                       <a class="btn btn-sm btn-primary" title="List" href="{{ route('customer_payment.index') }}"> <i class="nav-icon fa fa-th-list" aria-hidden="true"></i></a>
                       @endcan
                    </div>
