          ...
          <div class=" col-sm-4 ">
            <ol class="breadcrumb float-sm-right">
             ...
             <li class="breadcrumb-item active">
               ...
               @endcan
              <li class="breadcrumb-item active">
                 <a class="btn btn-sm btn-default" title="List" href="{{ route('customer_payment.index') }}">{{$page_name}}</a>
               </li>
            </ol>
          </div>
        </div><!-- /.row -->
                    ...
                    <div class="row">
                       ...
                       <div class="col-xs-12 col-sm-12 col-md-2">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 ">
                            ...
                            <input type="text" id="_search_main_ledger_id" name="_search_main_ledger_id" class="form-control _search_main_ledger_id" value="" placeholder="Customer" required>
