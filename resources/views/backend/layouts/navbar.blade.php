 ...
 @endcan
      ...
      <li class="nav-item dropdown remove_from_header ">
       ...
       @can('hrm-attandance-list')
        <div style="display: flex;">
         <a href="{{url('data-migration')}}" class="dropdown-item">
            <i class="fa fa-fax mr-2" aria-hidden="true"></i> {{ __('Data Migrations') }}
          </a>
        ...
        @endcan
       @can('employee_duty-list')
        <div style="display: flex;">
         <a href="{{url('employee_duty')}}" class="dropdown-item">
            <i class="fa fa-fax mr-2" aria-hidden="true"></i> {{ __('label.employee_duty') }}
          </a>
      ...
      <li class="nav-item dropdown remove_from_header">
        ...
        <div style="display: flex;">
           <a href="{{url('partical_production_receive_list')}}" class="dropdown-item">
            <i class="fa fa-recycle mr-2" aria-hidden="true"></i> {{ __('label.finished_goods_receive_to_stock') }}
          </a>
        ...
        <div style="display: flex;">
           ...
           <a  href="{{ route('direct-sales.create') }}" 
          class="dropdown-item text-right  " > 
            <i class="nav-icon fas fa-plus"></i> </a>
        ...
        <div style="display: flex;">
           <a href="{{url('sales_without_stock_deduct')}}" class="dropdown-item">
            <i class="fa fa-shopping-cart mr-2" aria-hidden="true"></i> {{ __('label.sales_without_stock_deduct') }}
          </a>
           <a  href="{{ route('sales_without_stock_deduct.create') }}" 
          class="dropdown-item text-right  " > 
            <i class="nav-icon fas fa-plus"></i> </a>
        ...
        <div style="display: flex;">
           <a href="{{url('previous_bill_item_send')}}" class="dropdown-item">
            <i class="fa fa-shopping-cart mr-2" aria-hidden="true"></i> {{ __('label.previous_bill_item_send') }}
          </a>
           <a  href="{{ route('previous_bill_item_send.create') }}" 
          class="dropdown-item text-right  " > 
            <i class="nav-icon fas fa-plus"></i> </a>
 ...
 @can('sales_return_wlm-list')
        ...
        <div style="display: flex;">
           <a href="{{url('sales_return_wlm')}}" class="dropdown-item">
            <i class="fa fa-shopping-cart mr-2" aria-hidden="true"></i> {{ __('label.sales_return_wlm') }}
          </a>
...
@can('security_deposits-list')
        ...
        <div style="display: flex;">
           <a href="{{url('security_deposits')}}" class="dropdown-item">
            <i class="fa fa-shopping-cart mr-2" aria-hidden="true"></i> {{ __('label.security_deposits') }}
          </a>
       ...
       @can('avaiable_product_list')
        ...
        <div style="display: flex;">
           <a href="{{url('product_show')}}" class="dropdown-item">
            <i class="fa fa-shopping-cart mr-2" aria-hidden="true"></i> {{__('label.avaiable_product_list')}}
          </a>
       ...
       @can('previous_sales_return-list')
        ...
        <div style="display: flex;">
           <a href="{{url('previous_sales_return')}}" class="dropdown-item">
            <i class="fa fa-shopping-cart mr-2" aria-hidden="true"></i> {{ __('label.previous_sales_return') }}
          </a>
   ...
   <li class="nav-item remove_from_header">
     ...
     @can('inventory-menu') 
      <li class="nav-item dropdown remove_from_header">
        ...
        <div style="display: flex;">
          <a href="{{url('group_wise_list?_type=cash')}}" class="dropdown-item">
            <i class="fa fa-fax mr-2" aria-hidden="true"></i> {{ __('label._cash_group') }}
          </a>
          
           <a  href="{{route('group_wise_create')}}?_type=cash" class="dropdown-item text-right "  >
            <i class="nav-icon fas fa-plus"></i>
          </a>
        </div>
        ...
        <div style="display: flex;">
          <a href="{{url('group_wise_list?_type=bank')}}" class="dropdown-item">
            <i class="fa fa-fax mr-2" aria-hidden="true"></i> {{ __('label._bank_groups') }}
          </a>
          
           <a  href="{{route('group_wise_create')}}?_type=bank" class="dropdown-item text-right "  >
            <i class="nav-icon fas fa-plus"></i>
          </a>
        </div>
        ...
        <div style="display: flex;">
          <a href="{{url('group_wise_list?_type=supplier')}}" class="dropdown-item">
            <i class="fa fa-fax mr-2" aria-hidden="true"></i> {{ __('label._supplier_group') }}
          </a>
          
           <a  href="{{route('group_wise_create')}}?_type=supplier" class="dropdown-item text-right "  >
            <i class="nav-icon fas fa-plus"></i>
          </a>
        </div>
        ...
        <div style="display: flex;">
          <a href="{{url('group_wise_list?_type=employee')}}" class="dropdown-item">
            <i class="fa fa-fax mr-2" aria-hidden="true"></i> {{ __('label._employee_group') }}
          </a>
          
           <a  href="{{route('group_wise_create')}}?_type=employee" class="dropdown-item text-right "  >
            <i class="nav-icon fas fa-plus"></i>
          </a>
        </div>
        ...
        <div style="display: flex;">
          <a href="{{url('group_wise_list?_type=honorarium')}}" class="dropdown-item">
            <i class="fa fa-fax mr-2" aria-hidden="true"></i> {{ __('label._honorarium_group') }}
          </a>
          
           <a  href="{{route('group_wise_create')}}?_type=honorarium" class="dropdown-item text-right "  >
            <i class="nav-icon fas fa-plus"></i>
          </a>
        </div>
         ...
         @endcan
          ...
          <div class="dropdown-divider"></div>
              <div style="display: flex;">
                ...
                <a  class="dropdown-item text-right "  href="{{route('item-brand.create')}}" ><i class="nav-icon fas fa-plus"></i></a>
              </div>
         ...
         @endcan
          ...
          <div class="dropdown-divider"></div>
              <div style="display: flex;">
                ...
                <a  class="dropdown-item text-right "  href="{{route('pack-size.create')}}" ><i class="nav-icon fas fa-plus"></i></a>
              </div>
        ...
        @can('lot-item-information')
         <div class="dropdown-divider"></div>
        <div style="display: flex;">
           <a href="{{url('cylinder_product')}}" class="dropdown-item">
            <i class="fa fa-list-alt mr-2" aria-hidden="true"></i>{{ __('label.cylinder_product') }}
          </a>
    ...
    @endcan
      ...
      <li class="nav-item dropdown remove_from_header">
        ...
        @can('countries_list')
         <div class="dropdown-divider"></div>
        <div style="display: flex;">
          <a href="{{url('countries')}}" class="dropdown-item">
            <i class="fas fa-store   mr-2"></i>{{ __('label.countries') }}
          </a>
