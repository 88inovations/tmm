          ...
          <div class="col-sm-12" style="display: flex;">
            ...
            <ol class="breadcrumb float-sm-right ml-2">
              ...
              <li class="breadcrumb-item active">
                  <a title="Add New" class="btn btn-info btn-sm" href="{{ route('sales_without_stock_deduct.create') }}"> Add New </a>
               </li>
              @endcan
            ...
            <div class="card">
              <div class="card-header border-0 mt-1">
                <div class="row">
                   ...
                   @endphp
                    <div class="col-md-4">
                       @include('backend.sales_without_stock_deduct.search')
                    </div>
                    <div class="col-md-8">
                          ...
                          <td style="display: flex;">
                              <div class="dropdown mr-1">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                     ...
                                     @can('sales-edit')
                                        <a class="dropdown-item " href="{{ route('sales_without_stock_deduct.edit',$data->id) }}" >
                                          Edit
                                        </a>
                                    @endcan
                                    ...
                                    @endcan
                                      ...
                                      @can('sales-delete')
                                    <a class="dropdown-item  mr-1" onclick="return confirm('Are you Sure?')" href="{{ url('sales_without_stock_deduct_delete') }}/{{$data->id}}">
                                      Delete
                                    </a>
                                     @endcan
