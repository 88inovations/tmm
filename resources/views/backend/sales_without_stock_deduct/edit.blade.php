...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class=" col-sm-6 ">
            <a class="m-0 _page_name" href="{{ route('sales_without_stock_deduct.index') }}">{!! $page_name ?? '' !!} </a>
          </div><!-- /.col -->
          <div class=" col-sm-6 ">
            <ol class="breadcrumb float-sm-right">
             ...
             <li class="breadcrumb-item ">
              ...
              @endcan
               @can('sales-create')
              <li class="breadcrumb-item ">
                        <a title="Add New" class="btn btn-success btn-sm" href="{{ route('sales_without_stock_deduct.create') }}"> <i class="nav-icon fas fa-plus"></i> </a>
               </li>
              @endcan
              <li class="breadcrumb-item ">
                 <a class="btn btn-sm btn-success" title="List" href="{{ route('sales_without_stock_deduct.index') }}"> <i class="nav-icon fas fa-list"></i> </a>
               </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
               <form action="{{url('sales_without_stock_deduct/update')}}" method="POST" class="purchase_form" >
                @csrf
                      <div class="row">
                       ...
                       <div class="col-xs-12 col-sm-12 col-md-2">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 ">
                            <div class="form-group">
                              ...
                              <select class="form-control  _store_id" name="_store_id">
                                  ...
                                  <option value="{{$store->id}}" @if($data->_store_id==$store->id) selected @endif >{{$store->_name ?? '' }}</option>
                                  @empty
                                  @endforelse
                                </select>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 ">
                            <div class="form-group">
                              ...
                              <input type="text" id="_order_ref_id_code" name="_order_ref_id_code" class="form-control _order_ref_id_code" value="{{old('_order_ref_id_code',id_to_cloumn($data->_order_ref_id,'_order_number','sales_orders'))}}" placeholder="Sales Order" readonly>
                            ...
                            <div class="form-group">
                              ...
                              <select class="form-control _sales_man" name="_sales_man_id">
                                <option value=""><----{{__('label._sales_man_id')}}----></option>
                                    ...
                                    <option value="{{$person->id}}" @if($person->id ==$data->_sales_man_id) selected @endif >{{ $person->_code ?? '' }}- {{ $person->_name ?? '' }}</option>
                                    @empty
                                    @endforelse
                              </select>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 @if($_show_payment_terms==0) display_none @endif ">
                            <div class="form-group">
                              ...
                              <select class="form-control _payment_terms" name="_payment_terms" id="_payment_terms">
                                ...
                                <option value="{{$terms->id}}" attr_date_number="{{ $terms->_days ?? 1 }}"  @if($data->_payment_terms==$terms->id) selected @endif >{{ $terms->_name ?? '' }}</option>
                                @empty
                                @endforelse
                              </select>
                            </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2  @if($_referance==0) display_none @endif">
                            <div class="form-group">
                              <label class="mr-2" for="_referance">{{__('label._referance')}}:</label>
                              <input  type="text" id="_referance" name="_referance" class="form-control _referance" value="{{$data->_referance ?? ''}}" placeholder="{{__('label._referance')}}">
                            </div>
                        </div>
                      </div>
                                      ...
                                      <table class="table table-bordered" >
                                          <thead >
                                            ...
                                            <th class="text-left @if(isset($form_settings->_show_unit)) @if($form_settings->_show_unit==0) display_none    @endif @endif" >Tran. Unit</th>
                                              <th class="text-left @if($_show_pack_size  ==0) display_none @endif">Pack Size</th>
                                          
                                            <th class="text-left @if($_show_barcode  ==0) display_none @endif" >Barcode</th>
                                            <th class="text-left @if($_show_short_note  ==0) display_none @endif" >Short Note</th>
                                          ...
                                          <tbody class="area__purchase_details" id="area__purchase_details">
                                            ...
                                            <tr class="_purchase_row">
                                              ...
                                              <td>
                                               ...
                                               <td>
                                                <input type="text" name="_search_item_code[]" class="form-control _search_item_code width_150_px" placeholder="Code" value="{{$detail->_items->_sales_items->_code ?? '' }}">
                                                <div class="search_box_item"></div>
                                              </td>
                                              <td>
                                                <input type="text" name="_search_item_id[]" class="form-control _search_item_id _search_item_id__counter_{{($m_key+1)}} width_280_px _search_item_id__{{$detail->_p_p_l_id}}" placeholder="Item" value="{{$detail->_items->_name ?? '' }}">
...
if($_unit_conversion==0){
  $_unit_conversion =1;
                                              ...
                                              @endphp
                                              <td class="display_none">
                                                <input type="number" name="conversion_qty[]" min="0" step="any" class="form-control conversion_qty " value="{{$_unit_conversion ?? 1}}" readonly>
                                              </td>
                                              <td class="@if($form_settings->_show_unit==0) display_none @endif">
                                               ...
                                               <td class="@if($_show_pack_size==0) display_none @endif">
                                                <input readonly type="text" name="pack_size[]" class="form-control pack_size pack_size__counter_{{($m_key+1)}}" value="{{$detail->_items_inv->_pack_size->_name ?? ''}}" >
                                              </td>
                                             ...
                                             <td class=" @if($form_settings->_show_barcode == 0) display_none  @endif ">
                                               ...
                                               @endphp
                                                ...
                                                <input type="text" name="_short_note[]" class="form-control _short_note 1__short_note"  value="{!! $detail->_short_note ?? '' !!}"  >
                                               
                                              </td>
                                              <td class=" @if($_show_model  ==0) display_none @endif ">
                                               
                                                <input type="text" name="_model[]" class="form-control _model 1__model"  value="{!! $detail->_model ?? '' !!}"  >
                                              ...
                                              <td>
                                                <input type="number" min="0"  name="sale_qty[]" class="form-control sale_qty sale_qty__counter_{{($m_key+1)}}  sale_qty__{{$detail->_p_p_l_id}} _common_keyup"  value="{{$detail->sale_qty ?? 0 }}" @if($_unique_barcode==1) readonly @endif>
                                              </td>
                                              <td class="@if($_show_free_qty==0) display_none @endif">
                                                <input type="number" min="0"  name="free_qty[]" class="form-control free_qty free_qty__counter_{{($m_key+1)}}  free_qty__{{$detail->_p_p_l_id}} _common_keyup"  value="{{$detail->free_qty ?? 0 }}"  @if($_unique_barcode==1) readonly @endif>
                                              </td>
                                              <td class="@if($_show_free_qty==0) display_none @endif">
                                                <input type="number" min="0"  name="_qty[]" class="form-control _qty _qty__counter_{{($m_key+1)}}  _qty__{{$detail->_p_p_l_id}} _common_keyup"  value="{{$detail->_qty ?? 0 }}"  @if($_unique_barcode==1) readonly @endif>
                                              </td>
                                          ...
                                          <tfoot>
                                            <tr>
                                              ...
                                              <td class="@if($_show_pack_size==0) display_none @endif"></td>
...
function _sales_item_search(_gloabal_this,_text_val,organization_id,_branch_id,_store_id){
    ...
    request.done(function( result ) {
      ...
      if(data.length > 0 ){
            ...
            <thead>
              ...
              <th>Qty</th>
             <th>Pack Size</th>
               <th class=" @if($_show_model  ==0) display_none @endif">Model</th>
  ...
  <input type="hidden" name="_p_item_warranty" class="_p_item_warranty" value="${data[i]._warranty}">
   ...
   <input type="hidden" name="_main_unit_text" class="_main_unit_text" value="${data[i]?._unit_name}">
                         ...
                         <td  @if($_show_model  ==0) display_none @endif> ${isEmpty(data[i]?._model)}</td>
...
$(document).on("change","#_discount_input",function(){
 ...
 var single_row =  `<tr class="_voucher_row">
                      ...
                      <td></td>
                      <td><input type="text" name="_search_ledger_id[]" @if($__user->_ac_type==1) attr_account_head_no="8" @endif  class="form-control _search_ledger_id width_280_px" placeholder="Ledger"   >
