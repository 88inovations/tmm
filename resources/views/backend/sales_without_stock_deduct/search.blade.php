              ...
              <div class="modal-content">
                ...
                <div class="modal-body search_modal">
                 @php 
                  ...
                  <div class="form-group row">
                    <label for="_is_close" class="col-sm-2 col-form-label">{{__('label._is_close')}}:</label>
                    <div class="col-sm-10">
                      @php
                      ...
                      @endphp
                       <select id="_is_close" class="form-control" name="_is_close" >
                        <option value="">Select</option>
                            @foreach($_is_closes AS $key=>$val)
                            <option value="{{$key}}" @if(isset($request->_is_close)) @if($key==$request->_is_close) selected @endif @endif >{{$val}}</option>
                        @endforeach
                        </select>
                    </div>
                  </div>
                          ...
                          <div class="col-md-8">
                              <div class="form-group ">
                                    ...
                                    <button type="button" class="btn btn-sm btn-warning mr-3" data-toggle="modal" data-target="#modal-default" title="Advance Search"><i class="fa fa-search mr-2"></i> </button>
                                     <a href="{{url('sales_without_stock_deduct-reset')}}" class="btn btn-sm btn-danger" title="Search Reset"><i class="fa fa-retweet mr-2"></i> </a>
                              </div>
                          </div>
                        </div><!-- end row -->
