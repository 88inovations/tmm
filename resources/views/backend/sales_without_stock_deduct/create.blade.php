          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
               ...
               @endif
               <form action="{{route('sales_without_stock_deduct.store')}}" method="POST" class="purchase_form" >
                @csrf
                    <div class="row">
                ...
                <input type="hidden" id="_search_form_value" name="_search_form_value" class="_search_form_value" value="2" >
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2  @if($payment_date==0) display_none @endif">
                            <div class="form-group">
                              ...
                              <input required type="date" id="payment_date" name="payment_date" class="form-control payment_date" value="{{date('Y-m-d')}}">
                            </div>
                        </div>
                      ...
                      <div class="row" >
                       ...
                       <div class="col-xs-12 col-sm-12 col-md-3 ">
                         ...
                         <div class="col-xs-12 col-sm-12 col-md-2 @if($_code==0) display_none @endif">
                            <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 @if($_phone==0) display_none @endif">
                            <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 @if($_address==0) display_none @endif">
                            <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 @if($_alious==0) display_none @endif">
                            <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-3 @if($_credit_limit==0) display_none @endif">
                              <div class="form-group">
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-3 @if($_balance==0) display_none @endif">
                              <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2  @if($_referance==0) display_none @endif">
                            <div class="form-group">
                              ...
                              <input  type="text" id="_referance" name="_referance" class="form-control _referance" value="" placeholder="{{__('label._referance')}}">
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 mb-10">
                          ...
                          <input type="number" name="_total" class="form-control width_200_px" id="_total" readonly value="0">
                           <input type="hidden" name="_item_row_count" value="1" class="_item_row_count">
                            ...
                            <tr>
                              <td style="border:0px;width: 20%;"><label for="_due_amount">{{__('label._due_amount')}} </label></td>
                              <td style="border:0px;width: 80%;">
