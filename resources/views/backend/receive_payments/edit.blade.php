          ...
          <div class=" col-sm-4 ">
            <ol class="breadcrumb float-sm-right">
             ...
             <li class="breadcrumb-item active">
               ...
               @endcan
              <li class="breadcrumb-item active">
                 <a class="btn btn-sm btn-default" title="List" href="{{ route('supplier_payment.index') }}">Voucher List</a>
               </li>
            </ol>
          </div>
        </div><!-- /.row -->
...
@endphp
              <div class="card-body">
                <form class="voucher-form" method="POST"  action="{{ route('supplier_payment.update', $data->id) }}" enctype='multipart/form-data'>
        @csrf
        @method('PUT')
                    <div class="row">
...
<div class="col-xs-12 col-sm-12 col-md-3 ">
                            ...
                            <input type="text" id="_search_main_ledger_id" name="_search_main_ledger_id" class="form-control _search_main_ledger_id" value="{!! $data->_sup_cus->_name ?? '' !!}" placeholder="Supplier" required>
