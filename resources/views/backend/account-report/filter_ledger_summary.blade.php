        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body filter_body" >
               <form  action="{{url('ledger-summary-report')}}" method="POST">
                @csrf
                    <div class="row">
            ...
            @endif
                     ...
                     <div class="row">
                         <select id="_with_zero" class="form-control  _with_zero " name="_with_zero"  >
                           <option value="1" @if(isset($previous_filter["_with_zero"])) @if($previous_filter["_with_zero"] ==1) selected @endif @endif >Without Zero Value</option>
                           <option value="0" @if(isset($previous_filter["_with_zero"])) @if($previous_filter["_with_zero"] ==0) selected @endif @endif>With Zero Value</option>
                     ...
                     <div class="row">
                         <select id="_order_by" class="form-control  _order_by " name="_order_by"  >
                           <option value="desc" @if(isset($previous_filter["_order_by"])) @if($previous_filter["_order_by"] =='desc') selected @endif @endif >Amount DESC</option>
                           <option value="asc" @if(isset($previous_filter["_order_by"])) @if($previous_filter["_order_by"] =='asc') selected @endif @endif>Amount ASC</option>
                     ...
                     <div class="row">
                         <select id="_status" class="form-control  _status " name="_status" >
                           ...
                           <option value="1"  @if(isset($previous_filter["_status"]) && $previous_filter["_status"]==1 ) selected @endif >Active</option>
                           <option value="0" @if(isset($previous_filter["_status"]) && $previous_filter["_status"]==0 ) selected @endif >In Active</option>
                    ...
                    <div class="row mt-3">
                         ...
                         <div class="col-xs-6 col-sm-6 col-md-6 ">
                                <a href="{{url('ledger-summary-filter-reset')}}"     class="btn btn-danger mt-2 form-control" title="Search Reset"><i class="fa fa-retweet mr-2"></i> Reset </a>
                        </div>
                        <br><br>
                     </div>
