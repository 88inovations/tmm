...
<section class="invoice" id="printablediv">
    ...
    <div class="row invoice-info">
      ...
      <div class="invoice-col" style="width:100%;white-spcae:nowrap;">
       ...
       <h5 class="text-center">Proprietor: {{ $ledger_info->_alious ?? '' }}</h5> 
        @endif
          ...
          <h5 class="text-center"><b>{{ $page_name ?? '' }}</b></h5>
         <h5 class="text-center"><small>Date: {{ date('d-m-Y')}}</small></h5>
      ...
      <div class="col-sm-4 invoice-col text-right">
        ...
        <b>{{__('label._branch_id')}} : {{ _branch_name($previous_filter["_branch_id"] ?? '') }}</b><br>
        <b>{{__('label._cost_center_id')}} : {{ _cost_center_name($previous_filter["_cost_center_id"] ?? '') }}</b><br>
    ...
    <table class="cewReportTable">
          ...
          <tr>
            ...
            <th style="width: 10%;border:1px solid silver;"  >{{__('label._reference')}}</th>
                ...
                @forelse($value as $l_key=>$l_val)
                  ...
                  @endphp
                    ...
                    <td style="width: 8%;text-align: left;">
                      ...
                      {{ _view_date_formate($detail->_date ?? '') }} </td>
