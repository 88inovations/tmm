        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body filter_body" >
               <form  action="{{url('cash-book-report')}}" method="POST">
                @csrf
                @include('basic.report_date_filter')
                    ...
                    @include('basic.org_report')
                     ...
                     <div class="row">
                         <select id="_account_ledger_id" class="form-control  _account_ledger_id multiple_select" name="_account_ledger_id[]" multiple size='6' required>
                           ...
                           <option value="{{$ledger->id}}" @if(isset($previous_filter["_account_ledger_id"])) @if(in_array($ledger->id,$previous_filter["_account_ledger_id"])) selected @endif  @endif>{{$ledger->_code ?? '' }}-{{$ledger->_name}}</option>
                           @empty
                           @endforelse
                    ...
                    <div class="row mt-3">
                         ...
                         <div class="col-xs-6 col-sm-6 col-md-6 ">
                               ...
                               <a href="{{url('cash-book-filter-reset')}}"     class="btn btn-danger mt-2 form-control" title="Search Reset"><i class="fa fa-retweet mr-2"></i> Reset </a>
                        </div>
                        <br><br>
                     </div>
