          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                {!! Form::model($data, ['method' => 'PATCH','route' => ['security_deposits.update', $data->id]]) !!}
                <div class="row ">
...
<div class="col-xs-12 col-sm-12 col-md-2 ">
                         ...
                         <div class="col-md-3">
                           <div class="form-group">
                              ...
                              <select class="form-control" name="_type" required>
                                ...
                                <option value="Receive" @if($data->_type=='Receive') selected @endif >Receive</option>
                                <option value="Return" @if($data->_type=='Return') selected @endif >Return</option>
                              </select>
                         ...
                         <div class="col-xs-12 col-sm-12 col-md-3 ">
                            <div class="form-group">
                              ...
                              <input type="text" id="_bank_name" name="_bank_name" class="form-control _bank_name" value="{{old('_bank_name',$data->_bank_name ?? '')}}" placeholder="{{__('label._bank_name')}}" >
                         ...
                         <div class="col-xs-12 col-sm-12 col-md-3 ">
                            <div class="form-group">
                              ...
                              <input type="text" id="_bank_branch_name" name="_bank_branch_name" class="form-control _bank_branch_name" value="{{old('_bank_branch_name',$data->_bank_branch_name ?? '')}}" placeholder="{{__('label._bank_branch_name')}}" >
                         ...
                         <div class="col-xs-12 col-sm-12 col-md-3 ">
                            <div class="form-group">
                              ...
                              <input type="text" id="_cheque_no" name="_cheque_no" class="form-control _cheque_no" value="{{old('_cheque_no',$data->_cheque_no ?? '')}}" placeholder="{{__('label._cheque_no')}}" >
                         ...
                         <div class="col-xs-12 col-sm-12 col-md-3 ">
                            <div class="form-group">
                              ...
                              <input type="date" id="_cheque_date" name="_cheque_date" class="form-control _cheque_date" value="{{old('_cheque_date',$data->_cheque_date ?? '')}}" placeholder="{{__('label._cheque_date')}}" >
                         ...
                         <div class="col-xs-12 col-sm-12 col-md-3 ">
                            <div class="form-group">
                              ...
                              <input type="text" id="_voucher_no" name="_voucher_no" class="form-control _voucher_no" value="{{old('_voucher_no',$data->_voucher_no ?? '')}}" placeholder="{{__('label._voucher_no')}}" >
                         ...
                         <div class="col-xs-12 col-sm-12 col-md-3 ">
                            <div class="form-group">
                              ...
                              <input type="number" min="0" step="any" id="_amount" name="_amount" class="form-control _amount" value="{{old('_amount',$data->_amount ?? 0)}}" placeholder="{{__('label._amount')}}" >
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 ">
                            <div class="form-group">
                              ...
                              <input type="text" id="_remarks" name="_remarks" class="form-control _remarks" value="{{old('_remarks',$data->_remarks ?? '')}}" placeholder="{{__('label._remarks')}}" >
