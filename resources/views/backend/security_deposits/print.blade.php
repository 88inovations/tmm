        ...
        <div class="tm_invoice_in">
          <div class="tm_invoice_head tm_top_head tm_mb20 tm_mb10_md">
            <div class="tm_invoice_left">
              <div class="tm_logo"><img src="{{asset($settings->logo ?? '')}}" alt="Logo">
                <br><b>{!! $settings->name ?? '' !!}</b>
          ...
          <div class="tm_invoice_info tm_mb10">
            <div class="tm_invoice_info_left">
              <p class="tm_mb2"><b>Related :</b></p>
              <p>
                <b class="tm_f16 tm_primary_color">
               
                  {{$data->_ledger->_name ?? '' }}<br>
                  {{$data->_ledger->_phone ?? '' }}<br>
                  {{$data->_ledger->_address ?? '' }}<br>
                 </b> <br>
                
              </p>
            </div>
            <div class="tm_invoice_info_right">
              <div class=" tm_text_uppercase tm_text_center tm_invoice_title tm_mb15 tm_ternary_color tm_mobile_hide">Security Deposit {{$data->_type ?? ''}} Slip</div>
              <div class="tm_grid_row tm_col_3 tm_invoice_info_in tm_round_border tm_gray_bg">
                ...
                <div>
                  <span>Amount:</span> <br>
                  <b class="tm_f18 tm_accent_color">{!! _report_amount($data->_amount ?? 0) !!}</b>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="tm_round_border">
              <div class="tm_table_responsive">
                <table>
                  <thead>
                    <tr>
                      <th class="tm_width_7 tm_semi_bold tm_accent_color">{{__('label.organization_id')}}:</th>
                      <th class="tm_width_7 tm_semi_bold tm_accent_color">{{ $data->_organization->_name ?? '' }}</th>
                    </tr>
                    <tr>
                      <th class="tm_width_7 tm_semi_bold tm_accent_color">{{__('label._branch_id')}}:</th>
                      <th class="tm_width_7 tm_semi_bold tm_accent_color">{{ $data->_master_branch->_name ?? '' }}</th>
                    </tr>
                    <tr>
                      <th class="tm_width_7 tm_semi_bold tm_accent_color">{{__('label._cost_center_id')}}:</th>
                      <th class="tm_width_7 tm_semi_bold tm_accent_color">{{ $data->_master_cost_center->_name ?? '' }}</th>
                    </tr>
                    <tr>
                      <th class="tm_width_7 tm_semi_bold tm_accent_color">{{__('label._bank_name')}}:</th>
                      <th class="tm_width_7 tm_semi_bold tm_accent_color">{{ $data->_bank_name ?? '' }}</th>
                    </tr>
                    <tr>
                      <th class="tm_width_7 tm_semi_bold tm_accent_color">{{__('label._bank_branch_name')}}:</th>
                      <th class="tm_width_7 tm_semi_bold tm_accent_color">{{ $data->_bank_branch_name ?? '' }}</th>
                    </tr>
                    <tr>
                      <th class="tm_width_7 tm_semi_bold tm_accent_color">{{__('label._cheque_no')}}:</th>
                      <th class="tm_width_7 tm_semi_bold tm_accent_color">{{ $data->_cheque_no ?? '' }}</th>
                    </tr>
                    <tr>
                      <th class="tm_width_7 tm_semi_bold tm_accent_color">{{__('label._cheque_date')}}:</th>
                      <th class="tm_width_7 tm_semi_bold tm_accent_color">{{ $data->_cheque_date ?? '' }}</th>
                    </tr>
                    <tr>
                      <th class="tm_width_7 tm_semi_bold tm_accent_color">{{__('label._remarks')}}:</th>
                      <th class="tm_width_7 tm_semi_bold tm_accent_color">{{ $data->_remarks ?? '' }}</th>
                    </tr>
                  </thead>
                  <tbody>
            ...
            <div class="tm_invoice_footer tm_type1">
              ...
              <div class="tm_right_footer">
                <div class="tm_sign tm_text_center">
                  ...
                  In Words:  {{ nv_number_to_text($data->_amount ?? 0) }}
                </div>
              </div>
            </div>
          </div>
...
<a class="tm_invoice_btn tm_color2"  title="Edit" href="{{ route('security_deposits.edit',$data->id) }}">Edit</a>
@endcan
<br>
<a class="tm_invoice_btn tm_color2"  title="Back" href="{{ url('security_deposits') }}">Back</a>
