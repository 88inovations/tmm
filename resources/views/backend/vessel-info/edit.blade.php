          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  {!! Form::model($data, ['method' => 'PATCH','route' => ['vessel-info.update', $data->id]]) !!} 
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="_type">
                                    ...
                                    <option value="{{$key}}" @if($data->_type==$key) selected @endif>{{$val}}</option>
                                    @empty
                                    @endforelse
                                </select>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3">
                            <div class="form-group">
                                ...
                                {!! Form::text('_capacity', $data->_capacity, array('placeholder' => __('label._capacity'),'class' => 'form-control','required')) !!}
                            </div>
                        </div>
