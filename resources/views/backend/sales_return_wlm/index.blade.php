        ...
        <div class="row mb-2">
          <div class="col-sm-12" style="display: flex;">
            ...
            <ol class="breadcrumb float-sm-right ml-2">
               @can('sales_return_wlm-create')
              <li class="breadcrumb-item active">
                  <a title="Add New" class="btn btn-info btn-sm" href="{{ route('sales_return_wlm.create') }}"> Add New </a>
               </li>
              @endcan
            </ol>
          </div>
            ...
            <div class="card">
              <div class="card-header border-0 mt-1">
                <div class="row">
                   ...
                   @endphp
                    <div class="col-md-4">
                       @include('backend.sales_return_wlm.search')
                    </div>
                    <div class="col-md-8">
                      <div class="d-flex flex-row justify-content-end">
                         @can('sales_return_wlm-print')
                        ...
                        <tr>
                              ...
                              <div class="dropdown mr-1">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                     <a class="dropdown-item "  href="{{url('sales_return_wlm/print')}}/{{$data->id}}" >
                                         View & Print
                                      </a>
                                     @can('sales_return_wlm-edit')
                                        <a class="dropdown-item "   href="{{ route('sales_return_wlm.edit',$data->id) }}" >
                                          Edit & Update
                                        </a>
                                    @endcan
                                     @can('money-receipt-print')
                                     @if(sizeof($__s_account) > 0)
                                        <a class="dropdown-item " href="{{ url('sales_return_wlm-money-receipt') }}/{{$data->id}}">
                                         Payment Receipt
                                        </a>
                                     @endif
                                    @endcan
