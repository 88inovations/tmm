...
<div class="_report_button_header">
 <a class="nav-link"  href="{{url('sales_return_wlm')}}" role="button"><i class="fa fa-arrow-left"></i></a>
 @can('sales_return_wlm-edit')
    <a class="nav-link"  title="Edit" href="{{ route('sales_return_wlm.edit',$data->id) }}">
        ...
        <table class="table" style="border:none;">
          <tr>
            ...
            <td style="border:none;width: 33%;text-align: center;">
              <table class="table" style="border:none;">
                <tr> <td class="text-center" style="border:none;font-size: 24px;">  {{ $settings->_top_title ?? '' }}</td> </tr>
