...
<div class="content-header">
          ...
          <div class=" col-sm-6 ">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item ">
                 <a target="__blank" href="{{url('sales_return_wlm/print')}}/{{$data->id}}" class="btn btn-sm btn-warning"> <i class="nav-icon fas fa-print"></i> </a>
   ...
   $_inline_discount = $form_settings->_inline_discount ?? 0;
    ...
    @endphp
              <div class="card-body">
               <form action="{{url('sales_return_wlm/update')}}" method="POST" class="purchase_form" >
                @csrf
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-2 ">
                      <div class="form-group">
                        ...
                        <select class="form-control  _store_id" name="_store_id">
                              ...
                              <option value="{{$store->id}}" @if($store->id==$data->_store_id) selected @endif >{{$store->_name ?? '' }}</option>
                              @empty
                              @endforelse
                            </select>
                    ...
                    <div class="row border_step_2">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 ">
                            <div class="form-group">
                              <label class="mr-2" for="_order_ref_id"> Invoice ID:<span class="_required">*</span></label>
                              <input readonly type="text" id="_search_order_ref_id" name="_search_order_ref_id" class="form-control _search_order_ref_id" value="{{old('_order_ref_id',$data->_order_number)}}" placeholder="Sales Invoice" >
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 ">
                          <div class="form-group">
                            ...
                            <input type="text" id="_token_number" name="_token_number" class="form-control _token_number" value="{{old('_token_number',$data->_token_number ?? '')}}" placeholder="{{__('label._token_number')}}" >
                          </div>
                      </div>
                      <div class="col-xs-12 col-sm-12 col-md-2 ">
                          <div class="form-group">
                            <label class="mr-2" for="track_no">{{__('label.track_no')}}:</label>
                            <input type="text" id="track_no" name="track_no" class="form-control track_no" value="{{old('track_no',$data->track_no ?? '')}}" placeholder="{{__('label.track_no')}}" >
                          </div>
                      </div>
                      <div class="col-xs-12 col-sm-12 col-md-2 ">
                          <div class="form-group">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-2 ">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 ">
                            <div class="form-group">
                              <label class="mr-2" for="_order_number">Sales Invoice:</label>
                              <input type="hidden" id="_order_number" name="_order_number" class="form-control _order_number" value="{{old('_order_number',$data->id)}}" placeholder="Order Number" readonly  >
                              <input type="text" name="sales_invoice_no" class="form-control" value="{{$data->sales_invoice_no ?? ''}}" readonly>
                                          ...
                                          <tbody class="area__purchase_details" id="area__purchase_details">
                                           ...
                                           @forelse($data->_master_details as $m_key=> $_detail)
                                            ...
                                            <tr class="_purchase_row">
                                              ...
                                              <td>
                                                   <input type="text" name="_code[]" class="form-control" readonly  placeholder="Code" value="{{$_detail->_items->_code ?? ''}}">
                                              </td>
                                              <td>
 ...
 <script type="text/javascript">
  $('#<?php echo ($m_key+1);?>__barcode').amsifySuggestags({
      ...
      showPlusAfter: 1,
                                              ...
                                              <td class="@if(isset($form_settings->_show_expire_date)) @if($form_settings->_show_expire_date==0) display_none  @endif @endif">
                                               ...
                                               <td class=" @if(sizeof($permited_costcenters) == 1) display_none @endif " >
                                                 <select class="form-control  _main_cost_center" name="_main_cost_center[]" required >
                                                  ...
                                                  <option value="{{$costcenter->id}}" @if(isset($_detail->_cost_center_id)) @if($_detail->_cost_center_id == $costcenter->id) selected @endif   @endif> {{ $costcenter->_name ?? '' }}</option>
                                                  @empty
                                                  @endforelse
                                                </select>
                                              </td>
              ...
              @include('backend.sales_return_wlm.edit_ac_cb')
                 
              @else
               @include('backend.sales_return_wlm.edit_ac_detail')
              @endif           
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form action="{{ url('sales_return_wlm-settings')}}" method="POST">
        @csrf
