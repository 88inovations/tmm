...
<div class="card-body ">
    {!! Form::model($data, ['method' => 'PATCH','route' => ['monthly_sales_targets.update', $data->id]]) !!}
                       ...
                       <div class="col-xs-12 col-sm-12 col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="_group">
                                  ...
                                  <option value="{{$key}}" @if($key==$data->_group) selected @endif >{{$val}}</option>
                                  @empty
                                  @endforelse
                                </select>
                            </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="_month_no" required>
                                    ...
                                    <option value="{{$key}}" @if($key==$data->_month_no) selected @endif >{{$val}}</option>
                                    @empty
                                    @endforelse
                                </select>
                            ...
                            <table class="table table-bordered" >
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{__('label._sales_amount')}}</th>
                                        <th>{{__('label._sales_return_amount')}}</th>
                                ...
                                <tr class="_purchase_row" >
                                      <td>
                                        ...
                                        <input type="hidden" name="_row_id[]" value="{{$data->id}}">
                                      </td>
                                      <td></td>
                                      <td>
                                          <input type="text" name="_ledger_id_name[]" class="form-control sales_target_ledger_id" value="{{_ledger_name($data->_ledger_id)}}" placeholder="{{__('label._ledger_id')}}">
                                           <input type="hidden" class="_ledger_id" name="_ledger_id[]" value="{{$data->_ledger_id}}"  />
                                           <div class="search_box_employee"> </div>
                                           
                                      </td>
                                      <td >
                                        <input type="number" min="0" step="any"  class="form-control _target_amount" name="_target_amount[]" value="{{$data->_target_amount ?? 0}}"  />
                                      </td>
                                      
                                      <td>
                                          <input type="hidden" name="_branch_id[]" class="form-control _branch_id" value="{{$data->_branch_id}}">
                                          <input type="text" readonly name="_branch_id_name[]" class="form-control _branch_id_name" value="{{_branch_name($data->_branch_id)}}">
                                      </td>
                                      
                                      
                                      <td class="">
                                        <input type="number" min="0" step="any"  readonly class="form-control _sales_amount" name="_sales_amount[]" value="{{$data->_sales_amount ?? 0}}"  />
                                      </td>
                                      <td class="">
                                        <input type="number" min="0" step="any" readonly class="form-control _sales_return_amount" name="_sales_return_amount[]" value="{{$data->_sales_return_amount ?? 0}}"  />
                                      </td>
                                      <td class="">
                                        <input type="number" min="0" step="any" readonly class="form-control _collection_amount" name="_collection_amount[]" value="{{$data->_collection_amount ?? 0}}"  />
                                      </td>
                                    </tr>  
                                </tbody>
                                <tfoot>
