                      ...
                      @endphp
                        <tr>
                           ...
                           <td class="_list_table_td">
                            ...
                            <a class="mr-4"  href="{{url('item-sales-price-edit')}}/{{$data->id}}" role="button"><i class="nav-icon fas fa-edit"></i></a>
                            @endcan
                            ...
                            <td class="_list_table_td">
                              @if($data->_input_type=='import_purchase')
                              <a target="__blank" class=""  href="{{ route('asset_import_cost.edit',$data->_master_id) }}">
                                     {{ _id_to_name($data->_master_id,'_order_number','asset_import_costs') }}
                                    </a>
                              @endif
                          ...
                          @if($data->_input_type=='replacement')
                           <a class="" 
                            ...
                            @endif
                          @if($data->_input_type=='production')
                           <a class="" 
                              href="{{url('production/print')}}/{{$data->_master_id}}">
                                      PR-{{$data->_master_id}}
                                    </a>
