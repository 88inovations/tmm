        ...
        <div class="row mb-2">
          <div class="col-sm-12" style="display: flex;">
            ...
            <ol class="breadcrumb float-sm-right ml-2">
               <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('pay-heads-create')): ?>
             <li class="breadcrumb-item active">
                <a type="button" 
               class="btn btn-sm btn-info" 
              
               href="<?php echo e(route('pay-heads.create')); ?>">
                     ...
                     <tbody>
                        ...
                        <tr>
                             ...
                             <td style="display: flex;">
                              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('pay-heads-delete')): ?>
                                 <?php echo Form::open(['method' => 'DELETE','route' => ['pay-heads.destroy', $data->id],'style'=>'display:inline']); ?>
                               ...
                               <?php endif; ?> 
                              <a  type="button" 
                                  href="<?php echo e(route('pay-heads.show',$data->id)); ?>"
                                  class="btn btn-sm btn-default  mr-1"><i class="fa fa-eye"></i></a>

                             <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('pay-heads-edit')): ?>
                                  <a  type="button" 
                                  href="<?php echo e(route('pay-heads.edit',$data->id)); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\avansis-software\resources\views/hrm/pay-heads/index.blade.php ENDPATH**/ ?>