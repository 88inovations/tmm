<div class="col-md-12  ">
                                      ...
                                      <table class="table table-bordered" >
                                          ...
                                          <tbody class="area__voucher_details form_body" id="area__voucher_details">
                                            <tr class="_voucher_row">
                                              ...
                                              <td>
                                                <?php
                                                $_default_cash_account = $form_settings->_default_cash_account ?? '';
                                                $_show_default_cash = $form_settings->_show_default_cash ?? '';

                                                ?>
                                                <input type="text" name="_search_ledger_id[]" class="form-control _search_ledger_id width_280_px"
                                                <?php if($_show_default_cash ==1): ?>
                                                 value="<?php echo e(_find_ledger($_default_cash_account)); ?>"
                                                <?php endif; ?>
                                                  placeholder="Ledger" <?php if($__user->_ac_type==1): ?> attr_account_head_no="<?php echo e(_cash_bank_type_id()); ?>" <?php endif; ?>   >

                                                <input type="hidden"
                                                 <?php if($_show_default_cash ==1): ?>
                                                 value="<?php echo e($_default_cash_account); ?>"
                                                   <?php endif; ?>
                                                  name="_ledger_id[]" class="form-control _ledger_id" >
                                              ...
                                              <td>
                                                <input type="number" name="_dr_amount[]" class="form-control  _dr_amount first_dr_amount" placeholder="Dr. Amount" value="<?php echo e(old('_dr_amount',0)); ?>">
                                              </td>
                                          ...
                                          <tfoot>
                                            <tr>
                                              ...
                                              <td>
                                                <button type="button" class="btn btn-info copyNetTotalAmount">Copy net total To Receive </button>
                                              </td>
                                              <?php if(sizeof($permited_branch)>1): ?>
                                               <td></td>
                                              <?php else: ?>
                        ...
                        </div><?php /**PATH D:\xampp\htdocs\avansis-software\resources\views/backend/sales/create_acc_cb.blade.php ENDPATH**/ ?>