...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('stm_report_section')): ?>
         ...
         <?php endif; ?>
           ...
           <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('collection_expense_report')): ?>
           
          <a href="<?php echo e(url('collection_expense_report')); ?>" class="dropdown-item">
            <i class="fa fa-sitemap mr-2" aria-hidden="true"></i><?php echo e(__('label.collection_expense_report')); ?> </a>
         <?php endif; ?>
             ...
             <!-- Attendence Report Section -->
              <div class="card" style="border: 1px solid silver;">
                    <h4 class="text-center"><?php echo e(__('label.attendence_report_section')); ?></h4>
...
<?php endif; ?>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\tmm\resources\views/report-panel/dashboard.blade.php ENDPATH**/ ?>