...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12" style="display: flex;">
            <a class="m-0 _page_name" href="<?php echo e(route('customer_list')); ?>"><?php echo $page_name ?? ''; ?> </a>
   ...
   <a 
       ...
       href="<?php echo e(route('customer_create')); ?>">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Upload Customer Ledger</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
      <form action="<?php echo e(route('ledger_excel_upload')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
...
if($currentURL === $current){
   ...
   $print_url_detal = $current."?print=detail";
     ...
     $print_url_detal = $currentURL."&print=detail";
                   ...
                   ?>
                    <div class="col-md-4">
                      <?php echo $__env->make('backend.account-ledger.customer_search', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="col-md-8">
                  ...
                  <table class="table table-bordered _list_table" >
                      <thead>
                        <tr>
                         ...
                         <th>Code</th>
                         <th>Ledger Name</th>
                         <th><?php echo e(__('label._alious')); ?></th>
                      ...
                      ?>
                        ...
                        <tr>
                           ...
                           <td style="display: flex;">
                            ...
                            <td><b><?php echo e($data->_alious ?? ''); ?></b></td>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\avansis-software\resources\views/backend/account-ledger/customer_list.blade.php ENDPATH**/ ?>