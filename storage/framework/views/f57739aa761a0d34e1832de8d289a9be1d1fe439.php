 ...
 <?php endif; ?>
      ...
      <li class="nav-item dropdown remove_from_header ">
       ...
       <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('hrm-attandance-list')): ?>
        <div style="display: flex;">
         <a href="<?php echo e(url('data-migration')); ?>" class="dropdown-item">
            <i class="fa fa-fax mr-2" aria-hidden="true"></i> <?php echo e(__('Data Migrations')); ?>
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('security_deposits-list')): ?>
  ...
  </nav><?php /**PATH D:\xampp\htdocs\tmm\resources\views/backend/layouts/navbar.blade.php ENDPATH**/ ?>