                      ...
                      <div class="report_box">
                         ...
                         <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-2 mt-3 ">
                                   <button type="button" class="btn btn-primary due_bill_search_button" attr_url="<?php echo e(route('month_wise_payment_status_data')); ?>"><i class="fa fa-search "></i> Report</button>
...
$(document).on('click','.due_bill_search_button',function(){
    ...
    var data ={ _admission_session_id,_education_type,_admission_class_id,_student_id,_year }
    console.log(page_url)
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u561342241/domains/saifinfotech.com/public_html/tmm/resources/views/stm/report/month_wise_payment_status_report.blade.php ENDPATH**/ ?>