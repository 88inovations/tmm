        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body filter_body" >
               <form  action="<?php echo e(url('report_ledger_foreign_amount')); ?>" method="GET">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\tmm\resources\views/backend/account-report/filterledgerReportForeign_amount.blade.php ENDPATH**/ ?>