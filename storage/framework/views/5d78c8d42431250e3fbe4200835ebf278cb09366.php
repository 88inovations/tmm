...
?>
    ...
    <?php echo $__env->make('backend.message.message', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
           ...
           <form class="mb-2" action="<?php echo e(route('stm_collection.create')); ?>" method="GET">
            <?php echo csrf_field(); ?>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2">
                          ...
                          <select name="_bill_type" class="form-control _bill_type" required>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-2 mt-3 ">
                                   <button type="button" class="btn btn-primary due_bill_search_button" attr_url="<?php echo e(route('student_due_bill_search')); ?>"><i class="fa fa-search "></i> Search</button>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u561342241/domains/saifinfotech.com/public_html/tmm/resources/views/stm/stm_collection/create.blade.php ENDPATH**/ ?>