      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12" style="display: flex;">
            <a class="m-0 _page_name" href="<?php echo e(route('stm_education_sessions.index')); ?>"><?php echo $page_name ?? ''; ?> </a>
            <ol class="breadcrumb float-sm-right ml-2">
               <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('stm_education_sessions_create')): ?>
             <li class="breadcrumb-item active">
                <a type="button" 
               class="btn btn-sm btn-info" 
              
               href="<?php echo e(route('stm_education_sessions.create')); ?>">
                     ...
                     <tbody>
                        ...
                        <tr>
                             ...
                             <td style="display: flex;">
                              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('stm_education_sessions_delete')): ?>
                                 <?php echo Form::open(['method' => 'DELETE','route' => ['stm_education_sessions.destroy', $data->id],'style'=>'display:inline']); ?>
                               ...
                               <?php endif; ?> 
                              <a  type="button" 
                                  href="<?php echo e(route('stm_education_sessions.show',$data->id)); ?>"
                                  class="btn btn-sm btn-default  mr-2"><i class="fa fa-eye"></i></a>

                             <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('stm_education_sessions_edit')): ?>
                                  <a  type="button" 
                                  href="<?php echo e(route('stm_education_sessions.edit',$data->id)); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u561342241/domains/saifinfotech.com/public_html/tmm/resources/views/stm/stm_education_sessions/index.blade.php ENDPATH**/ ?>