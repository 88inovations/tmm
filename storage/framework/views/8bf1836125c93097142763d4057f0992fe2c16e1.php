              ...
              <div class="modal-content">
                ...
                <div class="modal-body search_modal">
                 <?php 
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" name="_branch_id"  >
                                  <option value=""><--- Select <?php echo e(__('label._branch_id')); ?> ---></option>
                  ...
                  <div class="form-group row">
                    <label for="_is_close" class="col-sm-2 col-form-label"><?php echo e(__('label._is_close')); ?>:</label>
                    <div class="col-sm-10">
                      <?php
                        $_is_closes = [ '0'=>'Due', '1'=>'Paid'];
                      ?>
                       <select id="_is_close" class="form-control" name="_is_close" >
                        <option value="">Select</option>
                            <?php $__currentLoopData = $_is_closes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($key); ?>" <?php if(isset($request->_is_close)): ?> <?php if($key==$request->_is_close): ?> selected <?php endif; ?> <?php endif; ?> ><?php echo e($val); ?></option>
                  ...
                  <div class="form-group row">
                    <label for="_payment_terms " class="col-sm-2 col-form-label"><?php echo e(__('label._payment_terms')); ?>:</label>
                    <div class="col-sm-10">
                        <select class="form-control" name="_payment_terms"  >
                                  <option value=""><--- Select <?php echo e(__('label._payment_terms')); ?> ---></option>
                                  <?php $__empty_1 = true; $__currentLoopData = $transection_terms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tran_terms): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                  <option value="<?php echo e($tran_terms->id); ?>" <?php if(isset($request->_payment_terms)): ?> <?php if($request->_payment_terms == $tran_terms->id): ?> selected <?php endif; ?>   <?php endif; ?>><?php echo e($tran_terms->id ?? ''); ?> - <?php echo e($tran_terms->_name ?? ''); ?></option>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                  <?php endif; ?>
                                </select>
                    </div>
                          ...
                          <div class="col-md-8">
                              <div class="form-group ">
                                    ...
                                    <button type="button" class="btn btn-sm btn-warning mr-3" data-toggle="modal" data-target="#modal-default" title="Advance Search"><i class="fa fa-search mr-2"></i> </button>
                                     <a href="<?php echo e(url('sales_without_stock_deduct-reset')); ?>" class="btn btn-sm btn-danger" title="Search Reset"><i class="fa fa-retweet mr-2"></i> </a>
                              </div>
                          </div>
                        </div><!-- end row -->
                   
                  </form>
                </div><?php /**PATH D:\xampp\htdocs\avansis-software\resources\views/backend/sales_without_stock_deduct/search.blade.php ENDPATH**/ ?>