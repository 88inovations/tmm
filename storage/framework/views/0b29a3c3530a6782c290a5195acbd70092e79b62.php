...
<?php $__empty_4 = true; $__currentLoopData = $data_level_fours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_fours): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_4 = false; ?>
            <tr>
             ...
             <?php
            $ledgers = \DB::table('account_ledgers')->where('_account_group_id',$_fours->id)->get();

            ?>

            <?php $__empty_5 = true; $__currentLoopData = $ledgers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $led_key=>$ledger): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_5 = false; ?>
            <tr>

              <td style="width:60%;">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; &emsp;&emsp;<?php echo $ledger->_code ?? ''; ?>. <?php echo $ledger->_name ?? ''; ?></td>
...
<?php $__empty_3 = true; $__currentLoopData = $data_level_fours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_fours): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_3 = false; ?>
            ...
            <?php $__empty_4 = true; $__currentLoopData = $ledgers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $led_key=>$ledger): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_4 = false; ?>
            <tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u561342241/domains/saifinfotech.com/public_html/tmm/resources/views/backend/account-report/chart-of-ledger.blade.php ENDPATH**/ ?>