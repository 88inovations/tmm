              ...
              <div class="card-body">
                <?php echo Form::model($role, ['method' => 'PATCH','route' => ['roles.update', $role->id]]); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                              <?php
                              $types = ['admin','visitor','sales_officer'];
                              ?>
                                <strong>Type:</strong>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u561342241/domains/saifinfotech.com/public_html/tmm/resources/views/roles/edit.blade.php ENDPATH**/ ?>