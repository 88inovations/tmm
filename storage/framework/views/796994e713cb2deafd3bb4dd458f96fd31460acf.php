          ...
          <div class="card">
            <div class="card-body filter_body" >
              <div class="row">
               ...
               <form  action="<?php echo e(url('day-book-report')); ?>" method="POST">
                <?php echo csrf_field(); ?>
               <?php echo $__env->make('basic.report_date_filter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    <?php echo $__env->make('basic.org_report', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                     ...
                     <div class="row">
                      <label>Transection:<span class="_required">*</span></label><br></div>
                     <div class="row">
                         <select id="_transaction" class="form-control  _transaction " name="_transaction"   required>
                         <option value="all">Show All</option>
                           <?php $__empty_1 = true; $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transection): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                           <option value="<?php echo e($transection->_transaction); ?>" 
                            <?php if(isset($previous_filter["_transaction"])): ?> <?php if($transection->_transaction==$previous_filter["_transaction"]): ?> selected <?php endif; ?>  <?php endif; ?>><?php echo e($transection->_transaction); ?></option>
                     ...
                     <div class="row">
                      <label>Voucher Type:</label><br></div>
                     <div class="row">
                         <select id="_voucher_type" class="form-control  _voucher_type multiple_select " name="_voucher_type[]" multiple size="6"  >
                           ...
                           <option value="<?php echo e($voucher_type->_code); ?>" 
                             <?php if(isset($previous_filter["_voucher_type"])): ?>
                            <?php if(in_array($voucher_type->_code,$previous_filter["_voucher_type"])): ?> selected <?php endif; ?> <?php endif; ?>><?php echo e($voucher_type->_name ?? ''); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                           <?php endif; ?>
                    ...
                    <div class="row mt-3">
                         ...
                         <div class="col-xs-6 col-sm-6 col-md-6 ">
                                     ...
                                     <a class="btn btn-danger form-control  mt-2" href="<?php echo e(url('detail-item-sales-report-filter-reset')); ?>"      class="btn btn-danger mt-2 form-control" title="Search Reset"><i class="fa fa-retweet mr-2"></i> Reset </a>
                        </div>
                        <br><br>
                     </div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u561342241/domains/saifinfotech.com/public_html/tmm/resources/views/backend/account-report/filter_day_book.blade.php ENDPATH**/ ?>