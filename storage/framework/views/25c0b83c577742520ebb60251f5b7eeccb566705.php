                ...
                <div class="modal-body">
                 <?php 
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10 ">
                      <select class="form-control  _account_head_id" name="_account_head_id">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-10 ">
                      <select class="form-control  _branch_id" name="_branch_id">
                          <option value=""><?php echo e(__('label._branch_id')); ?></option>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      ...
                      <input type="hidden" name="_type" class="form-control" placeholder="Exp:1,2,3,4" value="<?php if(isset($request->_type)): ?> <?php echo e($request->_type ?? 'honorarium'); ?>  <?php endif; ?>">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    <label for="_status" class="col-sm-2 col-form-label"><?php echo e(__('label._status')); ?>:</label>
                    <div class="col-sm-10">
                      <?php
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-8">
                              <div class="form-group mr-2">
                                <div class="d-flex">
 <button type="button" class="btn btn-info  btn-sm mr-2 display_none" data-toggle="modal" data-target="#exampleModal">
  Excel File Upload
</button>
                                    <button type="button" class="btn btn-sm btn-warning mr-3" data-toggle="modal" data-target="#modal-default" title="Advance Search"><i class="fa fa-search mr-2"></i> </button>
                                     <a href="<?php echo e(url('customer_list')); ?>" class="btn btn-sm btn-danger" title="Search Reset"><i class="fa fa-retweet mr-2"></i> </a>
                                     </div>
                                </div>
                          </div>
                ...
                </div><?php /**PATH /home/u561342241/domains/saifinfotech.com/public_html/tmm/resources/views/backend/account-ledger/customer_search.blade.php ENDPATH**/ ?>