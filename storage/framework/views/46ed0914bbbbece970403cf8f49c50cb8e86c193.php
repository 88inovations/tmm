<div class="col-md-12  ">
                                      ...
                                      <table class="table table-bordered" >
                                          ...
                                          <tbody class="area__voucher_details form_body" id="area__voucher_details">
                                            <?php
                                              $_account_dr_total = 0;
                                              $_account_cr_total = 0;
                                               $purchase_order_account =  $data->purchase_order_account ?? [];
                                            ?>
                                            <?php $__empty_1 = true; $__currentLoopData = $purchase_order_account; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            ...
                                            <tr class="_voucher_row">
                                              ...
                                              <td>
                                                <input type="text" name="_search_ledger_id[]" class="form-control _search_ledger_id width_280_px" placeholder="Ledger" value="<?php echo e($account->_ledger->_name ?? ''); ?>">
                        ...
                        </div><?php /**PATH /home/u561342241/domains/saifinfotech.com/public_html/tmm/resources/views/backend/purchase-order/create_ac_detail.blade.php ENDPATH**/ ?>