        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body filter_body" style="">
               <form  action="<?php echo e(url('trail-balance-report')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                    <div class="row">
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                         <select id="_account_group_id" class="form-control _account_group_id multiple_select" name="_account_group_id[]" multiple  size='6'  >
            ...
            <?php endif; ?>
                     ...
                     <div class="row mt-3">
                         ...
                         <div class="col-xs-6 col-sm-6 col-md-6 ">
                                     <a href="<?php echo e(url('trail-balance-filter-reset')); ?>" class="btn btn-danger mt-2 form-control" title="Search Reset"><i class="fa fa-retweet mr-2"></i> Reset </a>
                        </div>
                        <br><br>
                     </div>
                    <?php echo Form::close(); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u561342241/domains/saifinfotech.com/public_html/tmm/resources/views/backend/account-report/trail-balance.blade.php ENDPATH**/ ?>