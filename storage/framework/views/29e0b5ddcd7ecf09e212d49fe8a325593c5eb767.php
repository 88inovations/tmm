...
<section class="invoice p-2" id="printablediv">
   ...
   <table class="cewReportTable">
          ...
          <tr>
            ...
            <td style="width:15%;" class="white_space"><?php echo e(__('label._due_balance')); ?></td>
          </tr>
...
?>
        <tr>
            ...
            <td class="white_space"><?php echo $data->_session__name ?? ''; ?> </td>
            <td class="white_space"><?php echo $data->_division_name ?? ''; ?> </td>
            <td class="white_space"><?php echo $data->_class_name ?? ''; ?> </td>
            <td class="white_space"><?php echo $data->_roll_no ?? ''; ?> </td>
            <td class="white_space"><?php echo $data->_name_in_bangla ?? ''; ?> </td>
            <td class="white_space"><?php echo $data->_name_in_english ?? ''; ?> </td>
            ...
            <td class="white_space"><?php echo _report_amount(($data->_fee_amount ?? 0)-(($data->_discount_amount ?? 0)+($data->_receive_amount ?? 0))); ?></td>
          </tr>
...
<tr>
  <tr>
    ...
    <!-- /.row -->
  </section><?php /**PATH D:\xampp\htdocs\avansis-software\resources\views/stm/report/division_class_collection_status_list.blade.php ENDPATH**/ ?>