        ...
        <div class="row mb-2">
          <div class="col-sm-12" style="display: flex;">
            ...
            <ol class="breadcrumb float-sm-right ml-2">
               <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('stm_collection_create')): ?>
            ...
            <div class="card">
              <div class="card-header border-0 mt-1">
                 <div class="row">
                  ...
                  <form class="" action="<?php echo e(route('stm_collection.index')); ?>" method="GET">
            <?php echo csrf_field(); ?>
                      ...
                      <div>
                         ...
                         <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control stduent_seach _admission_session_id _search_admission_session_id" name="_admission_session_id"  attr_url="<?php echo e(route('session_class_div_wise_student')); ?>">
                             ...
                             <div class="col-xs-12 col-sm-12 col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control stduent_seach _education_type _search_education_type" name="_education_type"  attr_url="<?php echo e(route('session_class_div_wise_student')); ?>">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control stduent_seach _admission_class_id _search_admission_class_id" name="_admission_class_id"  attr_url="<?php echo e(route('session_class_div_wise_student')); ?>">
                             ...
                             <div class="col-xs-12 col-sm-12 col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label"><?php echo e(__('label._student_id')); ?>:</label>
                                    <div class="_search_stduent_list">
                                        
                                         <select class="_student_id form-control  select2" name="_student_id">
                                                <option value="">Select Student</option>
                                                <?php $__empty_1 = true; $__currentLoopData = $students_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                 <option value="<?php echo e($student->id); ?>" <?php if($_student_id==$student->id): ?> selected <?php endif; ?> ><?php echo $student->_name_in_english ?? ''; ?>  | <?php echo $student->_student_id ?? ''; ?> | <?php echo $student->_father_name_english ?? ''; ?></option>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2">
                          ...
                          <select name="_bill_type" class="form-control _bill_type" >
                            <option value="">Select <?php echo e(__('label._bill_type')); ?></option>
                              <?php $__empty_1 = true; $__currentLoopData = $bill_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bill_key=>$lebel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                  <option value="<?php echo e($bill_key); ?>" <?php if($_bill_type ==$bill_key): ?> selected <?php endif; ?> ><?php echo e($lebel); ?></option>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                              <?php endif; ?>
                          </select>
                        </div>
                        ...
                        <div class="col-md-2">
                                ...
                                <select class="form-control _month" name="_month" >
                                    <option value=""><?php echo e(__('label.select')); ?> <?php echo e(__('label._month')); ?></option>
                              ...
                              <div class="col-xs-12 col-sm-12 col-md-2">
                                  ...
                                  <select name="_year" class="form-control" >
                                    <option value=""><?php echo e(__('label.select')); ?> <?php echo e(__('label._year')); ?></option>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2">
                         ...
                         <input type="text" name="_order_number" class="form-control _order_number" value="<?php echo e($_order_number); ?>">
                        </div>
                      ...
                      ?>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-3 mt-3 flex">
                                   ...
                                   <a  href="<?php echo e(route('stm_collection.index')); ?>" class="btn btn-danger mt-1"><i class="fa fa-retweet"></i> Reset</a>
                                  </div>
                        </div>
                     ...
                     <tbody>
                        ...
                        <tr>
                             ...
                             <td style="display: flex;">
                              ...
                              <a  type="button" 
                                  href="<?php echo e(route('stm_collection.show',$data->id)); ?>"
                             ...
                             <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('stm_collection_edit')): ?>
                                  <a  
                                  href="<?php echo e(route('stm_collection.edit',$data->id)); ?>"
                                 
                                  class="btn btn-sm btn-default  mr-2"><i class="fa fa-pen "></i></a>
                              <?php endif; ?> 
                             <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('stm_collection_delete')): ?>
                                 <form action="<?php echo e(route('stm_collection.destroy', $data->id)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                        ...
                        <tfoot>
                          <tr>
                            <td colspan="10">  <?php echo $datas->render(); ?></td>
                          </tr>
                        </tfoot>
                    </table>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u561342241/domains/saifinfotech.com/public_html/tmm/resources/views/stm/stm_collection/index.blade.php ENDPATH**/ ?>