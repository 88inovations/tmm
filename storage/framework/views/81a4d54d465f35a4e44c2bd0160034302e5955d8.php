      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card">
           <div class="row mb-2">
                  <div class="col-sm-6">
                    <a class="m-0 _page_name" href="<?php echo e(route('pay-heads.index')); ?>"><?php echo $page_name; ?> </a>
                  </div><!-- /.col -->
                  <div class="col-sm-6">
...
<div class="message-area">
    <?php echo $__env->make('backend.message.message', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="card-body p-4" >
               <?php echo Form::model($data, ['method' => 'PATCH','route' => ['pay-heads.update', $data->id]]); ?>

                <div class="row">
                      <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <label><?php echo e(__('label._payhead')); ?>:</label>
                                <input type="text" name="_ledger" class="form-control" value="<?php echo e(old('_ledger',$data->_ledger)); ?>">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <input type="text" id="_search_main_ledger_id" name="_search_main_ledger_id" class="form-control _search_main_ledger_id" value="<?php echo e(_ledger_name($data->_ledger_id ?? '')); ?>" placeholder="<?php echo e(__('label._ledger_id')); ?>" required>

                            <input type="hidden" id="_main_ledger_id" name="_ledger_id" class="form-control _main_ledger_id" value="<?php echo e($data->_ledger_id ?? ''); ?>" placeholder="<?php echo e(__('label._ledger_id')); ?>" required>
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control " name="_type" required>
                                  ...
                                  <option value="<?php echo e($val->id); ?>" <?php if($val->id==$data->_type): ?> selected <?php endif; ?>><?php echo $val->_name ?? ''; ?></option>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\avansis-software\resources\views/hrm/pay-heads/edit.blade.php ENDPATH**/ ?>