                ...
                <th>Manufacture</th>
                        ...
                        for (var i = 0; i < data.length; i++) {
                         ...
                         search_html += `<tr class="search_row_item" >
                                  ...
                                  <input type="hidden" name="_item_model" class="_item_model" value="${_model}">
...
$(document).on('click','.search_row_item',function(){
  ...
  var _item_model = $(this).find('._item_model').val();
...
var self = $(this);
 ...
 var _ref_counter = $(this).parent().parent().parent().parent().parent().parent().find('._ref_counter').val();
  ...
  $(this).parent().parent().parent().parent().parent().parent().find('._model').val(_item_model);
            ...
            search_html +=`<div class="card"><table table-bordered style="width: 100%;">
                        ...
                        for (var i = 0; i < data.length; i++) {
                         ...
                         search_html += `<tr class="search_row_purchase_order" style="color:${row_color}">
                                        ...
                                        <input type="hidden" name="_date_main_ledger" class="_date_main_ledger" value="${after_request_date__today(data[i]._date)}"></td>
...
if(data.length > 0 ){
  ...
  for (var i = 0; i < data.length; i++) {
   var _item_row_count = (parseFloat(i)+1);
    ...
    var _item_code = (data[i]._items._code) ? data[i]._items._code : '' ;
    ...
    $(document).find("._item_row_count").val(_item_row_count)
      ...
      $(document).find("#area__purchase_details").append(`<tr class="_purchase_row">
                                              ...
                                              <td>
                                                <input type="text" name="_search_item_code[]" class="form-control _search_item_code width_150_px" placeholder="Code" value="${_item_code}">
...
// }
 ...
 var single_row =  `<tr class="_voucher_row">
                      ...
                      <td></td>
                      <td><input type="text" name="_search_ledger_id[]" class="form-control _search_ledger_id width_280_px" placeholder="Ledger" <?php if($__user->_ac_type==1): ?> attr_account_head_no="<?php echo e(_cash_bank_type_id()); ?>" <?php endif; ?> >
...
</script><?php /**PATH /home/u561342241/domains/saifinfotech.com/public_html/tmm/resources/views/backend/purchase/purchase_script.blade.php ENDPATH**/ ?>