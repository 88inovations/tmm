<div  >
    ...
    <div class="modal fade" id="modal-default">
                ...
                <div class="modal-body search_modal">
                 <?php 
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" id="_order_number" name="_order_number" class="form-control" placeholder="Invoice No/Scan Barcode" value="<?php if(isset($request->_order_number)): ?><?php echo e($request->_order_number ?? ''); ?><?php endif; ?>">
                    </div>
                  </div>
                  <div class="form-group row">
       ...
       <form action="" method="GET">
                          ...
                          <div class="col-md-12 d-flex">
                            ...
                            <div class="form-group ml-2">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('purchase-create')): ?>
                                    ...
                                    <a title="Add New" class="btn btn-info btn-sm mr-1" href="<?php echo e(route('purchase.create')); ?>"><i class="nav-icon fas fa-plus"></i> Create New </a>
                                  <?php endif; ?>
                              </div>
                              ...
                              <div class="form-group ml-2">
                                    <button type="button" class="btn btn-sm btn-warning mr-3" data-toggle="modal" data-target="#modal-default" title="Advance Search"><i class="fa fa-search mr-2"></i> </button>
                                     <a href="<?php echo e(url('purchase-reset')); ?>" class="btn btn-sm btn-danger" title="Search Reset"><i class="fa fa-retweet mr-2"></i> </a>
                              </div>
                ...
                </div><?php /**PATH /home/u561342241/domains/saifinfotech.com/public_html/tmm/resources/views/backend/purchase/search.blade.php ENDPATH**/ ?>