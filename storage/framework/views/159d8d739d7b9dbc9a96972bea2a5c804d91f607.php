    ...
    <?php echo $__env->make('backend.message.message', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                      ...
                      <div class="report_box">
                         ...
                         <div class="row">
                            ...
                            <input type="date" name="start_date" id="start_date" class="form-control start_date" value="<?php echo e(date('Y-m-d')); ?>">
                        </div>
                        <div class="col-md-2">
                            <label for="end_date" class="form-label">End Date</label>
                            <input type="date" name="end_date" id="end_date" class="form-control end_date" value="<?php echo e(date('Y-m-d')); ?>" >
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2">
                          ...
                          <select name="_bill_type" class="form-control _bill_type" >
                            ...
                            <option value="_admission_fee"><?php echo e(__('label._admission_fee')); ?></option>
                              <?php $__empty_1 = true; $__currentLoopData = $bill_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bill_key=>$lebel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                  <option value="<?php echo e($bill_key); ?>" ><?php echo e($lebel); ?></option>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                              <?php endif; ?>
                          </select>
                        </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-2 mt-3 mb-2 ">
                                   <button type="button" class="btn btn-primary due_bill_search_button" attr_url="<?php echo e(route('division_class_collection_list')); ?>"><i class="fa fa-search "></i> Report</button>
...
$(document).on('click','.due_bill_search_button',function(){
    ...
    var data ={_datex,_datey, _admission_session_id,_education_type,_admission_class_id,_bill_type }
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u561342241/domains/saifinfotech.com/public_html/tmm/resources/views/stm/report/division_class_collection_report.blade.php ENDPATH**/ ?>