...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('stmd_today_collection_expense')): ?>
<?php
    ...
    <div class="card-body table-responsive p-0 info-box">
      <table class="cewReportTable">
          ...
          <tr>
            ...
            <td style="width:15%;"class="white_space"><?php echo e(__('label._ledger_id')); ?></td>
          ...
          ?>
                  <tr>
                      ...
                      <td class="white_space"><?php echo _fee_lebel($data->_bill_type ?? ''); ?> </td>
                      <td class="white_space"><?php echo ($data->total_collection_amount ?? 0); ?></td>
                    </tr>
          ...
          <?php if(sizeof($datas) > 0): ?>
            <tr>
                      ...
                      <th class="white_space"><?php echo ($_total_amount ?? 0); ?></th>
                    </tr>
          <?php endif; ?>
                    </tbody>
    ...
    <div class="card-body table-responsive p-0 info-box">
      <table class="cewReportTable">
          ...
          ?>
                  <tr>
                      <td class="white_space"><?php echo e(($d_key+1)); ?></td>
                      <td class="white_space"><?php echo $data->_name ?? ''; ?> </td>
                      <td class="white_space"><?php echo ($data->_amount ?? 0); ?></td>
                    </tr>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
          <tr>
                      <td colspan="3" class="white_space text-center">No Data Found</td>
          ...
          <?php if(sizeof($datas) > 0): ?>
            <tr>
                      <th colspan="2" class="white_space">Total </th>
                      <th class="white_space"><?php echo ($_total_expense_amount ?? 0); ?></th>
                    </tr>
          <?php endif; ?>
                    </tbody>
...
<div class="col-md-12">
<div class="row">
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('stmd_student_count')): ?>
<?php
...
<?php endif; ?>
 ...
 </div><!-- End of Row --><?php /**PATH /home/u561342241/domains/saifinfotech.com/public_html/tmm/resources/views/stm/dashboard.blade.php ENDPATH**/ ?>