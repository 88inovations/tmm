...
$main_accounts = \DB::table('main_account_head')->get();
                       ...
                       <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control _head_account_id" name="_account_id" required>
                                  ...
                                  <option value="<?php echo e($main->id); ?>"><?php echo e($main->_name); ?></option>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="_parent_id">
                                  ...
                                  <option value="<?php echo e($account_type->id); ?>"  <?php if(old('_parent_id') == $account_type->id): ?> selected <?php endif; ?>   ><?php echo e($account_type->_code ?? ''); ?>-<?php echo e($account_type->_name ?? ''); ?></option>
                                  ...
                                  <?php $__empty_2 = true; $__currentLoopData = $_child_groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                        <option value="<?php echo e($group->id); ?>"  <?php if(old('_parent_id') == $group->id): ?> selected <?php endif; ?>   > &nbsp; &nbsp; &nbsp; &nbsp;<?php echo e($group->_code ?? ''); ?>-<?php echo e($group->_name ?? ''); ?></option>
 ...
 <option value="<?php echo e($third_child_val->id); ?>"  <?php if(old('_parent_id') == $third_child_val->id): ?> selected <?php endif; ?>   > &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;<?php echo e($third_child_val->_code ?? ''); ?>-<?php echo e($third_child_val->_name ?? ''); ?></option>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\avansis-software\resources\views/backend/account-type/create.blade.php ENDPATH**/ ?>