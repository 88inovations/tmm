        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body filter_body" >
               <form  action="<?php echo e(url('receipt-payment-report')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                 <?php echo $__env->make('basic.report_date_filter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    <div class="row mt-3">
                         ...
                         <div class="col-xs-6 col-sm-6 col-md-6 ">
                                <a href="<?php echo e(url('receipt-payment-filter-reset')); ?>"     class="btn btn-danger mt-2 form-control" title="Search Reset"><i class="fa fa-retweet mr-2"></i> Reset </a>
                        </div>
                        <br><br>
                     </div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\tmm\resources\views/backend/account-report/filter_receipt_payment.blade.php ENDPATH**/ ?>