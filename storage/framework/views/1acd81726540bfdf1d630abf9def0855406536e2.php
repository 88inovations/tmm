          ...
          <div class="col-sm-12" style="display: flex;">
            ...
            <ol class="breadcrumb float-sm-right ml-2">
              ...
              <li class="breadcrumb-item active">
                  <a title="Add New" class="btn btn-info btn-sm" href="<?php echo e(route('sales_without_stock_deduct.create')); ?>"> Add New </a>
               </li>
              <?php endif; ?>
            ...
            <div class="card">
              <div class="card-header border-0 mt-1">
                <div class="row">
                   ...
                   ?>
                    <div class="col-md-4">
                       <?php echo $__env->make('backend.sales_without_stock_deduct.search', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="col-md-8">
                  ...
                  <table class="table table-bordered _list_table">
                      <thead>
                        <tr>
                         ...
                         <th class=""><b><?php echo e(__('label._sales_man_id')); ?></b></th>
                         <th class=""><b><?php echo e(__('label._payment_terms')); ?></b></th>
                         ...
                         <th class=""><b><?php echo e(__('label._receive_amount')); ?></b></th>
                         <th class=""><b><?php echo e(__('label._due_amount')); ?></b></th>
                         <th class=""><b><?php echo e(__('label._return_note')); ?></b></th>
                          ...
                          <td style="display: flex;">
                              <div class="dropdown mr-1">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                     <a target="__blank" class="dropdown-item " href="<?php echo e(url('sales/print')); ?>/<?php echo e($data->id); ?>" >
                                        Invoice Customer Copy
                                      </a>
                                      <a target="__blank" class="dropdown-item " href="<?php echo e(url('sales/office_print')); ?>/<?php echo e($data->id); ?>" >
                                        Invoice Office Copy
                                      </a>
                                      <a target="__blank" class="dropdown-item " href="<?php echo e(url('inv')); ?>/<?php echo $data->_online_inv_no ?? ''; ?>" >
                                         Online Invoice
                                      </a>
                                     
                                     <a target="__blank" class="dropdown-item " href="<?php echo e(url('net-sales-after-return')); ?>/<?php echo e($data->id); ?>" >
                                     ...
                                     <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sales-edit')): ?>
                                        <a class="dropdown-item " href="<?php echo e(route('sales_without_stock_deduct.edit',$data->id)); ?>" >
                                          Edit
                                        </a>
                                    <?php endif; ?>
                                    ...
                                    <a class="dropdown-item  mr-1" onclick="return confirm('Are you Sure?')" href="<?php echo e(url('sales_without_stock_deduct_delete')); ?>/<?php echo e($data->id); ?>">
                                      Delete
                                    </a>
                                     <?php endif; ?>
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('so_wise_due_invoice')): ?>
                              ...
                              <?php if($data->_is_close ==0 && $data->_due_amount > 0): ?>

 <button type="button" 
 class="btn btn-sm btn-danger invoice_wise_due_collection invoice_wise_due_collection__<?php echo e($data->id); ?> mr-3 ml-3" 
 attr_id="<?php echo e($data->id); ?>"
 attr_order_number="<?php echo e($data->_order_number); ?>"
 attr_url="<?php echo e(url('invoice_wise_due_collection')); ?>"
 data-toggle="modal" 
...
<?php endif; ?>
                            ...
                            <td><?php echo e($data->_sales_man->_name ?? ''); ?></td>
                            <td><?php echo e($data->_terms_con->_name ?? ''); ?></td>
                           

                            <td><?php echo e($data->_order_number ?? ''); ?></td>
                            <td class="_required"><?php echo e(id_to_cloumn($data->_order_ref_id ?? '','_order_number','sales_orders')); ?></td>
                            <td><?php echo e($data->_referance ?? ''); ?></td>
                            <td><?php echo e($data->_ledger->_name ?? ''); ?></td>
                            <td><?php echo e(_report_amount( $data->_sub_total ?? 0)); ?> </td>
                            <td><?php echo e(_report_amount( $data->_total_discount ?? 0)); ?> </td>
                            <td><?php echo e(_report_amount( $data->_total_vat ?? 0)); ?> </td>
                            <td><?php echo e(_report_amount( $data->_total ?? 0)); ?> </td>
                            <td><?php echo e(_report_amount( $data->_receive_amount ?? 0)); ?> </td>
                            <td><?php echo e(_report_amount( $data->_due_amount ?? 0)); ?> </td>
                            <td><?php echo e($data->_return_note ?? ''); ?></td>
                        ...
                        <tr>
                          <td colspan="15" class="collapse " id="collapseExample__<?php echo e($key); ?>">
                          <!--   <div class="_single_data_display__<?php echo e($data->id); ?>">
                              <h2 style="color: green">Loading..............</h2>
                            </div> -->
                            <?php echo $__env->make('backend.sales.sales_details', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        ...
                        <tr>
                          ...
                          <td><b><?php echo e(_report_amount($sum_of_sub__total_discount)); ?> </b></td>
                          <td><b><?php echo e(_report_amount($sum_of_sub__total_vat)); ?> </b></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\avansis-software\resources\views/backend/sales_without_stock_deduct/index.blade.php ENDPATH**/ ?>