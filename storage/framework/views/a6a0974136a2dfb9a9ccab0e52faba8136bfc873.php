...
<section class="invoice" id="printablediv">
    ...
    <div class="row invoice-info">
      ...
      <div class="invoice-col" style="width:100%;white-spcae:nowrap;">
       ...
       <h5 class="text-center">Proprietor: <?php echo e($ledger_info->_alious ?? ''); ?></h5> 
        <?php endif; ?>
          ...
          <h5 class="text-center"><b><?php echo e($page_name ?? ''); ?></b></h5>
         <h5 class="text-center"><small>Date: <?php echo e(date('d-m-Y')); ?></small></h5>
      ...
      <div class="col-sm-4 invoice-col text-right">
        ...
        <b><?php echo e(__('label._branch_id')); ?> : <?php echo e(_branch_name($previous_filter["_branch_id"] ?? '')); ?></b><br>
        <b><?php echo e(__('label._cost_center_id')); ?> : <?php echo e(_cost_center_name($previous_filter["_cost_center_id"] ?? '')); ?></b><br>
    ...
    <table class="cewReportTable">
          ...
          <tr>
            ...
            <th style="width: 10%;border:1px solid silver;"  ><?php echo e(__('label._reference')); ?></th>
          ...
          <tbody>
                ...
                <?php $__empty_2 = true; $__currentLoopData = $value; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l_key=>$l_val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                  ...
                  ?>
                    ...
                    <td style="width: 8%;text-align: left;">
                      ...
                      <?php echo e(_view_date_formate($detail->_date ?? '')); ?> </td>
                 ...
                 <td class="text-left" style="width: 7%;white-space: nowrap;">
                    ...
                    <td style="text-align: left;width: 20%;"><?php echo e($detail->_reference ?? ''); ?> </td>

                    <td style="text-align: right;width: 10%;white-space: nowrap;"><?php echo e(_report_amount($detail->_dr_amount ?? 0)); ?> </td>
                    <td style="text-align: right;width: 10%;white-space: nowrap;"><?php echo e(_report_amount($detail->_cr_amount ?? 0)); ?> </td>
                    <td style="text-align: right;width: 15%;white-space: nowrap;"><?php echo e(_show_amount_dr_cr(_report_amount(  $runing_balance_total ))); ?> </td>
            ...
            <tr>
                ...
                <td style="text-align: right;background: #f5f9f9;white-space: nowrap;"> <b><?php echo e(_report_amount($_dr_grand_total)); ?></b> </td>
                <td style="text-align: right;background: #f5f9f9;white-space: nowrap;"> <b><?php echo e(_report_amount($_cr_grand_total)); ?></b> </td>
                <td style="text-align: right;background: #f5f9f9;white-space: nowrap;"> <b><?php echo e(_show_amount_dr_cr(_report_amount($_total_balance))); ?></b> </td>
            </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u561342241/domains/saifinfotech.com/public_html/tmm/resources/views/backend/account-report/full_ledger_detail.blade.php ENDPATH**/ ?>