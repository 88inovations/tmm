...
<div class="form-group row">
      ...
      <div class="form-group row">
        <label for="_default_cash_account" class="col-sm-5 col-form-label">Default CASH Account</label>
        <select class="form-control col-md-7" name="_default_cash_account">
          <option value="">--Select ledger--</option>
          <?php $__currentLoopData = $dis_accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <option value="<?php echo e($account->id); ?>" <?php if(isset($form_settings->_default_cash_account)): ?><?php if($form_settings->_default_cash_account==$account->id): ?> selected <?php endif; ?> <?php endif; ?>><?php echo e($account->_name ?? ''); ?></option>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
      </div>

      <div class="form-group row">
        <label for="_show_default_cash" class="col-sm-5 col-form-label">Selected Cash Account</label>
        <select class="form-control col-sm-7" name="_show_default_cash">
         
          <option value="0" <?php if(isset($form_settings->_show_default_cash)): ?><?php if($form_settings->_show_default_cash==0): ?> selected <?php endif; ?> <?php endif; ?>>NO</option>
          <option value="1" <?php if(isset($form_settings->_show_default_cash)): ?><?php if($form_settings->_show_default_cash==1): ?> selected <?php endif; ?> <?php endif; ?>>YES</option>
        </select>
      </div>
      ...
      <div class="form-group row">
        <label for="_show_free_qty" class="col-sm-5 col-form-label">Show Free Qty</label>
        <select class="form-control col-sm-7" name="_show_free_qty">
         
          <option value="0" <?php if(isset($form_settings->_show_free_qty)): ?><?php if($form_settings->_show_free_qty==0): ?> selected <?php endif; ?> <?php endif; ?>>NO</option>
          <option value="1" <?php if(isset($form_settings->_show_free_qty)): ?><?php if($form_settings->_show_free_qty==1): ?> selected <?php endif; ?> <?php endif; ?>>YES</option>
        </select>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row">
        ...
        <select class="form-control col-sm-7" name="_show_model">
          <option value="0" <?php if(isset($form_settings->_show_model)): ?><?php if($form_settings->_show_model==0): ?> selected <?php endif; ?> <?php endif; ?>>NO</option>
          <option value="1" <?php if(isset($form_settings->_show_model)): ?><?php if($form_settings->_show_model==1): ?> selected <?php endif; ?> <?php endif; ?>>YES</option>
        </select>
      </div>
      <div class="form-group row">
        <label for="_show_pack_size" class="col-sm-5 col-form-label">Show Pack Size</label>
        <select class="form-control col-sm-7" name="_show_pack_size">
          <option value="0" <?php if(isset($form_settings->_show_pack_size)): ?><?php if($form_settings->_show_pack_size==0): ?> selected <?php endif; ?> <?php endif; ?>>NO</option>
          <option value="1" <?php if(isset($form_settings->_show_pack_size)): ?><?php if($form_settings->_show_pack_size==1): ?> selected <?php endif; ?> <?php endif; ?>>YES</option>
        </select>
      </div>
      <div class="form-group row">
     ...
     <div class="form-group row">
      ...
      <div class="form-group row">
        ...
        <select class="form-control col-sm-7" name="_invoice_template">
          ...
          <option value="7" <?php if(isset($form_settings->_invoice_template)): ?><?php if($form_settings->_invoice_template==7): ?> selected <?php endif; ?> <?php endif; ?>>Invoice AV</option>
          <option value="9" <?php if(isset($form_settings->_invoice_template)): ?><?php if($form_settings->_invoice_template==9): ?> selected <?php endif; ?> <?php endif; ?>>Print 9</option>
          <option value="10" <?php if(isset($form_settings->_invoice_template)): ?><?php if($form_settings->_invoice_template==10): ?> selected <?php endif; ?> <?php endif; ?>>Print 10</option>
          <option value="11" <?php if(isset($form_settings->_invoice_template)): ?><?php if($form_settings->_invoice_template==11): ?> selected <?php endif; ?> <?php endif; ?>>Print 11</option>
          <option value="12" <?php if(isset($form_settings->_invoice_template)): ?><?php if($form_settings->_invoice_template==12): ?> selected <?php endif; ?> <?php endif; ?>>Print 12</option>
        </select>
      </div>
      ...
      <script type="text/javascript">
         $('.select2').select2()
      </script><?php /**PATH D:\xampp\htdocs\avansis-software\resources\views/backend/sales/form_setting_modal.blade.php ENDPATH**/ ?>