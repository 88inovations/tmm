        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body filter_body" >
               <form  action="<?php echo e(url('report-voucher-history')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <?php echo $__env->make('basic.report_date_filter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    <?php echo $__env->make('basic.org_report', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                     ...
                     <div class="row">
                      <label>Voucher Type:<span class="_required">*</span></label><br></div>
                     <div class="row">
                         <select id="_voucher_type" class="form-control  _voucher_type multiple_select " name="_voucher_type[]" multiple size="6" required >
                    ...
                    <div class="row mt-3">
                         ...
                         <div class="col-xs-6 col-sm-6 col-md-6 ">
                               <a href="<?php echo e(url('resetFilter-voucher-history')); ?>"   class="btn btn-danger mt-2 form-control" title="Search Reset"><i class="fa fa-retweet mr-2"></i> Reset </a>
                        </div>
                        <br><br>
                     </div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\avansis-software\resources\views/backend/account-report/filter_voucher_history.blade.php ENDPATH**/ ?>