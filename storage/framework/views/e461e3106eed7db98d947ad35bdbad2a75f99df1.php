                      ...
                      <div class="report_box">
                         ...
                         <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-2 mt-3 ">
                                   <button type="button" class="btn btn-primary due_bill_search_button" attr_url="<?php echo e(route('monthlyCollectionReport')); ?>"><i class="fa fa-search "></i> Report</button>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u561342241/domains/saifinfotech.com/public_html/tmm/resources/views/stm/report/monthly_class_wise_fee_collection_ledger.blade.php ENDPATH**/ ?>