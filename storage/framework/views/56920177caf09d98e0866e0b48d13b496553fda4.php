                      ...
                      <div class="report_box">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-2 mt-3 mb-2 ">
                                   <button type="button" class="btn btn-primary due_bill_search_button" attr_url="<?php echo e(route('division_class_collection_status_list')); ?>"><i class="fa fa-search "></i> Report</button>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\avansis-software\resources\views/stm/report/division_class_collection_status_report.blade.php ENDPATH**/ ?>